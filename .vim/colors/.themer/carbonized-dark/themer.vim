...
hi usrred           guifg=#2b2b2b guibg=#903d3d gui=none
hi usrylw           guifg=#2b2b2b guibg=#7f6b30 gui=none
hi usrgrn           guifg=#2b2b2b guibg=#266426 gui=none
hi usrgnt           guifg=#2b2b2b guibg=#664d75 gui=none
