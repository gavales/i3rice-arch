...
hi Folded           guifg=#285577 guibg=#3d3d3d gui=italic
...
hi TabLine          guifg=#285577 guibg=#32495a gui=none
hi TabLineSel       guifg=#CDCBCD guibg=#3d3d3d gui=none
hi TabLineFill      guifg=#285577 guibg=#32495a gui=none

hi usrStatus        guifg=#CDCBCD guibg=#515151
hi usrred           guifg=#900000 guibg=#3d3d3d gui=underline,bold
hi usrylw           guifg=#904800 guibg=#3d3d3d gui=underline,bold
hi usrgrn           guifg=#009048 guibg=#3d3d3d gui=underline,bold
hi usrgry           guifg=#797979 guibg=#3d3d3d gui=underline,bold
hi usrblu           guifg=#285577 guibg=#3d3d3d gui=underline,bold
hi usrgnt           guifg=#900048 guibg=#3d3d3d gui=underline,bold
