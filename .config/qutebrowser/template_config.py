...
# //// info
c.colors.messages.info.bg = '%%fg0%%'
c.colors.messages.info.border = '%%fg0%%'
c.colors.messages.info.fg = '%%bg1%%'
...
c.colors.tabs.selected.even.fg = '%%bg1%%'
c.colors.tabs.selected.odd.bg = '%%acc%%'
c.colors.tabs.selected.odd.fg = '%%bg1%%'
...
c.fonts.completion.category      = 'bold %%fontsize%%pt monospace'
c.fonts.completion.entry         = '%%fontsize%%pt monospace'
c.fonts.debug_console            = '%%fontsize%%pt monospace'
c.fonts.downloads                = '%%fontsize%%pt monospace'
c.fonts.hints                    = 'bold %%fontsize%%pt monospace'
c.fonts.keyhint                  = '%%fontsize%%pt monospace'
c.fonts.messages.error           = 'italic %%fontsize%%pt monospace'
c.fonts.messages.info            = 'italic %%fontsize%%pt monospace'
c.fonts.messages.warning         = 'italic %%fontsize%%pt monospace'
c.fonts.prompts                  = '%%fontsize%%pt sans-serif'
c.fonts.statusbar                = 'bold %%fontsize%%pt monospace'
c.fonts.tabs                     = 'bold %%fontsize%%pt monospace'
