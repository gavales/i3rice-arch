...
c.colors.statusbar.caret.bg             = '#f9efe9'
...
c.colors.statusbar.command.bg           = '#f9efe9'
...
c.colors.statusbar.insert.bg            = '#f9efe9'
c.colors.statusbar.normal.fg            = '#8d6953'
c.colors.statusbar.normal.bg            = '#f9efe9'
...
# ━━ tabs
c.colors.tabs.bar.bg           = '#f9efe9'
c.colors.tabs.even.bg          = '#f9efe9'
c.colors.tabs.even.fg          = '#3e443e'
c.colors.tabs.odd.bg           = '#e5dbd5'
c.colors.tabs.odd.fg           = '#3e443e'
c.colors.tabs.indicator.error  = '#6F90A7'
c.colors.tabs.indicator.start  = '#507C88'
...
c.colors.tabs.selected.even.fg = '#8d6953'
c.colors.tabs.selected.odd.bg  = '#DC8E69'
c.colors.tabs.selected.odd.fg  = '#8d6953'
