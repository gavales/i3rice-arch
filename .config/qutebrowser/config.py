...
c.hints.border = '1px solid #caa185'
...
c.colors.completion.category.fg                 = '#e9e7e3'
c.colors.completion.even.bg                     = '#484649'
c.colors.completion.odd.bg                      = '#484649'
c.colors.completion.fg                          = ['#96778A', '#e9e7e3', '#706e71']
c.colors.completion.item.selected.bg            = '#96778A'
c.colors.completion.item.selected.fg            = '#e9e7e3'
...
c.colors.completion.scrollbar.bg                = '#484649'
c.colors.completion.scrollbar.fg                = '#e9e7e3'
...
c.colors.downloads.bar.bg    = '#484649'
c.colors.downloads.error.bg  = '#A36043'
c.colors.downloads.error.fg  = '#e9e7e3'
c.colors.downloads.start.bg  = '#96778A'
c.colors.downloads.start.fg  = '#e9e7e3'
c.colors.downloads.stop.bg   = '#B98C68'
c.colors.downloads.stop.fg   = '#e9e7e3'
...
c.colors.hints.fg          = '#e9e7e3'
c.colors.hints.match.fg    = '#B98C68'
c.colors.keyhint.bg        = 'rgba(208, 155, 109, 80%)'
c.colors.keyhint.fg        = '#e9e7e3'
c.colors.keyhint.suffix.fg = '#484649'

c.colors.messages.error.bg     = '#ac7a6a'
c.colors.messages.error.border = '#ac7a6a'
c.colors.messages.error.fg     = '#343235'
c.colors.messages.info.bg     = '#484649'
c.colors.messages.info.border = '#484649'
c.colors.messages.info.fg     = '#e9e7e3'
c.colors.messages.warning.bg     = '#caa185'
c.colors.messages.warning.border = '#caa185'
c.colors.messages.warning.fg     = '#e9e7e3'

c.colors.prompts.bg          = '#343235'
c.colors.prompts.border      = '1px solid #484649'
c.colors.prompts.fg          = '#e9e7e3'
c.colors.prompts.selected.bg = '#65545f'

c.colors.statusbar.caret.fg             = '#D5AE91'
c.colors.statusbar.caret.bg             = '#3f3a3f'
c.colors.statusbar.caret.selection.fg   = '#343235'
c.colors.statusbar.caret.selection.bg   = '#cdae9d'
c.colors.statusbar.command.fg           = '#e9e7e3'
c.colors.statusbar.command.bg           = '#3f3a3f'
c.colors.statusbar.command.private.bg   = '#c1bfbb'
c.colors.statusbar.command.private.fg   = '#343235'
c.colors.statusbar.insert.fg            = '#bb9782'
c.colors.statusbar.insert.bg            = '#3f3a3f'
c.colors.statusbar.normal.fg            = '#e9e7e3'
c.colors.statusbar.normal.bg            = '#3f3a3f'
c.colors.statusbar.passthrough.bg       = '#65545f'
c.colors.statusbar.passthrough.fg       = '#e9e7e3'
c.colors.statusbar.private.bg           = '#c2a9b9'
c.colors.statusbar.private.fg           = '#e9e7e3'
c.colors.statusbar.progress.bg          = '#e9e7e3'
c.colors.statusbar.url.error.fg         = '#ac7a6a'
c.colors.statusbar.url.fg               = '#d5d3cf'
c.colors.statusbar.url.hover.fg         = '#e9e7e3'
c.colors.statusbar.url.success.http.fg  = '#bb9782'
c.colors.statusbar.url.success.https.fg = '#bb9782'
c.colors.statusbar.url.warn.fg          = '#caa185'

c.colors.tabs.bar.bg           = '#65545f'
c.colors.tabs.even.bg          = '#65545f'
c.colors.tabs.even.fg          = '#96778A'
c.colors.tabs.odd.bg           = '#584b54'
c.colors.tabs.odd.fg           = '#96778A'
c.colors.tabs.indicator.error  = '#ac7a6a'
c.colors.tabs.indicator.start  = '#bb9782'
c.colors.tabs.indicator.stop   = '#96778A'
c.colors.tabs.indicator.system = 'rgb'                      # rgb, hsv, hsl, none
c.colors.tabs.selected.even.bg = '#3f3a3f'
c.colors.tabs.selected.even.fg = '#e9e7e3'
c.colors.tabs.selected.odd.bg  = '#3f3a3f'
c.colors.tabs.selected.odd.fg  = '#e9e7e3'
c.colors.tabs.pinned.even.bg          = '#5a8eb7'
c.colors.tabs.pinned.even.fg          = '#e9e7e3'
c.colors.tabs.pinned.odd.bg           = '#5a8eb7'
c.colors.tabs.pinned.odd.fg           = '#e9e7e3'
c.colors.tabs.pinned.selected.even.bg = '#3f3a3f'
c.colors.tabs.pinned.selected.even.fg = '#bfafb6'
c.colors.tabs.pinned.selected.odd.bg  = '#3f3a3f'
c.colors.tabs.pinned.selected.odd.fg  = '#bfafb6'

c.colors.webpage.bg = '#3f3a3f'
