...
c.hints.border = '1px solid #e0af4a'
...
c.colors.messages.error.bg     = '#d75747'
c.colors.messages.error.border = '#d75747'
...
c.colors.messages.warning.bg     = '#e0af4a'
c.colors.messages.warning.border = '#e0af4a'
...
c.colors.statusbar.caret.selection.bg   = '#c38596'
...
c.colors.statusbar.insert.fg            = '#b0ad45'
...
c.colors.statusbar.private.bg           = '#72a097'
c.colors.statusbar.private.fg           = '#fbf1c7'
c.colors.statusbar.progress.bg          = '#fbf1c7'
c.colors.statusbar.url.error.fg         = '#d75747'
c.colors.statusbar.url.fg               = '#e7ddb3'
c.colors.statusbar.url.hover.fg         = '#fbf1c7'
c.colors.statusbar.url.success.http.fg  = '#b0ad45'
c.colors.statusbar.url.success.https.fg = '#b0ad45'
c.colors.statusbar.url.warn.fg          = '#e0af4a'
...
c.colors.tabs.indicator.error  = '#d75747'
c.colors.tabs.indicator.start  = '#b0ad45'
...
c.colors.tabs.pinned.even.bg          = '#8cb281'
c.colors.tabs.pinned.even.fg          = '#fbf1c7'
c.colors.tabs.pinned.odd.bg           = '#8cb281'
