...
c.colors.downloads.error.bg = '#fc796b'
...
# //// errors
c.colors.messages.error.bg = '#fc796b'
c.colors.messages.error.border = '#fc796b'
...
c.colors.statusbar.url.error.fg = '#fc796b'
...
c.colors.tabs.indicator.error = '#fc796b'
