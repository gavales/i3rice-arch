...
c.colors.downloads.error.bg = '#DC8E69'
...
# //// errors
c.colors.messages.error.bg = '#DC8E69'
c.colors.messages.error.border = '#DC8E69'
...
c.colors.statusbar.url.error.fg = '#DC8E69'
...
c.colors.tabs.indicator.error = '#DC8E69'
