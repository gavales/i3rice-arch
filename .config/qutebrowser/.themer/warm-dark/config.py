...
c.colors.completion.category.fg                 = '#3f4e43'
c.colors.completion.even.bg                     = '#536257'
c.colors.completion.odd.bg                      = '#536257'
c.colors.completion.fg                          = ['#68A8AD', '#C4D4AF', '#7b8a7f']
c.colors.completion.item.selected.bg            = '#68A8AD'
c.colors.completion.item.selected.fg            = '#536257'
...
c.colors.completion.scrollbar.bg                = '#536257'
c.colors.completion.scrollbar.fg                = '#C4D4AF'

# //// downloads
c.colors.downloads.bar.bg    = '#536257'
c.colors.downloads.error.bg  = '#F17D80'
c.colors.downloads.error.fg  = '#C4D4AF'
c.colors.downloads.start.bg  = '#68A8AD'
c.colors.downloads.start.fg  = '#C4D4AF'
c.colors.downloads.stop.bg   = '#009048'
c.colors.downloads.stop.fg   = '#C4D4AF'
...
c.colors.hints.fg          = '#C4D4AF'
c.colors.hints.match.fg    = '#009048'
c.colors.keyhint.bg        = 'rgba(144, 72, 0, 80%)'
c.colors.keyhint.fg        = '#C4D4AF'
c.colors.keyhint.suffix.fg = '#536257'

# //// errors
c.colors.messages.error.bg     = '#F17D80'
c.colors.messages.error.border = '#F17D80'
c.colors.messages.error.fg     = '#C4D4AF'

# //// info
c.colors.messages.info.bg     = '#C4D4AF'
c.colors.messages.info.border = '#C4D4AF'
c.colors.messages.info.fg     = '#536257'

# //// warning
c.colors.messages.warning.bg     = '#904800'
c.colors.messages.warning.border = '#904800'
c.colors.messages.warning.fg     = '#536257'

# //// prompts
c.colors.prompts.bg          = '#536257'
c.colors.prompts.border      = '1px solid #536257'
c.colors.prompts.fg          = '#C4D4AF'
c.colors.prompts.selected.bg = '#68A8AD'

# //// statusbar
c.colors.statusbar.caret.fg             = '#737495'
c.colors.statusbar.caret.bg             = '#536257'
c.colors.statusbar.caret.selection.fg   = '#737495'
c.colors.statusbar.caret.selection.bg   = '#536257'
c.colors.statusbar.command.fg           = '#C4D4AF'
c.colors.statusbar.command.bg           = '#536257'
c.colors.statusbar.command.private.bg   = '#7b8a7f'
c.colors.statusbar.command.private.fg   = '#C4D4AF'
c.colors.statusbar.insert.fg            = '#009048'
c.colors.statusbar.insert.bg            = '#536257'
c.colors.statusbar.normal.fg            = '#68A8AD'
c.colors.statusbar.normal.bg            = '#536257'
c.colors.statusbar.passthrough.bg       = '#536257'
c.colors.statusbar.passthrough.fg       = '#C4D4AF'
c.colors.statusbar.private.bg           = '#7b8a7f'
c.colors.statusbar.private.fg           = '#C4D4AF'
c.colors.statusbar.progress.bg          = '#C4D4AF'
c.colors.statusbar.url.error.fg         = '#F17D80'
c.colors.statusbar.url.fg               = '#C4D4AF'
c.colors.statusbar.url.hover.fg         = '#68A8AD'
c.colors.statusbar.url.success.http.fg  = '#C4D4AF'
c.colors.statusbar.url.success.https.fg = '#C4D4AF'
c.colors.statusbar.url.warn.fg          = '#904800'

# //// tabs
c.colors.tabs.bar.bg           = '#536257'
c.colors.tabs.even.bg          = '#536257'
c.colors.tabs.even.fg          = '#C4D4AF'
c.colors.tabs.odd.bg           = '#536257'
c.colors.tabs.odd.fg           = '#C4D4AF'
...
c.colors.tabs.selected.even.fg = '#536257'
c.colors.tabs.selected.odd.bg  = '#68A8AD'
c.colors.tabs.selected.odd.fg  = '#536257'
