...
c.hints.border = '1px solid #b2a14f'

c.colors.completion.category.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #444444, stop:1 #444444)'
c.colors.completion.category.border.bottom      = '#444444'
c.colors.completion.category.border.top         = '#444444'
c.colors.completion.category.fg                 = '#222222'
c.colors.completion.even.bg                     = '#d8d8d8'
c.colors.completion.odd.bg                      = '#d8d8d8'
c.colors.completion.fg                          = ['#444444', '#222222', '#b0b0b0']
c.colors.completion.item.selected.bg            = '#444444'
c.colors.completion.item.selected.fg            = '#222222'
c.colors.completion.item.selected.border.bottom = '#6ce6d6'
c.colors.completion.item.selected.border.top    = '#6ce6d6'
c.colors.completion.match.fg                    = '#444444'
c.colors.completion.item.selected.match.fg      = '#444444'
c.colors.completion.scrollbar.bg                = '#d8d8d8'
...
c.colors.downloads.bar.bg    = '#d8d8d8'
c.colors.downloads.error.bg  = '#cc8f75'
c.colors.downloads.error.fg  = '#222222'
c.colors.downloads.start.bg  = '#444444'
c.colors.downloads.start.fg  = '#222222'
c.colors.downloads.stop.bg   = '#6ce6d6'
...
c.colors.hints.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 rgba(227, 204, 94, 0.8), stop:1 rgba(227, 204, 94, 0.8))'
c.colors.hints.fg          = '#222222'
c.colors.hints.match.fg    = '#6ce6d6'
c.colors.keyhint.bg        = 'rgba(227, 204, 94, 80%)'
c.colors.keyhint.fg        = '#222222'
c.colors.keyhint.suffix.fg = '#d8d8d8'

c.colors.messages.error.bg     = '#a17360'
c.colors.messages.error.border = '#a17360'
c.colors.messages.error.fg     = '#ececec'
c.colors.messages.info.bg     = '#d8d8d8'
c.colors.messages.info.border = '#d8d8d8'
c.colors.messages.info.fg     = '#222222'
c.colors.messages.warning.bg     = '#b2a14f'
c.colors.messages.warning.border = '#b2a14f'
c.colors.messages.warning.fg     = '#222222'

c.colors.prompts.bg          = '#ececec'
c.colors.prompts.border      = '1px solid #d8d8d8'
c.colors.prompts.fg          = '#222222'
c.colors.prompts.selected.bg = '#989898'

c.colors.statusbar.caret.fg             = '#c886db'
c.colors.statusbar.caret.bg             = '#d7d7d7'
c.colors.statusbar.caret.selection.fg   = '#ececec'
c.colors.statusbar.caret.selection.bg   = '#9e6dac'
c.colors.statusbar.command.fg           = '#222222'
c.colors.statusbar.command.bg           = '#d7d7d7'
c.colors.statusbar.command.private.bg   = '#4a4a4a'
c.colors.statusbar.command.private.fg   = '#ececec'
c.colors.statusbar.insert.fg            = '#59b5a9'
c.colors.statusbar.insert.bg            = '#d7d7d7'
c.colors.statusbar.normal.fg            = '#222222'
c.colors.statusbar.normal.bg            = '#d7d7d7'
c.colors.statusbar.passthrough.bg       = '#989898'
c.colors.statusbar.passthrough.fg       = '#222222'
c.colors.statusbar.private.bg           = '#6bb2ba'
c.colors.statusbar.private.fg           = '#222222'
c.colors.statusbar.progress.bg          = '#222222'
c.colors.statusbar.url.error.fg         = '#a17360'
c.colors.statusbar.url.fg               = '#363636'
c.colors.statusbar.url.hover.fg         = '#222222'
c.colors.statusbar.url.success.http.fg  = '#59b5a9'
c.colors.statusbar.url.success.https.fg = '#59b5a9'
c.colors.statusbar.url.warn.fg          = '#b2a14f'

c.colors.tabs.bar.bg           = '#989898'
c.colors.tabs.even.bg          = '#989898'
c.colors.tabs.even.fg          = '#444444'
c.colors.tabs.odd.bg           = '#adadad'
c.colors.tabs.odd.fg           = '#444444'
c.colors.tabs.indicator.error  = '#a17360'
c.colors.tabs.indicator.start  = '#59b5a9'
c.colors.tabs.indicator.stop   = '#444444'
c.colors.tabs.indicator.system = 'rgb'                      # rgb, hsv, hsl, none
c.colors.tabs.selected.even.bg = '#d7d7d7'
c.colors.tabs.selected.even.fg = '#222222'
c.colors.tabs.selected.odd.bg  = '#d7d7d7'
c.colors.tabs.selected.odd.fg  = '#222222'
c.colors.tabs.pinned.even.bg          = '#6088a1'
c.colors.tabs.pinned.even.fg          = '#222222'
c.colors.tabs.pinned.odd.bg           = '#6088a1'
c.colors.tabs.pinned.odd.fg           = '#222222'
c.colors.tabs.pinned.selected.even.bg = '#d7d7d7'
c.colors.tabs.pinned.selected.even.fg = '#333333'
c.colors.tabs.pinned.selected.odd.bg  = '#d7d7d7'
c.colors.tabs.pinned.selected.odd.fg  = '#333333'

c.colors.webpage.bg = '#d7d7d7'
