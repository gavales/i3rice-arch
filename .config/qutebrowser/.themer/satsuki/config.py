...
c.colors.completion.category.fg                 = '#fbf4f1'
c.colors.completion.even.bg                     = '#e7e0dd'
c.colors.completion.odd.bg                      = '#e7e0dd'
c.colors.completion.fg                          = ['#df8578', '#383436', '#bfb8b5']
c.colors.completion.item.selected.bg            = '#df8578'
c.colors.completion.item.selected.fg            = '#e7e0dd'
...
c.colors.completion.scrollbar.bg                = '#e7e0dd'
c.colors.completion.scrollbar.fg                = '#383436'

# ━━ downloads
c.colors.downloads.bar.bg    = '#e7e0dd'
c.colors.downloads.error.bg  = '#b85227'
c.colors.downloads.error.fg  = '#383436'
c.colors.downloads.start.bg  = '#df8578'
c.colors.downloads.start.fg  = '#383436'
c.colors.downloads.stop.bg   = '#18E3C8'
c.colors.downloads.stop.fg   = '#383436'
...
c.colors.hints.fg          = '#383436'
c.colors.hints.match.fg    = '#18E3C8'
c.colors.keyhint.bg        = 'rgba(221, 183, 0, 80%)'
c.colors.keyhint.fg        = '#383436'
c.colors.keyhint.suffix.fg = '#e7e0dd'

# ━━ errors
c.colors.messages.error.bg     = '#b85227'
c.colors.messages.error.border = '#b85227'
c.colors.messages.error.fg     = '#383436'

# ━━ info
c.colors.messages.info.bg     = '#383436'
c.colors.messages.info.border = '#383436'
c.colors.messages.info.fg     = '#e7e0dd'

# ━━ warning
c.colors.messages.warning.bg     = '#DDB700'
c.colors.messages.warning.border = '#DDB700'
c.colors.messages.warning.fg     = '#e7e0dd'

# ━━ prompts
c.colors.prompts.bg          = '#e7e0dd'
c.colors.prompts.border      = '1px solid #e7e0dd'
c.colors.prompts.fg          = '#383436'
c.colors.prompts.selected.bg = '#df8578'

# ━━ statusbar
c.colors.statusbar.caret.fg             = '#B043D1'
c.colors.statusbar.caret.bg             = '#e7e0dd'
c.colors.statusbar.caret.selection.fg   = '#B043D1'
c.colors.statusbar.caret.selection.bg   = '#e7e0dd'
c.colors.statusbar.command.fg           = '#383436'
c.colors.statusbar.command.bg           = '#e7e0dd'
c.colors.statusbar.command.private.bg   = '#bfb8b5'
c.colors.statusbar.command.private.fg   = '#383436'
c.colors.statusbar.insert.fg            = '#18E3C8'
c.colors.statusbar.insert.bg            = '#e7e0dd'
c.colors.statusbar.normal.fg            = '#df8578'
c.colors.statusbar.normal.bg            = '#e7e0dd'
c.colors.statusbar.passthrough.bg       = '#e7e0dd'
c.colors.statusbar.passthrough.fg       = '#383436'
c.colors.statusbar.private.bg           = '#bfb8b5'
c.colors.statusbar.private.fg           = '#383436'
c.colors.statusbar.progress.bg          = '#383436'
c.colors.statusbar.url.error.fg         = '#b85227'
c.colors.statusbar.url.fg               = '#383436'
c.colors.statusbar.url.hover.fg         = '#df8578'
c.colors.statusbar.url.success.http.fg  = '#383436'
c.colors.statusbar.url.success.https.fg = '#383436'
c.colors.statusbar.url.warn.fg          = '#DDB700'

# ━━ tabs
c.colors.tabs.bar.bg           = '#e7e0dd'
c.colors.tabs.even.bg          = '#e7e0dd'
c.colors.tabs.even.fg          = '#383436'
c.colors.tabs.odd.bg           = '#e7e0dd'
c.colors.tabs.odd.fg           = '#383436'
...
c.colors.tabs.selected.even.fg = '#e7e0dd'
c.colors.tabs.selected.odd.bg  = '#df8578'
c.colors.tabs.selected.odd.fg  = '#e7e0dd'
