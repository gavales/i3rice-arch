...
c.colors.completion.category.fg                 = '#3b4d4f'
c.colors.completion.even.bg                     = '#4f6163'
c.colors.completion.odd.bg                      = '#4f6163'
c.colors.completion.fg                          = ['#e46c6d', '#fdf6e3', '#77898b']
c.colors.completion.item.selected.bg            = '#e46c6d'
c.colors.completion.item.selected.fg            = '#4f6163'
...
c.colors.completion.scrollbar.bg                = '#4f6163'
c.colors.completion.scrollbar.fg                = '#fdf6e3'

# ━━ downloads
c.colors.downloads.bar.bg    = '#4f6163'
...
c.colors.keyhint.suffix.fg = '#4f6163'
...
c.colors.messages.info.fg     = '#4f6163'

# ━━ warning
c.colors.messages.warning.bg     = '#c49b4a'
c.colors.messages.warning.border = '#c49b4a'
c.colors.messages.warning.fg     = '#4f6163'

# ━━ prompts
c.colors.prompts.bg          = '#4f6163'
c.colors.prompts.border      = '1px solid #4f6163'
c.colors.prompts.fg          = '#fdf6e3'
c.colors.prompts.selected.bg = '#e46c6d'

# ━━ statusbar
c.colors.statusbar.caret.fg             = '#a38895'
c.colors.statusbar.caret.bg             = '#4f6163'
c.colors.statusbar.caret.selection.fg   = '#a38895'
c.colors.statusbar.caret.selection.bg   = '#4f6163'
c.colors.statusbar.command.fg           = '#fdf6e3'
c.colors.statusbar.command.bg           = '#4f6163'
c.colors.statusbar.command.private.bg   = '#77898b'
c.colors.statusbar.command.private.fg   = '#fdf6e3'
c.colors.statusbar.insert.fg            = '#8cb88b'
c.colors.statusbar.insert.bg            = '#4f6163'
c.colors.statusbar.normal.fg            = '#e46c6d'
c.colors.statusbar.normal.bg            = '#4f6163'
c.colors.statusbar.passthrough.bg       = '#4f6163'
c.colors.statusbar.passthrough.fg       = '#fdf6e3'
c.colors.statusbar.private.bg           = '#77898b'
...
# ━━ tabs
c.colors.tabs.bar.bg           = '#4f6163'
c.colors.tabs.even.bg          = '#4f6163'
c.colors.tabs.even.fg          = '#fdf6e3'
c.colors.tabs.odd.bg           = '#4f6163'
...
c.colors.tabs.selected.even.fg = '#4f6163'
c.colors.tabs.selected.odd.bg  = '#e46c6d'
c.colors.tabs.selected.odd.fg  = '#4f6163'
