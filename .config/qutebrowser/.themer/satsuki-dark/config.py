...
# ━  COLORS
# ━━ completion
c.colors.completion.category.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #df8578, stop:1 #df8578)'
c.colors.completion.category.border.bottom      = '#df8578'
c.colors.completion.category.border.top         = '#df8578'
c.colors.completion.category.fg                 = '#383436'
c.colors.completion.even.bg                     = '#4c484a'
c.colors.completion.odd.bg                      = '#4c484a'
c.colors.completion.fg                          = ['#df8578', '#fbf4f1', '#747072']
c.colors.completion.item.selected.bg            = '#df8578'
...
c.colors.completion.match.fg                    = '#df8578'
c.colors.completion.scrollbar.bg                = '#4c484a'
c.colors.completion.scrollbar.fg                = '#fbf4f1'

# ━━ downloads
c.colors.downloads.bar.bg    = '#4c484a'
c.colors.downloads.error.bg  = '#b85227'
c.colors.downloads.error.fg  = '#fbf4f1'
c.colors.downloads.start.bg  = '#df8578'
c.colors.downloads.start.fg  = '#fbf4f1'
c.colors.downloads.stop.bg   = '#18E3C8'
c.colors.downloads.stop.fg   = '#fbf4f1'
...
c.colors.hints.fg          = '#fbf4f1'
c.colors.hints.match.fg    = '#18E3C8'
c.colors.keyhint.bg        = 'rgba(221, 183, 0, 80%)'
c.colors.keyhint.fg        = '#fbf4f1'
c.colors.keyhint.suffix.fg = '#4c484a'

# ━━ errors
c.colors.messages.error.bg     = '#b85227'
c.colors.messages.error.border = '#b85227'
c.colors.messages.error.fg     = '#fbf4f1'

# ━━ info
c.colors.messages.info.bg     = '#fbf4f1'
c.colors.messages.info.border = '#fbf4f1'
c.colors.messages.info.fg     = '#4c484a'

# ━━ warning
c.colors.messages.warning.bg     = '#DDB700'
c.colors.messages.warning.border = '#DDB700'
c.colors.messages.warning.fg     = '#4c484a'

# ━━ prompts
c.colors.prompts.bg          = '#4c484a'
c.colors.prompts.border      = '1px solid #4c484a'
c.colors.prompts.fg          = '#fbf4f1'
c.colors.prompts.selected.bg = '#df8578'

# ━━ statusbar
c.colors.statusbar.caret.fg             = '#B043D1'
c.colors.statusbar.caret.bg             = '#4c484a'
c.colors.statusbar.caret.selection.fg   = '#B043D1'
c.colors.statusbar.caret.selection.bg   = '#4c484a'
c.colors.statusbar.command.fg           = '#fbf4f1'
c.colors.statusbar.command.bg           = '#4c484a'
c.colors.statusbar.command.private.bg   = '#747072'
c.colors.statusbar.command.private.fg   = '#fbf4f1'
c.colors.statusbar.insert.fg            = '#18E3C8'
c.colors.statusbar.insert.bg            = '#4c484a'
c.colors.statusbar.normal.fg            = '#df8578'
c.colors.statusbar.normal.bg            = '#4c484a'
c.colors.statusbar.passthrough.bg       = '#4c484a'
c.colors.statusbar.passthrough.fg       = '#fbf4f1'
c.colors.statusbar.private.bg           = '#747072'
c.colors.statusbar.private.fg           = '#fbf4f1'
c.colors.statusbar.progress.bg          = '#fbf4f1'
c.colors.statusbar.url.error.fg         = '#b85227'
c.colors.statusbar.url.fg               = '#fbf4f1'
c.colors.statusbar.url.hover.fg         = '#df8578'
c.colors.statusbar.url.success.http.fg  = '#fbf4f1'
c.colors.statusbar.url.success.https.fg = '#fbf4f1'
c.colors.statusbar.url.warn.fg          = '#DDB700'

# ━━ tabs
c.colors.tabs.bar.bg           = '#4c484a'
c.colors.tabs.even.bg          = '#4c484a'
c.colors.tabs.even.fg          = '#fbf4f1'
c.colors.tabs.odd.bg           = '#4c484a'
c.colors.tabs.odd.fg           = '#fbf4f1'
c.colors.tabs.indicator.error  = '#b85227'
c.colors.tabs.indicator.start  = '#df8578'
c.colors.tabs.indicator.stop   = '#18E3C8'
c.colors.tabs.indicator.system = 'rgb' # rgb, hsv, hsl, none
c.colors.tabs.selected.even.bg = '#df8578'
c.colors.tabs.selected.even.fg = '#4c484a'
c.colors.tabs.selected.odd.bg  = '#df8578'
...
c.hints.border                     = '1px solid #DDB700'
