...
# ━  COLORS
# ━━ completion
c.colors.completion.category.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #48b06f, stop:1 #48b06f)'
c.colors.completion.category.border.bottom      = '#48b06f'
c.colors.completion.category.border.top         = '#48b06f'
c.colors.completion.category.fg                 = '#282A36'
c.colors.completion.even.bg                     = '#3c3e4a'
c.colors.completion.odd.bg                      = '#3c3e4a'
c.colors.completion.fg                          = ['#48b06f', '#ffffde', '#646672']
c.colors.completion.item.selected.bg            = '#48b06f'
c.colors.completion.item.selected.fg            = '#3c3e4a'
c.colors.completion.item.selected.border.bottom = '#896eb6'
c.colors.completion.item.selected.border.top    = '#896eb6'
c.colors.completion.match.fg                    = '#48b06f'
c.colors.completion.scrollbar.bg                = '#3c3e4a'
c.colors.completion.scrollbar.fg                = '#ffffde'

# ━━ downloads
c.colors.downloads.bar.bg    = '#3c3e4a'
c.colors.downloads.error.bg  = '#b55655'
c.colors.downloads.error.fg  = '#ffffde'
c.colors.downloads.start.bg  = '#48b06f'
c.colors.downloads.start.fg  = '#ffffde'
c.colors.downloads.stop.bg   = '#896eb6'
c.colors.downloads.stop.fg   = '#ffffde'
c.colors.downloads.system.bg = 'rgb' # rgb, hsv, hsl, none
c.colors.downloads.system.fg = 'rgb' # rgb, hsv, hsl, none

# ━━ hints
c.colors.hints.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 rgba(147, 148, 17, 0.8), stop:1 rgba(147, 148, 17, 0.8))'
c.colors.hints.fg          = '#ffffde'
c.colors.hints.match.fg    = '#896eb6'
c.colors.keyhint.bg        = 'rgba(147, 148, 17, 80%)'
c.colors.keyhint.fg        = '#ffffde'
c.colors.keyhint.suffix.fg = '#3c3e4a'

# ━━ errors
c.colors.messages.error.bg     = '#b55655'
c.colors.messages.error.border = '#b55655'
c.colors.messages.error.fg     = '#ffffde'

# ━━ info
c.colors.messages.info.bg     = '#ffffde'
c.colors.messages.info.border = '#ffffde'
c.colors.messages.info.fg     = '#3c3e4a'

# ━━ warning
c.colors.messages.warning.bg     = '#939411'
c.colors.messages.warning.border = '#939411'
c.colors.messages.warning.fg     = '#3c3e4a'

# ━━ prompts
c.colors.prompts.bg          = '#3c3e4a'
c.colors.prompts.border      = '1px solid #3c3e4a'
c.colors.prompts.fg          = '#ffffde'
c.colors.prompts.selected.bg = '#48b06f'

# ━━ statusbar
c.colors.statusbar.caret.fg             = '#b56e9b'
c.colors.statusbar.caret.bg             = '#3c3e4a'
c.colors.statusbar.caret.selection.fg   = '#b56e9b'
c.colors.statusbar.caret.selection.bg   = '#3c3e4a'
c.colors.statusbar.command.fg           = '#ffffde'
c.colors.statusbar.command.bg           = '#3c3e4a'
c.colors.statusbar.command.private.bg   = '#646672'
c.colors.statusbar.command.private.fg   = '#ffffde'
c.colors.statusbar.insert.fg            = '#896eb6'
c.colors.statusbar.insert.bg            = '#3c3e4a'
c.colors.statusbar.normal.fg            = '#48b06f'
c.colors.statusbar.normal.bg            = '#3c3e4a'
c.colors.statusbar.passthrough.bg       = '#3c3e4a'
c.colors.statusbar.passthrough.fg       = '#ffffde'
c.colors.statusbar.private.bg           = '#646672'
c.colors.statusbar.private.fg           = '#ffffde'
c.colors.statusbar.progress.bg          = '#ffffde'
c.colors.statusbar.url.error.fg         = '#b55655'
c.colors.statusbar.url.fg               = '#ffffde'
c.colors.statusbar.url.hover.fg         = '#48b06f'
c.colors.statusbar.url.success.http.fg  = '#ffffde'
c.colors.statusbar.url.success.https.fg = '#ffffde'
c.colors.statusbar.url.warn.fg          = '#939411'

# ━━ tabs
c.colors.tabs.bar.bg           = '#3c3e4a'
c.colors.tabs.even.bg          = '#3c3e4a'
c.colors.tabs.even.fg          = '#ffffde'
c.colors.tabs.odd.bg           = '#3c3e4a'
c.colors.tabs.odd.fg           = '#ffffde'
c.colors.tabs.indicator.error  = '#b55655'
c.colors.tabs.indicator.start  = '#48b06f'
c.colors.tabs.indicator.stop   = '#896eb6'
c.colors.tabs.indicator.system = 'rgb' # rgb, hsv, hsl, none
c.colors.tabs.selected.even.bg = '#48b06f'
c.colors.tabs.selected.even.fg = '#3c3e4a'
c.colors.tabs.selected.odd.bg  = '#48b06f'
c.colors.tabs.selected.odd.fg  = '#3c3e4a'
...
c.hints.border                     = '1px solid #939411'
