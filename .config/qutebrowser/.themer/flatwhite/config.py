...
c.hints.border = '1px solid #a49826'

c.colors.completion.category.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #277eb8, stop:1 #277eb8)'
c.colors.completion.category.border.bottom      = '#277eb8'
c.colors.completion.category.border.top         = '#277eb8'
c.colors.completion.category.fg                 = '#493C2C'
c.colors.completion.even.bg                     = '#e3dfda'
c.colors.completion.odd.bg                      = '#e3dfda'
c.colors.completion.fg                          = ['#277eb8', '#493C2C', '#bbb7b2']
c.colors.completion.item.selected.bg            = '#277eb8'
c.colors.completion.item.selected.fg            = '#493C2C'
c.colors.completion.item.selected.border.bottom = '#18E3C8'
c.colors.completion.item.selected.border.top    = '#18E3C8'
c.colors.completion.match.fg                    = '#277eb8'
c.colors.completion.item.selected.match.fg      = '#277eb8'
c.colors.completion.scrollbar.bg                = '#e3dfda'
c.colors.completion.scrollbar.fg                = '#493C2C'
...
c.colors.downloads.bar.bg    = '#e3dfda'
c.colors.downloads.error.bg  = '#b85227'
c.colors.downloads.error.fg  = '#493C2C'
c.colors.downloads.start.bg  = '#277eb8'
c.colors.downloads.start.fg  = '#493C2C'
c.colors.downloads.stop.bg   = '#18E3C8'
c.colors.downloads.stop.fg   = '#493C2C'
...
c.colors.hints.fg          = '#493C2C'
c.colors.hints.match.fg    = '#18E3C8'
c.colors.keyhint.bg        = 'rgba(221, 183, 0, 80%)'
c.colors.keyhint.fg        = '#493C2C'
c.colors.keyhint.suffix.fg = '#e3dfda'

c.colors.messages.error.bg     = '#8c5540'
c.colors.messages.error.border = '#8c5540'
c.colors.messages.error.fg     = '#F7F3EE'
c.colors.messages.info.bg     = '#e3dfda'
c.colors.messages.info.border = '#e3dfda'
c.colors.messages.info.fg     = '#493C2C'
c.colors.messages.warning.bg     = '#a49826'
c.colors.messages.warning.border = '#a49826'
c.colors.messages.warning.fg     = '#493C2C'

c.colors.prompts.bg          = '#F7F3EE'
c.colors.prompts.border      = '1px solid #e3dfda'
c.colors.prompts.fg          = '#493C2C'
c.colors.prompts.selected.bg = '#8fb8d3'

c.colors.statusbar.caret.fg             = '#B043D1'
c.colors.statusbar.caret.bg             = '#dee4e7'
c.colors.statusbar.caret.selection.fg   = '#F7F3EE'
c.colors.statusbar.caret.selection.bg   = '#874bb0'
c.colors.statusbar.command.fg           = '#493C2C'
c.colors.statusbar.command.bg           = '#dee4e7'
c.colors.statusbar.command.private.bg   = '#716454'
c.colors.statusbar.command.private.fg   = '#F7F3EE'
c.colors.statusbar.insert.fg            = '#22b5aa'
c.colors.statusbar.insert.bg            = '#dee4e7'
c.colors.statusbar.normal.fg            = '#493C2C'
c.colors.statusbar.normal.bg            = '#dee4e7'
c.colors.statusbar.passthrough.bg       = '#8fb8d3'
c.colors.statusbar.passthrough.fg       = '#493C2C'
c.colors.statusbar.private.bg           = '#3cb0c3'
c.colors.statusbar.private.fg           = '#493C2C'
c.colors.statusbar.progress.bg          = '#493C2C'
c.colors.statusbar.url.error.fg         = '#8c5540'
c.colors.statusbar.url.fg               = '#5d5040'
c.colors.statusbar.url.hover.fg         = '#493C2C'
c.colors.statusbar.url.success.http.fg  = '#22b5aa'
c.colors.statusbar.url.success.https.fg = '#22b5aa'
c.colors.statusbar.url.warn.fg          = '#a49826'

c.colors.tabs.bar.bg           = '#8fb8d3'
c.colors.tabs.even.bg          = '#8fb8d3'
c.colors.tabs.even.fg          = '#277eb8'
c.colors.tabs.odd.bg           = '#aac7da'
c.colors.tabs.odd.fg           = '#277eb8'
c.colors.tabs.indicator.error  = '#8c5540'
c.colors.tabs.indicator.start  = '#22b5aa'
c.colors.tabs.indicator.stop   = '#277eb8'
c.colors.tabs.indicator.system = 'rgb'                      # rgb, hsv, hsl, none
c.colors.tabs.selected.even.bg = '#dee4e7'
c.colors.tabs.selected.even.fg = '#493C2C'
c.colors.tabs.selected.odd.bg  = '#dee4e7'
c.colors.tabs.selected.odd.fg  = '#493C2C'
c.colors.tabs.pinned.even.bg          = '#2c72a0'
c.colors.tabs.pinned.even.fg          = '#493C2C'
c.colors.tabs.pinned.odd.bg           = '#2c72a0'
c.colors.tabs.pinned.odd.fg           = '#493C2C'
c.colors.tabs.pinned.selected.even.bg = '#dee4e7'
c.colors.tabs.pinned.selected.even.fg = '#385d72'
c.colors.tabs.pinned.selected.odd.bg  = '#dee4e7'
c.colors.tabs.pinned.selected.odd.fg  = '#385d72'

c.colors.webpage.bg = '#dee4e7'
