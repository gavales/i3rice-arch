...
# ━  COLORS
# ━━ completion
c.colors.completion.category.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #714019, stop:1 #714019)'
c.colors.completion.category.border.bottom      = '#714019'
c.colors.completion.category.border.top         = '#714019'
c.colors.completion.category.fg                 = '#1A110A'
c.colors.completion.even.bg                     = '#2e251e'
c.colors.completion.odd.bg                      = '#2e251e'
c.colors.completion.fg                          = ['#714019', '#FFD9B3', '#564d46']
c.colors.completion.item.selected.bg            = '#714019'
c.colors.completion.item.selected.fg            = '#2e251e'
c.colors.completion.item.selected.border.bottom = '#009048'
c.colors.completion.item.selected.border.top    = '#009048'
c.colors.completion.match.fg                    = '#714019'
c.colors.completion.scrollbar.bg                = '#2e251e'
c.colors.completion.scrollbar.fg                = '#FFD9B3'

# ━━ downloads
c.colors.downloads.bar.bg    = '#2e251e'
c.colors.downloads.error.bg  = '#cc241d'
c.colors.downloads.error.fg  = '#FFD9B3'
c.colors.downloads.start.bg  = '#714019'
c.colors.downloads.start.fg  = '#FFD9B3'
c.colors.downloads.stop.bg   = '#009048'
c.colors.downloads.stop.fg   = '#FFD9B3'
...
c.colors.hints.fg          = '#FFD9B3'
c.colors.hints.match.fg    = '#009048'
c.colors.keyhint.bg        = 'rgba(144, 72, 0, 80%)'
c.colors.keyhint.fg        = '#FFD9B3'
c.colors.keyhint.suffix.fg = '#2e251e'

# ━━ errors
c.colors.messages.error.bg     = '#cc241d'
c.colors.messages.error.border = '#cc241d'
c.colors.messages.error.fg     = '#FFD9B3'

# ━━ info
c.colors.messages.info.bg     = '#FFD9B3'
c.colors.messages.info.border = '#FFD9B3'
c.colors.messages.info.fg     = '#2e251e'

# ━━ warning
c.colors.messages.warning.bg     = '#904800'
c.colors.messages.warning.border = '#904800'
c.colors.messages.warning.fg     = '#2e251e'

# ━━ prompts
c.colors.prompts.bg          = '#2e251e'
c.colors.prompts.border      = '1px solid #2e251e'
c.colors.prompts.fg          = '#FFD9B3'
c.colors.prompts.selected.bg = '#714019'

# ━━ statusbar
c.colors.statusbar.caret.fg             = '#900048'
c.colors.statusbar.caret.bg             = '#2e251e'
c.colors.statusbar.caret.selection.fg   = '#900048'
c.colors.statusbar.caret.selection.bg   = '#2e251e'
c.colors.statusbar.command.fg           = '#FFD9B3'
c.colors.statusbar.command.bg           = '#2e251e'
c.colors.statusbar.command.private.bg   = '#564d46'
c.colors.statusbar.command.private.fg   = '#FFD9B3'
c.colors.statusbar.insert.fg            = '#009048'
c.colors.statusbar.insert.bg            = '#2e251e'
c.colors.statusbar.normal.fg            = '#714019'
c.colors.statusbar.normal.bg            = '#2e251e'
c.colors.statusbar.passthrough.bg       = '#2e251e'
c.colors.statusbar.passthrough.fg       = '#FFD9B3'
c.colors.statusbar.private.bg           = '#564d46'
c.colors.statusbar.private.fg           = '#FFD9B3'
c.colors.statusbar.progress.bg          = '#FFD9B3'
c.colors.statusbar.url.error.fg         = '#cc241d'
c.colors.statusbar.url.fg               = '#FFD9B3'
c.colors.statusbar.url.hover.fg         = '#714019'
c.colors.statusbar.url.success.http.fg  = '#FFD9B3'
c.colors.statusbar.url.success.https.fg = '#FFD9B3'
c.colors.statusbar.url.warn.fg          = '#904800'

# ━━ tabs
c.colors.tabs.bar.bg           = '#2e251e'
c.colors.tabs.even.bg          = '#2e251e'
c.colors.tabs.even.fg          = '#FFD9B3'
c.colors.tabs.odd.bg           = '#2e251e'
c.colors.tabs.odd.fg           = '#FFD9B3'
c.colors.tabs.indicator.error  = '#cc241d'
c.colors.tabs.indicator.start  = '#714019'
c.colors.tabs.indicator.stop   = '#009048'
c.colors.tabs.indicator.system = 'rgb' # rgb, hsv, hsl, none
c.colors.tabs.selected.even.bg = '#714019'
c.colors.tabs.selected.even.fg = '#2e251e'
c.colors.tabs.selected.odd.bg  = '#714019'
c.colors.tabs.selected.odd.fg  = '#2e251e'
