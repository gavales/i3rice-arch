...
# >>>> COLORS
# //// completion
c.colors.completion.category.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #E7D5A4, stop:1 #E7D5A4)'
c.colors.completion.category.border.bottom      = '#E7D5A4'
c.colors.completion.category.border.top         = '#E7D5A4'
c.colors.completion.category.fg                 = '#cde1eb'
c.colors.completion.even.bg                     = '#b9cdd7'
c.colors.completion.odd.bg                      = '#b9cdd7'
c.colors.completion.fg                          = ['#E7D5A4', '#182128', '#91a5af']
c.colors.completion.item.selected.bg            = '#E7D5A4'
c.colors.completion.item.selected.fg            = '#b9cdd7'
c.colors.completion.item.selected.border.bottom = '#77AFD2'
c.colors.completion.item.selected.border.top    = '#77AFD2'
c.colors.completion.match.fg                    = '#E7D5A4'
c.colors.completion.scrollbar.bg                = '#b9cdd7'
c.colors.completion.scrollbar.fg                = '#182128'

# //// downloads
c.colors.downloads.bar.bg    = '#b9cdd7'
c.colors.downloads.error.bg  = '#6098A3'
c.colors.downloads.error.fg  = '#182128'
c.colors.downloads.start.bg  = '#E7D5A4'
c.colors.downloads.start.fg  = '#182128'
c.colors.downloads.stop.bg   = '#77AFD2'
c.colors.downloads.stop.fg   = '#182128'
c.colors.downloads.system.bg = 'rgb' # rgb, hsv, hsl, none
c.colors.downloads.system.fg = 'rgb' # rgb, hsv, hsl, none

# //// hints
c.colors.hints.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 rgba(148, 156, 154, 0.8), stop:1 rgba(148, 156, 154, 0.8))'
c.colors.hints.fg          = '#182128'
c.colors.hints.match.fg    = '#77AFD2'
c.colors.keyhint.bg        = 'rgba(148, 156, 154, 80%)'
c.colors.keyhint.fg        = '#182128'
c.colors.keyhint.suffix.fg = '#b9cdd7'

# //// errors
c.colors.messages.error.bg     = '#6098A3'
c.colors.messages.error.border = '#6098A3'
c.colors.messages.error.fg     = '#182128'

# //// info
c.colors.messages.info.bg     = '#182128'
c.colors.messages.info.border = '#182128'
c.colors.messages.info.fg     = '#b9cdd7'

# //// warning
c.colors.messages.warning.bg     = '#949C9A'
c.colors.messages.warning.border = '#949C9A'
c.colors.messages.warning.fg     = '#b9cdd7'

# //// prompts
c.colors.prompts.bg          = '#b9cdd7'
c.colors.prompts.border      = '1px solid #b9cdd7'
c.colors.prompts.fg          = '#182128'
c.colors.prompts.selected.bg = '#E7D5A4'

# //// statusbar
c.colors.statusbar.caret.fg             = '#8EBADA'
c.colors.statusbar.caret.bg             = '#b9cdd7'
c.colors.statusbar.caret.selection.fg   = '#8EBADA'
c.colors.statusbar.caret.selection.bg   = '#b9cdd7'
c.colors.statusbar.command.fg           = '#182128'
c.colors.statusbar.command.bg           = '#b9cdd7'
c.colors.statusbar.command.private.bg   = '#91a5af'
c.colors.statusbar.command.private.fg   = '#182128'
c.colors.statusbar.insert.fg            = '#77AFD2'
c.colors.statusbar.insert.bg            = '#b9cdd7'
c.colors.statusbar.normal.fg            = '#E7D5A4'
c.colors.statusbar.normal.bg            = '#b9cdd7'
c.colors.statusbar.passthrough.bg       = '#b9cdd7'
c.colors.statusbar.passthrough.fg       = '#182128'
c.colors.statusbar.private.bg           = '#91a5af'
c.colors.statusbar.private.fg           = '#182128'
c.colors.statusbar.progress.bg          = '#182128'
c.colors.statusbar.url.error.fg         = '#6098A3'
c.colors.statusbar.url.fg               = '#182128'
c.colors.statusbar.url.hover.fg         = '#E7D5A4'
c.colors.statusbar.url.success.http.fg  = '#182128'
c.colors.statusbar.url.success.https.fg = '#182128'
c.colors.statusbar.url.warn.fg          = '#949C9A'

# //// tabs
c.colors.tabs.bar.bg           = '#b9cdd7'
c.colors.tabs.even.bg          = '#b9cdd7'
c.colors.tabs.even.fg          = '#182128'
c.colors.tabs.odd.bg           = '#b9cdd7'
c.colors.tabs.odd.fg           = '#182128'
c.colors.tabs.indicator.error  = '#6098A3'
c.colors.tabs.indicator.start  = '#E7D5A4'
c.colors.tabs.indicator.stop   = '#77AFD2'
c.colors.tabs.indicator.system = 'rgb' # rgb, hsv, hsl, none
c.colors.tabs.selected.even.bg = '#E7D5A4'
c.colors.tabs.selected.even.fg = '#b9cdd7'
c.colors.tabs.selected.odd.bg  = '#E7D5A4'
c.colors.tabs.selected.odd.fg  = '#b9cdd7'
...
c.hints.border                     = '1px solid #949C9A'
