...
# ━  COLORS
# ━━ completion
c.colors.completion.category.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #686B98, stop:1 #686B98)'
c.colors.completion.category.border.bottom      = '#686B98'
c.colors.completion.category.border.top         = '#686B98'
c.colors.completion.category.fg                 = '#bcb2be'
c.colors.completion.even.bg                     = '#a89eaa'
c.colors.completion.odd.bg                      = '#a89eaa'
c.colors.completion.fg                          = ['#686B98', '#0c0e0d', '#807682']
c.colors.completion.item.selected.bg            = '#686B98'
c.colors.completion.item.selected.fg            = '#a89eaa'
c.colors.completion.item.selected.border.bottom = '#4B5A8C'
c.colors.completion.item.selected.border.top    = '#4B5A8C'
c.colors.completion.match.fg                    = '#686B98'
c.colors.completion.scrollbar.bg                = '#a89eaa'
c.colors.completion.scrollbar.fg                = '#0c0e0d'

# ━━ downloads
c.colors.downloads.bar.bg    = '#a89eaa'
c.colors.downloads.error.bg  = '#316BAC'
c.colors.downloads.error.fg  = '#0c0e0d'
c.colors.downloads.start.bg  = '#686B98'
c.colors.downloads.start.fg  = '#0c0e0d'
c.colors.downloads.stop.bg   = '#4B5A8C'
c.colors.downloads.stop.fg   = '#0c0e0d'
c.colors.downloads.system.bg = 'rgb' # rgb, hsv, hsl, none
c.colors.downloads.system.fg = 'rgb' # rgb, hsv, hsl, none

# ━━ hints
c.colors.hints.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 rgba(80, 101, 150, 0.8), stop:1 rgba(80, 101, 150, 0.8))'
c.colors.hints.fg          = '#0c0e0d'
c.colors.hints.match.fg    = '#4B5A8C'
c.colors.keyhint.bg        = 'rgba(80, 101, 150, 80%)'
c.colors.keyhint.fg        = '#0c0e0d'
c.colors.keyhint.suffix.fg = '#a89eaa'

# ━━ errors
c.colors.messages.error.bg     = '#316BAC'
c.colors.messages.error.border = '#316BAC'
c.colors.messages.error.fg     = '#0c0e0d'

# ━━ info
c.colors.messages.info.bg     = '#0c0e0d'
c.colors.messages.info.border = '#0c0e0d'
c.colors.messages.info.fg     = '#a89eaa'

# ━━ warning
c.colors.messages.warning.bg     = '#506596'
c.colors.messages.warning.border = '#506596'
c.colors.messages.warning.fg     = '#a89eaa'

# ━━ prompts
c.colors.prompts.bg          = '#a89eaa'
c.colors.prompts.border      = '1px solid #a89eaa'
c.colors.prompts.fg          = '#0c0e0d'
c.colors.prompts.selected.bg = '#686B98'

# ━━ statusbar
c.colors.statusbar.caret.fg             = '#4A70AA'
c.colors.statusbar.caret.bg             = '#a89eaa'
c.colors.statusbar.caret.selection.fg   = '#4A70AA'
c.colors.statusbar.caret.selection.bg   = '#a89eaa'
c.colors.statusbar.command.fg           = '#0c0e0d'
c.colors.statusbar.command.bg           = '#a89eaa'
c.colors.statusbar.command.private.bg   = '#807682'
c.colors.statusbar.command.private.fg   = '#0c0e0d'
c.colors.statusbar.insert.fg            = '#4B5A8C'
c.colors.statusbar.insert.bg            = '#a89eaa'
c.colors.statusbar.normal.fg            = '#686B98'
c.colors.statusbar.normal.bg            = '#a89eaa'
c.colors.statusbar.passthrough.bg       = '#a89eaa'
c.colors.statusbar.passthrough.fg       = '#0c0e0d'
c.colors.statusbar.private.bg           = '#807682'
c.colors.statusbar.private.fg           = '#0c0e0d'
c.colors.statusbar.progress.bg          = '#0c0e0d'
c.colors.statusbar.url.error.fg         = '#316BAC'
c.colors.statusbar.url.fg               = '#0c0e0d'
c.colors.statusbar.url.hover.fg         = '#686B98'
c.colors.statusbar.url.success.http.fg  = '#0c0e0d'
c.colors.statusbar.url.success.https.fg = '#0c0e0d'
c.colors.statusbar.url.warn.fg          = '#506596'

# ━━ tabs
c.colors.tabs.bar.bg           = '#a89eaa'
c.colors.tabs.even.bg          = '#a89eaa'
c.colors.tabs.even.fg          = '#0c0e0d'
c.colors.tabs.odd.bg           = '#a89eaa'
c.colors.tabs.odd.fg           = '#0c0e0d'
c.colors.tabs.indicator.error  = '#316BAC'
c.colors.tabs.indicator.start  = '#686B98'
c.colors.tabs.indicator.stop   = '#4B5A8C'
c.colors.tabs.indicator.system = 'rgb' # rgb, hsv, hsl, none
c.colors.tabs.selected.even.bg = '#686B98'
c.colors.tabs.selected.even.fg = '#a89eaa'
c.colors.tabs.selected.odd.bg  = '#686B98'
c.colors.tabs.selected.odd.fg  = '#a89eaa'
...
c.hints.border                     = '1px solid #506596'
