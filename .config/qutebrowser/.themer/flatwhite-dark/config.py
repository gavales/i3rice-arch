...
c.hints.border = '1px solid #c2b747'
...
c.colors.completion.category.fg                 = '#F7F3EE'
c.colors.completion.even.bg                     = '#5d5040'
c.colors.completion.odd.bg                      = '#5d5040'
c.colors.completion.fg                          = ['#277eb8', '#F7F3EE', '#857868']
c.colors.completion.item.selected.bg            = '#277eb8'
c.colors.completion.item.selected.fg            = '#F7F3EE'
...
c.colors.completion.scrollbar.bg                = '#5d5040'
c.colors.completion.scrollbar.fg                = '#F7F3EE'
...
c.colors.downloads.bar.bg    = '#5d5040'
c.colors.downloads.error.bg  = '#b85227'
c.colors.downloads.error.fg  = '#F7F3EE'
c.colors.downloads.start.bg  = '#277eb8'
c.colors.downloads.start.fg  = '#F7F3EE'
c.colors.downloads.stop.bg   = '#18E3C8'
c.colors.downloads.stop.fg   = '#F7F3EE'
...
c.colors.hints.fg          = '#F7F3EE'
c.colors.hints.match.fg    = '#18E3C8'
c.colors.keyhint.bg        = 'rgba(221, 183, 0, 80%)'
c.colors.keyhint.fg        = '#F7F3EE'
c.colors.keyhint.suffix.fg = '#5d5040'

c.colors.messages.error.bg     = '#aa7461'
c.colors.messages.error.border = '#aa7461'
c.colors.messages.error.fg     = '#493C2C'
c.colors.messages.info.bg     = '#5d5040'
c.colors.messages.info.border = '#5d5040'
c.colors.messages.info.fg     = '#F7F3EE'
c.colors.messages.warning.bg     = '#c2b747'
c.colors.messages.warning.border = '#c2b747'
c.colors.messages.warning.fg     = '#F7F3EE'

c.colors.prompts.bg          = '#493C2C'
c.colors.prompts.border      = '1px solid #5d5040'
c.colors.prompts.fg          = '#F7F3EE'
c.colors.prompts.selected.bg = '#385d72'

c.colors.statusbar.caret.fg             = '#B043D1'
c.colors.statusbar.caret.bg             = '#44433c'
c.colors.statusbar.caret.selection.fg   = '#493C2C'
c.colors.statusbar.caret.selection.bg   = '#a46ad1'
c.colors.statusbar.command.fg           = '#F7F3EE'
c.colors.statusbar.command.bg           = '#44433c'
c.colors.statusbar.command.private.bg   = '#cfcbc6'
c.colors.statusbar.command.private.fg   = '#493C2C'
c.colors.statusbar.insert.fg            = '#40d4cb'
c.colors.statusbar.insert.bg            = '#44433c'
c.colors.statusbar.normal.fg            = '#F7F3EE'
c.colors.statusbar.normal.bg            = '#44433c'
c.colors.statusbar.passthrough.bg       = '#385d72'
c.colors.statusbar.passthrough.fg       = '#F7F3EE'
c.colors.statusbar.private.bg           = '#5acfe4'
c.colors.statusbar.private.fg           = '#F7F3EE'
c.colors.statusbar.progress.bg          = '#F7F3EE'
c.colors.statusbar.url.error.fg         = '#aa7461'
c.colors.statusbar.url.fg               = '#e3dfda'
c.colors.statusbar.url.hover.fg         = '#F7F3EE'
c.colors.statusbar.url.success.http.fg  = '#40d4cb'
c.colors.statusbar.url.success.https.fg = '#40d4cb'
c.colors.statusbar.url.warn.fg          = '#c2b747'

c.colors.tabs.bar.bg           = '#385d72'
c.colors.tabs.even.bg          = '#385d72'
c.colors.tabs.even.fg          = '#277eb8'
c.colors.tabs.odd.bg           = '#3c545f'
c.colors.tabs.odd.fg           = '#277eb8'
c.colors.tabs.indicator.error  = '#aa7461'
c.colors.tabs.indicator.start  = '#40d4cb'
c.colors.tabs.indicator.stop   = '#277eb8'
c.colors.tabs.indicator.system = 'rgb'                      # rgb, hsv, hsl, none
c.colors.tabs.selected.even.bg = '#44433c'
c.colors.tabs.selected.even.fg = '#F7F3EE'
c.colors.tabs.selected.odd.bg  = '#44433c'
c.colors.tabs.selected.odd.fg  = '#F7F3EE'
c.colors.tabs.pinned.even.bg          = '#4a91c1'
c.colors.tabs.pinned.even.fg          = '#F7F3EE'
c.colors.tabs.pinned.odd.bg           = '#4a91c1'
c.colors.tabs.pinned.odd.fg           = '#F7F3EE'
c.colors.tabs.pinned.selected.even.bg = '#44433c'
c.colors.tabs.pinned.selected.even.fg = '#8fb8d3'
c.colors.tabs.pinned.selected.odd.bg  = '#44433c'
c.colors.tabs.pinned.selected.odd.fg  = '#8fb8d3'

c.colors.webpage.bg = '#44433c'
