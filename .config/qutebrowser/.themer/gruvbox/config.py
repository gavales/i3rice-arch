...
c.hints.border = '1px solid #ab7c22'

c.colors.completion.category.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #689d6a, stop:1 #689d6a)'
c.colors.completion.category.border.bottom      = '#689d6a'
c.colors.completion.category.border.top         = '#689d6a'
c.colors.completion.category.fg                 = '#282828'
c.colors.completion.even.bg                     = '#e7ddb3'
c.colors.completion.odd.bg                      = '#e7ddb3'
c.colors.completion.fg                          = ['#689d6a', '#282828', '#bfb58b']
...
c.colors.completion.item.selected.match.fg      = '#689d6a'
c.colors.completion.scrollbar.bg                = '#e7ddb3'
...
c.colors.downloads.bar.bg    = '#e7ddb3'
c.colors.downloads.error.bg  = '#cc241d'
c.colors.downloads.error.fg  = '#282828'
...
c.colors.keyhint.fg        = '#282828'
c.colors.keyhint.suffix.fg = '#e7ddb3'

c.colors.messages.error.bg     = '#a3251f'
c.colors.messages.error.border = '#a3251f'
c.colors.messages.error.fg     = '#fbf1c7'
c.colors.messages.info.bg     = '#e7ddb3'
c.colors.messages.info.border = '#e7ddb3'
c.colors.messages.info.fg     = '#282828'
c.colors.messages.warning.bg     = '#ab7c22'
c.colors.messages.warning.border = '#ab7c22'
c.colors.messages.warning.fg     = '#282828'

c.colors.prompts.bg          = '#fbf1c7'
c.colors.prompts.border      = '1px solid #e7ddb3'
c.colors.prompts.fg          = '#282828'
c.colors.prompts.selected.bg = '#b1c798'

c.colors.statusbar.caret.fg             = '#b16286'
c.colors.statusbar.caret.bg             = '#e9e6bb'
c.colors.statusbar.caret.selection.fg   = '#fbf1c7'
c.colors.statusbar.caret.selection.bg   = '#8e536e'
c.colors.statusbar.command.fg           = '#282828'
c.colors.statusbar.command.bg           = '#e9e6bb'
c.colors.statusbar.command.private.bg   = '#505050'
c.colors.statusbar.command.private.fg   = '#fbf1c7'
c.colors.statusbar.insert.fg            = '#7c7b1d'
c.colors.statusbar.insert.bg            = '#e9e6bb'
c.colors.statusbar.normal.fg            = '#282828'
c.colors.statusbar.normal.bg            = '#e9e6bb'
c.colors.statusbar.passthrough.bg       = '#b1c798'
c.colors.statusbar.passthrough.fg       = '#282828'
c.colors.statusbar.private.bg           = '#3d6d70'
c.colors.statusbar.private.fg           = '#282828'
c.colors.statusbar.progress.bg          = '#282828'
c.colors.statusbar.url.error.fg         = '#a3251f'
c.colors.statusbar.url.fg               = '#3c3c3c'
c.colors.statusbar.url.hover.fg         = '#282828'
c.colors.statusbar.url.success.http.fg  = '#7c7b1d'
c.colors.statusbar.url.success.https.fg = '#7c7b1d'
c.colors.statusbar.url.warn.fg          = '#ab7c22'

c.colors.tabs.bar.bg           = '#b1c798'
c.colors.tabs.even.bg          = '#b1c798'
c.colors.tabs.even.fg          = '#689d6a'
c.colors.tabs.odd.bg           = '#c4d1a4'
c.colors.tabs.odd.fg           = '#689d6a'
c.colors.tabs.indicator.error  = '#a3251f'
c.colors.tabs.indicator.start  = '#7c7b1d'
c.colors.tabs.indicator.stop   = '#689d6a'
c.colors.tabs.indicator.system = 'rgb'                      # rgb, hsv, hsl, none
c.colors.tabs.selected.even.bg = '#e9e6bb'
c.colors.tabs.selected.even.fg = '#282828'
c.colors.tabs.selected.odd.bg  = '#e9e6bb'
c.colors.tabs.selected.odd.fg  = '#282828'
c.colors.tabs.pinned.even.bg          = '#587f59'
c.colors.tabs.pinned.even.fg          = '#282828'
c.colors.tabs.pinned.odd.bg           = '#587f59'
c.colors.tabs.pinned.odd.fg           = '#282828'
c.colors.tabs.pinned.selected.even.bg = '#e9e6bb'
c.colors.tabs.pinned.selected.even.fg = '#486249'
c.colors.tabs.pinned.selected.odd.bg  = '#e9e6bb'
c.colors.tabs.pinned.selected.odd.fg  = '#486249'

c.colors.webpage.bg = '#e9e6bb'
