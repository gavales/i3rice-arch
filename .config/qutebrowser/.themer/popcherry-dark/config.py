...
# ━  COLORS
# ━━ completion
c.colors.completion.category.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #65A9AA, stop:1 #65A9AA)'
c.colors.completion.category.border.bottom      = '#65A9AA'
c.colors.completion.category.border.top         = '#65A9AA'
c.colors.completion.category.fg                 = '#231F20'
c.colors.completion.even.bg                     = '#373334'
c.colors.completion.odd.bg                      = '#373334'
c.colors.completion.fg                          = ['#65A9AA', '#e9f1f1', '#5f5b5c']
c.colors.completion.item.selected.bg            = '#65A9AA'
...
c.colors.completion.match.fg                    = '#65A9AA'
c.colors.completion.scrollbar.bg                = '#373334'
c.colors.completion.scrollbar.fg                = '#e9f1f1'

# ━━ downloads
c.colors.downloads.bar.bg    = '#373334'
c.colors.downloads.error.bg  = '#b85227'
c.colors.downloads.error.fg  = '#e9f1f1'
c.colors.downloads.start.bg  = '#65A9AA'
c.colors.downloads.start.fg  = '#e9f1f1'
c.colors.downloads.stop.bg   = '#18E3C8'
c.colors.downloads.stop.fg   = '#e9f1f1'
...
c.colors.prompts.fg          = '#e9f1f1'
c.colors.prompts.selected.bg = '#65A9AA'
