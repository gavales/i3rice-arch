...
c.hints.border = '1px solid #cf7423'

c.colors.completion.category.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #b46b7d, stop:1 #b46b7d)'
c.colors.completion.category.border.bottom      = '#b46b7d'
c.colors.completion.category.border.top         = '#b46b7d'
c.colors.completion.category.fg                 = '#303030'
c.colors.completion.even.bg                     = '#e2e2e0'
c.colors.completion.odd.bg                      = '#e2e2e0'
c.colors.completion.fg                          = ['#b46b7d', '#303030', '#babab8']
c.colors.completion.item.selected.bg            = '#b46b7d'
c.colors.completion.item.selected.fg            = '#303030'
c.colors.completion.item.selected.border.bottom = '#47aa12'
c.colors.completion.item.selected.border.top    = '#47aa12'
c.colors.completion.match.fg                    = '#b46b7d'
c.colors.completion.item.selected.match.fg      = '#b46b7d'
c.colors.completion.scrollbar.bg                = '#e2e2e0'
...
c.colors.downloads.bar.bg    = '#e2e2e0'
c.colors.downloads.error.bg  = '#ff4845'
c.colors.downloads.error.fg  = '#303030'
c.colors.downloads.start.bg  = '#b46b7d'
c.colors.downloads.start.fg  = '#303030'
c.colors.downloads.stop.bg   = '#47aa12'
c.colors.downloads.stop.fg   = '#303030'
c.colors.downloads.system.bg = 'rgb' # rgb, hsv, hsl, none
c.colors.downloads.system.fg = 'rgb' # rgb, hsv, hsl, none

c.colors.hints.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 rgba(255, 137, 10, 0.8), stop:1 rgba(255, 137, 10, 0.8))'
c.colors.hints.fg          = '#303030'
c.colors.hints.match.fg    = '#47aa12'
c.colors.keyhint.bg        = 'rgba(255, 137, 10, 80%)'
c.colors.keyhint.fg        = '#303030'
c.colors.keyhint.suffix.fg = '#e2e2e0'

c.colors.messages.error.bg     = '#cf494a'
c.colors.messages.error.border = '#cf494a'
c.colors.messages.error.fg     = '#f6f6f4'
c.colors.messages.info.bg     = '#e2e2e0'
c.colors.messages.info.border = '#e2e2e0'
c.colors.messages.info.fg     = '#303030'
c.colors.messages.warning.bg     = '#cf7423'
c.colors.messages.warning.border = '#cf7423'
c.colors.messages.warning.fg     = '#303030'

c.colors.prompts.bg          = '#f6f6f4'
c.colors.prompts.border      = '1px solid #e2e2e0'
c.colors.prompts.fg          = '#303030'
c.colors.prompts.selected.bg = '#d5b0b8'

c.colors.statusbar.caret.fg             = '#288ad6'
c.colors.statusbar.caret.bg             = '#eee5e5'
c.colors.statusbar.caret.selection.fg   = '#f6f6f4'
c.colors.statusbar.caret.selection.bg   = '#4175aa'
c.colors.statusbar.command.fg           = '#303030'
c.colors.statusbar.command.bg           = '#eee5e5'
c.colors.statusbar.command.private.bg   = '#585858'
c.colors.statusbar.command.private.fg   = '#f6f6f4'
c.colors.statusbar.insert.fg            = '#558a29'
c.colors.statusbar.insert.bg            = '#eee5e5'
c.colors.statusbar.normal.fg            = '#303030'
c.colors.statusbar.normal.bg            = '#eee5e5'
c.colors.statusbar.passthrough.bg       = '#d5b0b8'
c.colors.statusbar.passthrough.fg       = '#303030'
c.colors.statusbar.private.bg           = '#6d9088'
c.colors.statusbar.private.fg           = '#303030'
c.colors.statusbar.progress.bg          = '#303030'
c.colors.statusbar.url.error.fg         = '#cf494a'
c.colors.statusbar.url.fg               = '#444444'
c.colors.statusbar.url.hover.fg         = '#303030'
c.colors.statusbar.url.success.http.fg  = '#558a29'
c.colors.statusbar.url.success.https.fg = '#558a29'
c.colors.statusbar.url.warn.fg          = '#cf7423'

c.colors.tabs.bar.bg           = '#d5b0b8'
c.colors.tabs.even.bg          = '#d5b0b8'
c.colors.tabs.even.fg          = '#b46b7d'
c.colors.tabs.odd.bg           = '#ddc2c7'
c.colors.tabs.odd.fg           = '#b46b7d'
c.colors.tabs.indicator.error  = '#cf494a'
c.colors.tabs.indicator.start  = '#558a29'
c.colors.tabs.indicator.stop   = '#b46b7d'
c.colors.tabs.indicator.system = 'rgb'                      # rgb, hsv, hsl, none
c.colors.tabs.selected.even.bg = '#eee5e5'
c.colors.tabs.selected.even.fg = '#303030'
c.colors.tabs.selected.odd.bg  = '#eee5e5'
c.colors.tabs.selected.odd.fg  = '#303030'
c.colors.tabs.pinned.even.bg          = '#9d606f'
c.colors.tabs.pinned.even.fg          = '#303030'
c.colors.tabs.pinned.odd.bg           = '#9d606f'
c.colors.tabs.pinned.odd.fg           = '#303030'
c.colors.tabs.pinned.selected.even.bg = '#eee5e5'
c.colors.tabs.pinned.selected.even.fg = '#724d56'
c.colors.tabs.pinned.selected.odd.bg  = '#eee5e5'
c.colors.tabs.pinned.selected.odd.fg  = '#724d56'

c.colors.webpage.bg = '#eee5e5'
