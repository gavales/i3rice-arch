...
c.hints.border = '1px solid #b5c19b'
...
c.colors.completion.category.fg                 = '#60473A'
c.colors.completion.even.bg                     = '#e8e8e7'
c.colors.completion.odd.bg                      = '#e8e8e7'
c.colors.completion.fg                          = ['#A3C99C', '#60473A', '#c0c0bf']
c.colors.completion.item.selected.bg            = '#A3C99C'
c.colors.completion.item.selected.fg            = '#60473A'
...
c.colors.completion.scrollbar.bg                = '#e8e8e7'
c.colors.completion.scrollbar.fg                = '#60473A'
...
c.colors.downloads.bar.bg    = '#e8e8e7'
c.colors.downloads.error.bg  = '#BEB7C6'
c.colors.downloads.error.fg  = '#60473A'
c.colors.downloads.start.bg  = '#A3C99C'
c.colors.downloads.start.fg  = '#60473A'
c.colors.downloads.stop.bg   = '#CCDCB9'
c.colors.downloads.stop.fg   = '#60473A'
...
c.colors.hints.fg          = '#60473A'
c.colors.hints.match.fg    = '#CCDCB9'
c.colors.keyhint.bg        = 'rgba(208, 223, 180, 80%)'
c.colors.keyhint.fg        = '#60473A'
c.colors.keyhint.suffix.fg = '#e8e8e7'

c.colors.messages.error.bg     = '#a9a7a7'
c.colors.messages.error.border = '#a9a7a7'
c.colors.messages.error.fg     = '#fcfcfb'
c.colors.messages.info.bg     = '#e8e8e7'
c.colors.messages.info.border = '#e8e8e7'
c.colors.messages.info.fg     = '#60473A'
c.colors.messages.warning.bg     = '#b5c19b'
c.colors.messages.warning.border = '#b5c19b'
c.colors.messages.warning.fg     = '#60473A'

c.colors.prompts.bg          = '#fcfcfb'
c.colors.prompts.border      = '1px solid #e8e8e7'
c.colors.prompts.fg          = '#60473A'
c.colors.prompts.selected.bg = '#cfe2cb'

c.colors.statusbar.caret.fg             = '#9FCCD3'
c.colors.statusbar.caret.bg             = '#f1f5ef'
c.colors.statusbar.caret.selection.fg   = '#fcfcfb'
c.colors.statusbar.caret.selection.bg   = '#94b4af'
c.colors.statusbar.command.fg           = '#60473A'
c.colors.statusbar.command.bg           = '#f1f5ef'
c.colors.statusbar.command.private.bg   = '#886f62'
c.colors.statusbar.command.private.fg   = '#fcfcfb'
c.colors.statusbar.insert.fg            = '#b2bf9e'
c.colors.statusbar.insert.bg            = '#f1f5ef'
c.colors.statusbar.normal.fg            = '#60473A'
c.colors.statusbar.normal.bg            = '#f1f5ef'
c.colors.statusbar.passthrough.bg       = '#cfe2cb'
c.colors.statusbar.passthrough.fg       = '#60473A'
c.colors.statusbar.private.bg           = '#babfae'
c.colors.statusbar.private.fg           = '#60473A'
c.colors.statusbar.progress.bg          = '#60473A'
c.colors.statusbar.url.error.fg         = '#a9a7a7'
c.colors.statusbar.url.fg               = '#745b4e'
c.colors.statusbar.url.hover.fg         = '#60473A'
c.colors.statusbar.url.success.http.fg  = '#b2bf9e'
c.colors.statusbar.url.success.https.fg = '#b2bf9e'
c.colors.statusbar.url.warn.fg          = '#b5c19b'

c.colors.tabs.bar.bg           = '#cfe2cb'
c.colors.tabs.even.bg          = '#cfe2cb'
c.colors.tabs.even.fg          = '#A3C99C'
c.colors.tabs.odd.bg           = '#dbe9d7'
c.colors.tabs.odd.fg           = '#A3C99C'
c.colors.tabs.indicator.error  = '#a9a7a7'
c.colors.tabs.indicator.start  = '#b2bf9e'
c.colors.tabs.indicator.stop   = '#A3C99C'
c.colors.tabs.indicator.system = 'rgb'                      # rgb, hsv, hsl, none
c.colors.tabs.selected.even.bg = '#f1f5ef'
c.colors.tabs.selected.even.fg = '#60473A'
c.colors.tabs.selected.odd.bg  = '#f1f5ef'
c.colors.tabs.selected.odd.fg  = '#60473A'
c.colors.tabs.pinned.even.bg          = '#45819d'
c.colors.tabs.pinned.even.fg          = '#60473A'
c.colors.tabs.pinned.odd.bg           = '#45819d'
c.colors.tabs.pinned.odd.fg           = '#60473A'
c.colors.tabs.pinned.selected.even.bg = '#f1f5ef'
c.colors.tabs.pinned.selected.even.fg = '#81886b'
c.colors.tabs.pinned.selected.odd.bg  = '#f1f5ef'
c.colors.tabs.pinned.selected.odd.fg  = '#81886b'

c.colors.webpage.bg = '#f1f5ef'
