...
c.colors.completion.fg                          = ['#e06a26', '#fffff0', '#676767']
c.colors.completion.item.selected.bg            = '#e06a26'
c.colors.completion.item.selected.fg            = '#3f3f3f'
...
c.colors.completion.scrollbar.fg                = '#fffff0'

# ━━ downloads
c.colors.downloads.bar.bg    = '#3f3f3f'
c.colors.downloads.error.bg  = '#f55050'
c.colors.downloads.error.fg  = '#fffff0'
c.colors.downloads.start.bg  = '#e06a26'
c.colors.downloads.start.fg  = '#fffff0'
c.colors.downloads.stop.bg   = '#219e21'
c.colors.downloads.stop.fg   = '#fffff0'
...
c.colors.hints.fg          = '#fffff0'
c.colors.hints.match.fg    = '#219e21'
c.colors.keyhint.bg        = 'rgba(212, 172, 53, 80%)'
c.colors.keyhint.fg        = '#fffff0'
c.colors.keyhint.suffix.fg = '#3f3f3f'

# ━━ errors
c.colors.messages.error.bg     = '#f55050'
c.colors.messages.error.border = '#f55050'
c.colors.messages.error.fg     = '#fffff0'

# ━━ info
c.colors.messages.info.bg     = '#fffff0'
c.colors.messages.info.border = '#fffff0'
c.colors.messages.info.fg     = '#3f3f3f'
...
c.colors.prompts.border      = '1px solid #3f3f3f'
c.colors.prompts.fg          = '#fffff0'
c.colors.prompts.selected.bg = '#e06a26'

# ━━ statusbar
c.colors.statusbar.caret.fg             = '#a26fbf'
c.colors.statusbar.caret.bg             = '#3f3f3f'
c.colors.statusbar.caret.selection.fg   = '#a26fbf'
c.colors.statusbar.caret.selection.bg   = '#3f3f3f'
c.colors.statusbar.command.fg           = '#fffff0'
c.colors.statusbar.command.bg           = '#3f3f3f'
c.colors.statusbar.command.private.bg   = '#676767'
c.colors.statusbar.command.private.fg   = '#fffff0'
c.colors.statusbar.insert.fg            = '#219e21'
c.colors.statusbar.insert.bg            = '#3f3f3f'
c.colors.statusbar.normal.fg            = '#e06a26'
c.colors.statusbar.normal.bg            = '#3f3f3f'
c.colors.statusbar.passthrough.bg       = '#3f3f3f'
c.colors.statusbar.passthrough.fg       = '#fffff0'
c.colors.statusbar.private.bg           = '#676767'
c.colors.statusbar.private.fg           = '#fffff0'
c.colors.statusbar.progress.bg          = '#fffff0'
c.colors.statusbar.url.error.fg         = '#f55050'
c.colors.statusbar.url.fg               = '#fffff0'
c.colors.statusbar.url.hover.fg         = '#e06a26'
c.colors.statusbar.url.success.http.fg  = '#fffff0'
c.colors.statusbar.url.success.https.fg = '#fffff0'
c.colors.statusbar.url.warn.fg          = '#d4ac35'

# ━━ tabs
c.colors.tabs.bar.bg           = '#3f3f3f'
c.colors.tabs.even.bg          = '#3f3f3f'
c.colors.tabs.even.fg          = '#fffff0'
c.colors.tabs.odd.bg           = '#3f3f3f'
c.colors.tabs.odd.fg           = '#fffff0'
