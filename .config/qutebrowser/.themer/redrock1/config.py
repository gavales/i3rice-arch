...
c.hints.border = '1px solid #8b7761'
...
c.colors.completion.category.fg                 = '#3e443e'
c.colors.completion.even.bg                     = '#e5dbd5'
c.colors.completion.odd.bg                      = '#e5dbd5'
c.colors.completion.fg                          = ['#DC8E69', '#3e443e', '#bdb3ad']
c.colors.completion.item.selected.bg            = '#DC8E69'
c.colors.completion.item.selected.fg            = '#3e443e'
...
c.colors.completion.scrollbar.fg                = '#3e443e'
...
c.colors.downloads.error.fg  = '#3e443e'
c.colors.downloads.start.bg  = '#DC8E69'
c.colors.downloads.start.fg  = '#3e443e'
c.colors.downloads.stop.bg   = '#507C88'
c.colors.downloads.stop.fg   = '#3e443e'
...
c.colors.hints.fg          = '#3e443e'
c.colors.hints.match.fg    = '#507C88'
c.colors.keyhint.bg        = 'rgba(165, 137, 109, 80%)'
c.colors.keyhint.fg        = '#3e443e'
c.colors.keyhint.suffix.fg = '#e5dbd5'

c.colors.messages.error.bg     = '#627d8c'
c.colors.messages.error.border = '#627d8c'
c.colors.messages.error.fg     = '#f9efe9'
c.colors.messages.info.bg     = '#e5dbd5'
c.colors.messages.info.border = '#e5dbd5'
c.colors.messages.info.fg     = '#3e443e'
c.colors.messages.warning.bg     = '#8b7761'
c.colors.messages.warning.border = '#8b7761'
c.colors.messages.warning.fg     = '#3e443e'

c.colors.prompts.bg          = '#f9efe9'
c.colors.prompts.border      = '1px solid #e5dbd5'
c.colors.prompts.fg          = '#3e443e'
c.colors.prompts.selected.bg = '#eabea9'

c.colors.statusbar.caret.fg             = '#609AC1'
c.colors.statusbar.caret.bg             = '#f5e3d9'
c.colors.statusbar.caret.selection.fg   = '#f9efe9'
c.colors.statusbar.caret.selection.bg   = '#5784a0'
c.colors.statusbar.command.fg           = '#3e443e'
c.colors.statusbar.command.bg           = '#f5e3d9'
c.colors.statusbar.command.private.bg   = '#666c66'
c.colors.statusbar.command.private.fg   = '#f9efe9'
c.colors.statusbar.insert.fg            = '#4b6e75'
c.colors.statusbar.insert.bg            = '#f5e3d9'
c.colors.statusbar.normal.fg            = '#3e443e'
c.colors.statusbar.normal.bg            = '#f5e3d9'
c.colors.statusbar.passthrough.bg       = '#eabea9'
c.colors.statusbar.passthrough.fg       = '#3e443e'
c.colors.statusbar.private.bg           = '#57a199'
c.colors.statusbar.private.fg           = '#3e443e'
c.colors.statusbar.progress.bg          = '#3e443e'
c.colors.statusbar.url.error.fg         = '#627d8c'
c.colors.statusbar.url.fg               = '#525852'
c.colors.statusbar.url.hover.fg         = '#3e443e'
c.colors.statusbar.url.success.http.fg  = '#4b6e75'
c.colors.statusbar.url.success.https.fg = '#4b6e75'
c.colors.statusbar.url.warn.fg          = '#8b7761'

c.colors.tabs.bar.bg           = '#eabea9'
c.colors.tabs.even.bg          = '#eabea9'
c.colors.tabs.even.fg          = '#DC8E69'
c.colors.tabs.odd.bg           = '#eecbb9'
c.colors.tabs.odd.fg           = '#DC8E69'
c.colors.tabs.indicator.error  = '#627d8c'
c.colors.tabs.indicator.start  = '#4b6e75'
c.colors.tabs.indicator.stop   = '#DC8E69'
c.colors.tabs.indicator.system = 'rgb'                      # rgb, hsv, hsl, none
c.colors.tabs.selected.even.bg = '#f5e3d9'
c.colors.tabs.selected.even.fg = '#3e443e'
c.colors.tabs.selected.odd.bg  = '#f5e3d9'
c.colors.tabs.selected.odd.fg  = '#3e443e'
c.colors.tabs.pinned.even.bg          = '#b47b5e'
c.colors.tabs.pinned.even.fg          = '#3e443e'
c.colors.tabs.pinned.odd.bg           = '#b47b5e'
c.colors.tabs.pinned.odd.fg           = '#3e443e'
c.colors.tabs.pinned.selected.even.bg = '#f5e3d9'
c.colors.tabs.pinned.selected.even.fg = '#8d6953'
c.colors.tabs.pinned.selected.odd.bg  = '#f5e3d9'
c.colors.tabs.pinned.selected.odd.fg  = '#8d6953'

c.colors.webpage.bg = '#f5e3d9'
