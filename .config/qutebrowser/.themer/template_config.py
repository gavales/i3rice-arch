...
c.hints.border = '1px solid %%darkylw%%'

c.colors.completion.category.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 %%acc%%, stop:1 %%acc%%)'
c.colors.completion.category.border.bottom      = '%%acc%%'
c.colors.completion.category.border.top         = '%%acc%%'
c.colors.completion.category.fg                 = '%%fg0%%'
c.colors.completion.even.bg                     = '%%bg1%%'
c.colors.completion.odd.bg                      = '%%bg1%%'
c.colors.completion.fg                          = ['%%acc%%', '%%fg0%%', '%%bg3%%']
...
c.colors.keyhint.suffix.fg = '%%bg1%%'
...
c.colors.messages.warning.bg     = '%%darkylw%%'
c.colors.messages.warning.border = '%%darkylw%%'
c.colors.messages.warning.fg     = '%%fg0%%'

c.colors.prompts.bg          = '%%bg0%%'
c.colors.prompts.border      = '1px solid %%bg1%%'
c.colors.prompts.fg          = '%%fg0%%'
c.colors.prompts.selected.bg = '%%acb%%'

c.colors.statusbar.caret.fg             = '%%gnt%%'
c.colors.statusbar.caret.bg             = '%%ac88b%%'
c.colors.statusbar.caret.selection.fg   = '%%bg0%%'
c.colors.statusbar.caret.selection.bg   = '%%darkgnt%%'
c.colors.statusbar.command.fg           = '%%fg0%%'
c.colors.statusbar.command.bg           = '%%ac88b%%'
c.colors.statusbar.command.private.bg   = '%%fg2%%'
c.colors.statusbar.command.private.fg   = '%%bg0%%'
c.colors.statusbar.insert.fg            = '%%darkgrn%%'
c.colors.statusbar.insert.bg            = '%%ac88b%%'
c.colors.statusbar.normal.fg            = '%%fg0%%'
c.colors.statusbar.normal.bg            = '%%ac88b%%'
c.colors.statusbar.passthrough.bg       = '%%acb%%'
c.colors.statusbar.passthrough.fg       = '%%fg0%%'
c.colors.statusbar.private.bg           = '%%darkcyn%%'
c.colors.statusbar.private.fg           = '%%fg0%%'
c.colors.statusbar.progress.bg          = '%%fg0%%'
c.colors.statusbar.url.error.fg         = '%%darkred%%'
c.colors.statusbar.url.fg               = '%%fg1%%'
c.colors.statusbar.url.hover.fg         = '%%fg0%%'
c.colors.statusbar.url.success.http.fg  = '%%darkgrn%%'
c.colors.statusbar.url.success.https.fg = '%%darkgrn%%'
c.colors.statusbar.url.warn.fg          = '%%darkylw%%'

c.colors.tabs.bar.bg           = '%%ac50b%%'
c.colors.tabs.even.bg          = '%%ac50b%%'
c.colors.tabs.even.fg          = '%%acc%%'
c.colors.tabs.odd.bg           = '%%ac63b%%'
c.colors.tabs.odd.fg           = '%%acc%%'
c.colors.tabs.indicator.error  = '%%darkred%%'
c.colors.tabs.indicator.start  = '%%darkgrn%%'
c.colors.tabs.indicator.stop   = '%%acc%%'
c.colors.tabs.indicator.system = 'rgb'                      # rgb, hsv, hsl, none
c.colors.tabs.selected.even.bg = '%%ac88b%%'
c.colors.tabs.selected.even.fg = '%%fg0%%'
c.colors.tabs.selected.odd.bg  = '%%ac88b%%'
c.colors.tabs.selected.odd.fg  = '%%fg0%%'
c.colors.tabs.pinned.even.bg          = '%%darkblu%%'
c.colors.tabs.pinned.even.fg          = '%%fg0%%'
c.colors.tabs.pinned.odd.bg           = '%%darkblu%%'
c.colors.tabs.pinned.odd.fg           = '%%fg0%%'
c.colors.tabs.pinned.selected.even.bg = '%%ac88b%%'
c.colors.tabs.pinned.selected.even.fg = '%%acf%%'
c.colors.tabs.pinned.selected.odd.bg  = '%%ac88b%%'
c.colors.tabs.pinned.selected.odd.fg  = '%%acf%%'

c.colors.webpage.bg = '%%ac88b%%'
...
c.fonts.default_family = ['%%editfont%%']
