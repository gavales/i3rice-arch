...
# ━  COLORS
# ━━ completion
c.colors.completion.category.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #414458, stop:1 #414458)'
c.colors.completion.category.border.bottom      = '#414458'
c.colors.completion.category.border.top         = '#414458'
c.colors.completion.category.fg                 = '#282A36'
c.colors.completion.even.bg                     = '#3c3e4a'
c.colors.completion.odd.bg                      = '#3c3e4a'
c.colors.completion.fg                          = ['#414458', '#fafafa', '#646672']
c.colors.completion.item.selected.bg            = '#414458'
...
c.colors.completion.match.fg                    = '#414458'
c.colors.completion.scrollbar.bg                = '#3c3e4a'
c.colors.completion.scrollbar.fg                = '#fafafa'

# ━━ downloads
c.colors.downloads.bar.bg    = '#3c3e4a'
c.colors.downloads.error.bg  = '#FF4971'
c.colors.downloads.error.fg  = '#fafafa'
c.colors.downloads.start.bg  = '#414458'
c.colors.downloads.start.fg  = '#fafafa'
c.colors.downloads.stop.bg   = '#18E3C8'
c.colors.downloads.stop.fg   = '#fafafa'
c.colors.downloads.system.bg = 'rgb' # rgb, hsv, hsl, none
c.colors.downloads.system.fg = 'rgb' # rgb, hsv, hsl, none

# ━━ hints
c.colors.hints.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 rgba(255, 128, 55, 0.8), stop:1 rgba(255, 128, 55, 0.8))'
c.colors.hints.fg          = '#fafafa'
c.colors.hints.match.fg    = '#18E3C8'
c.colors.keyhint.bg        = 'rgba(255, 128, 55, 80%)'
c.colors.keyhint.fg        = '#fafafa'
c.colors.keyhint.suffix.fg = '#3c3e4a'

# ━━ errors
c.colors.messages.error.bg     = '#FF4971'
c.colors.messages.error.border = '#FF4971'
c.colors.messages.error.fg     = '#fafafa'

# ━━ info
c.colors.messages.info.bg     = '#fafafa'
c.colors.messages.info.border = '#fafafa'
c.colors.messages.info.fg     = '#3c3e4a'

# ━━ warning
c.colors.messages.warning.bg     = '#FF8037'
c.colors.messages.warning.border = '#FF8037'
c.colors.messages.warning.fg     = '#3c3e4a'

# ━━ prompts
c.colors.prompts.bg          = '#3c3e4a'
c.colors.prompts.border      = '1px solid #3c3e4a'
c.colors.prompts.fg          = '#fafafa'
c.colors.prompts.selected.bg = '#414458'
...
c.colors.statusbar.command.fg           = '#fafafa'
...
c.colors.statusbar.normal.fg            = '#414458'
c.colors.statusbar.normal.bg            = '#3c3e4a'
c.colors.statusbar.passthrough.bg       = '#3c3e4a'
c.colors.statusbar.passthrough.fg       = '#fafafa'
c.colors.statusbar.private.bg           = '#646672'
c.colors.statusbar.private.fg           = '#fafafa'
c.colors.statusbar.progress.bg          = '#fafafa'
c.colors.statusbar.url.error.fg         = '#FF4971'
c.colors.statusbar.url.fg               = '#fafafa'
c.colors.statusbar.url.hover.fg         = '#414458'
c.colors.statusbar.url.success.http.fg  = '#fafafa'
c.colors.statusbar.url.success.https.fg = '#fafafa'
c.colors.statusbar.url.warn.fg          = '#FF8037'

# ━━ tabs
c.colors.tabs.bar.bg           = '#3c3e4a'
c.colors.tabs.even.bg          = '#3c3e4a'
c.colors.tabs.even.fg          = '#fafafa'
c.colors.tabs.odd.bg           = '#3c3e4a'
c.colors.tabs.odd.fg           = '#fafafa'
c.colors.tabs.indicator.error  = '#FF4971'
c.colors.tabs.indicator.start  = '#414458'
c.colors.tabs.indicator.stop   = '#18E3C8'
c.colors.tabs.indicator.system = 'rgb' # rgb, hsv, hsl, none
c.colors.tabs.selected.even.bg = '#414458'
c.colors.tabs.selected.even.fg = '#3c3e4a'
c.colors.tabs.selected.odd.bg  = '#414458'
...
c.hints.border                     = '1px solid #FF8037'
