...
c.hints.border = '1px solid #adadad'
...
c.colors.completion.category.fg                 = '#ececec'
c.colors.completion.even.bg                     = '#363636'
c.colors.completion.odd.bg                      = '#363636'
c.colors.completion.fg                          = ['#7f7f7f', '#ececec', '#5e5e5e']
c.colors.completion.item.selected.bg            = '#7f7f7f'
c.colors.completion.item.selected.fg            = '#ececec'
c.colors.completion.item.selected.border.bottom = '#999999'
c.colors.completion.item.selected.border.top    = '#999999'
c.colors.completion.match.fg                    = '#7f7f7f'
c.colors.completion.item.selected.match.fg      = '#7f7f7f'
c.colors.completion.scrollbar.bg                = '#363636'
...
c.colors.downloads.bar.bg    = '#363636'
c.colors.downloads.error.bg  = '#999999'
c.colors.downloads.error.fg  = '#ececec'
c.colors.downloads.start.bg  = '#7f7f7f'
c.colors.downloads.start.fg  = '#ececec'
c.colors.downloads.stop.bg   = '#999999'
c.colors.downloads.stop.fg   = '#ececec'
c.colors.downloads.system.bg = 'rgb' # rgb, hsv, hsl, none
c.colors.downloads.system.fg = 'rgb' # rgb, hsv, hsl, none

c.colors.hints.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 rgba(153, 153, 153, 0.8), stop:1 rgba(153, 153, 153, 0.8))'
c.colors.hints.fg          = '#ececec'
c.colors.hints.match.fg    = '#999999'
c.colors.keyhint.bg        = 'rgba(153, 153, 153, 80%)'
c.colors.keyhint.fg        = '#ececec'
c.colors.keyhint.suffix.fg = '#363636'

c.colors.messages.error.bg     = '#adadad'
c.colors.messages.error.border = '#adadad'
c.colors.messages.error.fg     = '#222222'
c.colors.messages.info.bg     = '#363636'
c.colors.messages.info.border = '#363636'
c.colors.messages.info.fg     = '#ececec'
c.colors.messages.warning.bg     = '#adadad'
c.colors.messages.warning.border = '#adadad'
c.colors.messages.warning.fg     = '#ececec'

c.colors.prompts.bg          = '#222222'
c.colors.prompts.border      = '1px solid #363636'
c.colors.prompts.fg          = '#ececec'
c.colors.prompts.selected.bg = '#505050'

c.colors.statusbar.caret.fg             = '#999999'
c.colors.statusbar.caret.bg             = '#2d2d2d'
c.colors.statusbar.caret.selection.fg   = '#222222'
c.colors.statusbar.caret.selection.bg   = '#adadad'
c.colors.statusbar.command.fg           = '#ececec'
c.colors.statusbar.command.bg           = '#2d2d2d'
c.colors.statusbar.command.private.bg   = '#c4c4c4'
c.colors.statusbar.command.private.fg   = '#222222'
c.colors.statusbar.insert.fg            = '#adadad'
c.colors.statusbar.insert.bg            = '#2d2d2d'
c.colors.statusbar.normal.fg            = '#ececec'
c.colors.statusbar.normal.bg            = '#2d2d2d'
c.colors.statusbar.passthrough.bg       = '#505050'
c.colors.statusbar.passthrough.fg       = '#ececec'
c.colors.statusbar.private.bg           = '#adadad'
c.colors.statusbar.private.fg           = '#ececec'
c.colors.statusbar.progress.bg          = '#ececec'
c.colors.statusbar.url.error.fg         = '#adadad'
c.colors.statusbar.url.fg               = '#d8d8d8'
c.colors.statusbar.url.hover.fg         = '#ececec'
c.colors.statusbar.url.success.http.fg  = '#adadad'
c.colors.statusbar.url.success.https.fg = '#adadad'
c.colors.statusbar.url.warn.fg          = '#adadad'

c.colors.tabs.bar.bg           = '#505050'
c.colors.tabs.even.bg          = '#505050'
c.colors.tabs.even.fg          = '#7f7f7f'
c.colors.tabs.odd.bg           = '#444444'
c.colors.tabs.odd.fg           = '#7f7f7f'
c.colors.tabs.indicator.error  = '#adadad'
c.colors.tabs.indicator.start  = '#adadad'
c.colors.tabs.indicator.stop   = '#7f7f7f'
c.colors.tabs.indicator.system = 'rgb'                      # rgb, hsv, hsl, none
c.colors.tabs.selected.even.bg = '#2d2d2d'
c.colors.tabs.selected.even.fg = '#ececec'
c.colors.tabs.selected.odd.bg  = '#2d2d2d'
c.colors.tabs.selected.odd.fg  = '#ececec'
c.colors.tabs.pinned.even.bg          = '#adadad'
c.colors.tabs.pinned.even.fg          = '#ececec'
c.colors.tabs.pinned.odd.bg           = '#adadad'
c.colors.tabs.pinned.odd.fg           = '#ececec'
c.colors.tabs.pinned.selected.even.bg = '#2d2d2d'
c.colors.tabs.pinned.selected.even.fg = '#b5b5b5'
c.colors.tabs.pinned.selected.odd.bg  = '#2d2d2d'
c.colors.tabs.pinned.selected.odd.fg  = '#b5b5b5'

c.colors.webpage.bg = '#2d2d2d'
