...
c.colors.completion.category.fg                 = '#fdd89a'
c.colors.completion.even.bg                     = '#e9c486'
c.colors.completion.odd.bg                      = '#e9c486'
c.colors.completion.fg                          = ['#fc796b', '#3c4542', '#c19c5e']
c.colors.completion.item.selected.bg            = '#fc796b'
c.colors.completion.item.selected.fg            = '#e9c486'
...
c.colors.completion.scrollbar.bg                = '#e9c486'
c.colors.completion.scrollbar.fg                = '#3c4542'

# ━━ downloads
c.colors.downloads.bar.bg    = '#e9c486'
c.colors.downloads.error.bg  = '#bcbfb4'
c.colors.downloads.error.fg  = '#3c4542'
c.colors.downloads.start.bg  = '#fc796b'
c.colors.downloads.start.fg  = '#3c4542'
c.colors.downloads.stop.bg   = '#a8cb79'
c.colors.downloads.stop.fg   = '#3c4542'
...
c.colors.hints.fg          = '#3c4542'
c.colors.hints.match.fg    = '#a8cb79'
c.colors.keyhint.bg        = 'rgba(237, 192, 116, 80%)'
c.colors.keyhint.fg        = '#3c4542'
c.colors.keyhint.suffix.fg = '#e9c486'

# ━━ errors
c.colors.messages.error.bg     = '#bcbfb4'
c.colors.messages.error.border = '#bcbfb4'
c.colors.messages.error.fg     = '#3c4542'

# ━━ info
c.colors.messages.info.bg     = '#3c4542'
c.colors.messages.info.border = '#3c4542'
c.colors.messages.info.fg     = '#e9c486'

# ━━ warning
c.colors.messages.warning.bg     = '#edc074'
c.colors.messages.warning.border = '#edc074'
c.colors.messages.warning.fg     = '#e9c486'

# ━━ prompts
c.colors.prompts.bg          = '#e9c486'
c.colors.prompts.border      = '1px solid #e9c486'
c.colors.prompts.fg          = '#3c4542'
c.colors.prompts.selected.bg = '#fc796b'

# ━━ statusbar
c.colors.statusbar.caret.fg             = '#d8bbbd'
c.colors.statusbar.caret.bg             = '#e9c486'
c.colors.statusbar.caret.selection.fg   = '#d8bbbd'
c.colors.statusbar.caret.selection.bg   = '#e9c486'
c.colors.statusbar.command.fg           = '#3c4542'
c.colors.statusbar.command.bg           = '#e9c486'
c.colors.statusbar.command.private.bg   = '#c19c5e'
c.colors.statusbar.command.private.fg   = '#3c4542'
c.colors.statusbar.insert.fg            = '#a8cb79'
c.colors.statusbar.insert.bg            = '#e9c486'
c.colors.statusbar.normal.fg            = '#fc796b'
c.colors.statusbar.normal.bg            = '#e9c486'
c.colors.statusbar.passthrough.bg       = '#e9c486'
c.colors.statusbar.passthrough.fg       = '#3c4542'
c.colors.statusbar.private.bg           = '#c19c5e'
c.colors.statusbar.private.fg           = '#3c4542'
c.colors.statusbar.progress.bg          = '#3c4542'
c.colors.statusbar.url.error.fg         = '#bcbfb4'
c.colors.statusbar.url.fg               = '#3c4542'
c.colors.statusbar.url.hover.fg         = '#fc796b'
c.colors.statusbar.url.success.http.fg  = '#3c4542'
c.colors.statusbar.url.success.https.fg = '#3c4542'
c.colors.statusbar.url.warn.fg          = '#edc074'

# ━━ tabs
c.colors.tabs.bar.bg           = '#e9c486'
c.colors.tabs.even.bg          = '#e9c486'
c.colors.tabs.even.fg          = '#3c4542'
c.colors.tabs.odd.bg           = '#e9c486'
c.colors.tabs.odd.fg           = '#3c4542'
...
c.colors.tabs.selected.even.fg = '#e9c486'
c.colors.tabs.selected.odd.bg  = '#fc796b'
c.colors.tabs.selected.odd.fg  = '#e9c486'
