...
c.hints.border = '1px solid #baa28c'
...
c.colors.completion.even.bg                     = '#525852'
c.colors.completion.odd.bg                      = '#525852'
c.colors.completion.fg                          = ['#DC8E69', '#f9efe9', '#7a807a']
c.colors.completion.item.selected.bg            = '#DC8E69'
c.colors.completion.item.selected.fg            = '#f9efe9'
...
c.colors.completion.item.selected.match.fg      = '#DC8E69'
c.colors.completion.scrollbar.bg                = '#525852'
c.colors.completion.scrollbar.fg                = '#f9efe9'
...
c.colors.downloads.bar.bg    = '#525852'
c.colors.downloads.error.bg  = '#6F90A7'
c.colors.downloads.error.fg  = '#f9efe9'
c.colors.downloads.start.bg  = '#DC8E69'
c.colors.downloads.start.fg  = '#f9efe9'
c.colors.downloads.stop.bg   = '#507C88'
c.colors.downloads.stop.fg   = '#f9efe9'
...
c.colors.hints.fg          = '#f9efe9'
c.colors.hints.match.fg    = '#507C88'
c.colors.keyhint.bg        = 'rgba(165, 137, 109, 80%)'
c.colors.keyhint.fg        = '#f9efe9'
c.colors.keyhint.suffix.fg = '#525852'

c.colors.messages.error.bg     = '#91a7b7'
c.colors.messages.error.border = '#91a7b7'
c.colors.messages.error.fg     = '#3e443e'
c.colors.messages.info.bg     = '#525852'
c.colors.messages.info.border = '#525852'
c.colors.messages.info.fg     = '#f9efe9'
c.colors.messages.warning.bg     = '#baa28c'
c.colors.messages.warning.border = '#baa28c'
c.colors.messages.warning.fg     = '#f9efe9'

c.colors.prompts.bg          = '#3e443e'
c.colors.prompts.border      = '1px solid #525852'
c.colors.prompts.fg          = '#f9efe9'
c.colors.prompts.selected.bg = '#8d6953'

c.colors.statusbar.caret.fg             = '#609AC1'
c.colors.statusbar.caret.bg             = '#3e443e'
c.colors.statusbar.caret.selection.fg   = '#3e443e'
c.colors.statusbar.caret.selection.bg   = '#609AC1'
c.colors.statusbar.command.fg           = '#f9efe9'
c.colors.statusbar.command.bg           = '#3e443e'
c.colors.statusbar.command.private.bg   = '#d1c7c1'
c.colors.statusbar.command.private.fg   = '#3e443e'
c.colors.statusbar.insert.fg            = '#7a98a0'
c.colors.statusbar.insert.bg            = '#3e443e'
c.colors.statusbar.normal.fg            = '#eabea9'
c.colors.statusbar.normal.bg            = '#3e443e'
c.colors.statusbar.passthrough.bg       = '#8d6953'
c.colors.statusbar.passthrough.fg       = '#f9efe9'
c.colors.statusbar.private.bg           = '#7a807a'
c.colors.statusbar.private.fg           = '#f9efe9'
c.colors.statusbar.progress.bg          = '#f9efe9'
c.colors.statusbar.url.error.fg         = '#91a7b7'
c.colors.statusbar.url.fg               = '#e5dbd5'
c.colors.statusbar.url.hover.fg         = '#f9efe9'
c.colors.statusbar.url.success.http.fg  = '#7a98a0'
c.colors.statusbar.url.success.https.fg = '#7a98a0'
c.colors.statusbar.url.warn.fg          = '#baa28c'

c.colors.tabs.bar.bg           = '#8d6953'
c.colors.tabs.even.bg          = '#8d6953'
c.colors.tabs.even.fg          = '#DC8E69'
c.colors.tabs.odd.bg           = '#785f4d'
c.colors.tabs.odd.fg           = '#DC8E69'
c.colors.tabs.indicator.error  = '#91a7b7'
c.colors.tabs.indicator.start  = '#7a98a0'
c.colors.tabs.indicator.stop   = '#DC8E69'
c.colors.tabs.indicator.system = 'rgb' # rgb, hsv, hsl, none
c.colors.tabs.selected.even.bg = '#8d6953'
c.colors.tabs.selected.even.fg = '#f9efe9'
c.colors.tabs.selected.odd.bg  = '#8d6953'
c.colors.tabs.selected.odd.fg  = '#f9efe9'
c.colors.tabs.pinned.even.bg          = '#785f4d'
c.colors.tabs.pinned.even.fg          = '#f9efe9'
c.colors.tabs.pinned.odd.bg           = '#785f4d'
c.colors.tabs.pinned.odd.fg           = '#f9efe9'
c.colors.tabs.pinned.selected.even.bg = '#655648'
c.colors.tabs.pinned.selected.even.fg = '#eabea9'
c.colors.tabs.pinned.selected.odd.bg  = '#655648'
c.colors.tabs.pinned.selected.odd.fg  = '#eabea9'

c.colors.webpage.bg = '#504c43'
