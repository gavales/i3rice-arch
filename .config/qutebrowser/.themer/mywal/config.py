...
# ━  COLORS
# ━━ completion
c.colors.completion.category.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #9299A9, stop:1 #9299A9)'
c.colors.completion.category.border.bottom      = '#9299A9'
c.colors.completion.category.border.top         = '#9299A9'
c.colors.completion.category.fg                 = '#f8fafd'
c.colors.completion.even.bg                     = '#e4e6e9'
c.colors.completion.odd.bg                      = '#e4e6e9'
c.colors.completion.fg                          = ['#9299A9', '#262a3b', '#bcbec1']
c.colors.completion.item.selected.bg            = '#9299A9'
c.colors.completion.item.selected.fg            = '#e4e6e9'
c.colors.completion.item.selected.border.bottom = '#388CE8'
c.colors.completion.item.selected.border.top    = '#388CE8'
c.colors.completion.match.fg                    = '#9299A9'
c.colors.completion.scrollbar.bg                = '#e4e6e9'
c.colors.completion.scrollbar.fg                = '#262a3b'

# ━━ downloads
c.colors.downloads.bar.bg    = '#e4e6e9'
c.colors.downloads.error.bg  = '#6D86A9'
c.colors.downloads.error.fg  = '#262a3b'
c.colors.downloads.start.bg  = '#9299A9'
c.colors.downloads.start.fg  = '#262a3b'
c.colors.downloads.stop.bg   = '#388CE8'
c.colors.downloads.stop.fg   = '#262a3b'
c.colors.downloads.system.bg = 'rgb' # rgb, hsv, hsl, none
c.colors.downloads.system.fg = 'rgb' # rgb, hsv, hsl, none

# ━━ hints
c.colors.hints.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 rgba(106, 154, 220, 0.8), stop:1 rgba(106, 154, 220, 0.8))'
c.colors.hints.fg          = '#262a3b'
c.colors.hints.match.fg    = '#388CE8'
c.colors.keyhint.bg        = 'rgba(106, 154, 220, 80%)'
c.colors.keyhint.fg        = '#262a3b'
c.colors.keyhint.suffix.fg = '#e4e6e9'

# ━━ errors
c.colors.messages.error.bg     = '#6D86A9'
c.colors.messages.error.border = '#6D86A9'
c.colors.messages.error.fg     = '#262a3b'

# ━━ info
c.colors.messages.info.bg     = '#262a3b'
c.colors.messages.info.border = '#262a3b'
c.colors.messages.info.fg     = '#e4e6e9'

# ━━ warning
c.colors.messages.warning.bg     = '#6A9ADC'
c.colors.messages.warning.border = '#6A9ADC'
c.colors.messages.warning.fg     = '#e4e6e9'

# ━━ prompts
c.colors.prompts.bg          = '#e4e6e9'
c.colors.prompts.border      = '1px solid #e4e6e9'
c.colors.prompts.fg          = '#262a3b'
c.colors.prompts.selected.bg = '#9299A9'

# ━━ statusbar
c.colors.statusbar.caret.fg             = '#DAB9AD'
c.colors.statusbar.caret.bg             = '#e4e6e9'
c.colors.statusbar.caret.selection.fg   = '#DAB9AD'
c.colors.statusbar.caret.selection.bg   = '#e4e6e9'
c.colors.statusbar.command.fg           = '#262a3b'
c.colors.statusbar.command.bg           = '#e4e6e9'
c.colors.statusbar.command.private.bg   = '#bcbec1'
c.colors.statusbar.command.private.fg   = '#262a3b'
c.colors.statusbar.insert.fg            = '#388CE8'
c.colors.statusbar.insert.bg            = '#e4e6e9'
c.colors.statusbar.normal.fg            = '#9299A9'
c.colors.statusbar.normal.bg            = '#e4e6e9'
c.colors.statusbar.passthrough.bg       = '#e4e6e9'
c.colors.statusbar.passthrough.fg       = '#262a3b'
c.colors.statusbar.private.bg           = '#bcbec1'
c.colors.statusbar.private.fg           = '#262a3b'
c.colors.statusbar.progress.bg          = '#262a3b'
c.colors.statusbar.url.error.fg         = '#6D86A9'
c.colors.statusbar.url.fg               = '#262a3b'
c.colors.statusbar.url.hover.fg         = '#9299A9'
c.colors.statusbar.url.success.http.fg  = '#262a3b'
c.colors.statusbar.url.success.https.fg = '#262a3b'
c.colors.statusbar.url.warn.fg          = '#6A9ADC'

# ━━ tabs
c.colors.tabs.bar.bg           = '#e4e6e9'
c.colors.tabs.even.bg          = '#e4e6e9'
c.colors.tabs.even.fg          = '#262a3b'
c.colors.tabs.odd.bg           = '#e4e6e9'
c.colors.tabs.odd.fg           = '#262a3b'
c.colors.tabs.indicator.error  = '#6D86A9'
c.colors.tabs.indicator.start  = '#9299A9'
c.colors.tabs.indicator.stop   = '#388CE8'
c.colors.tabs.indicator.system = 'rgb' # rgb, hsv, hsl, none
c.colors.tabs.selected.even.bg = '#9299A9'
c.colors.tabs.selected.even.fg = '#e4e6e9'
c.colors.tabs.selected.odd.bg  = '#9299A9'
c.colors.tabs.selected.odd.fg  = '#e4e6e9'
...
c.hints.border                     = '1px solid #6A9ADC'
