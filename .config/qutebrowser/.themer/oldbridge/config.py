...
c.hints.border = '1px solid #ab8268'
...
c.colors.completion.category.fg                 = '#343235'
c.colors.completion.even.bg                     = '#d5d3cf'
c.colors.completion.odd.bg                      = '#d5d3cf'
c.colors.completion.fg                          = ['#96778A', '#343235', '#adaba7']
c.colors.completion.item.selected.bg            = '#96778A'
c.colors.completion.item.selected.fg            = '#343235'
...
c.colors.completion.scrollbar.bg                = '#d5d3cf'
c.colors.completion.scrollbar.fg                = '#343235'
...
c.colors.downloads.bar.bg    = '#d5d3cf'
c.colors.downloads.error.bg  = '#A36043'
c.colors.downloads.error.fg  = '#343235'
c.colors.downloads.start.bg  = '#96778A'
c.colors.downloads.start.fg  = '#343235'
c.colors.downloads.stop.bg   = '#B98C68'
c.colors.downloads.stop.fg   = '#343235'
...
c.colors.hints.fg          = '#343235'
c.colors.hints.match.fg    = '#B98C68'
c.colors.keyhint.bg        = 'rgba(208, 155, 109, 80%)'
c.colors.keyhint.fg        = '#343235'
c.colors.keyhint.suffix.fg = '#d5d3cf'

c.colors.messages.error.bg     = '#8d5b4c'
c.colors.messages.error.border = '#8d5b4c'
c.colors.messages.error.fg     = '#e9e7e3'
c.colors.messages.info.bg     = '#d5d3cf'
c.colors.messages.info.border = '#d5d3cf'
c.colors.messages.info.fg     = '#343235'
c.colors.messages.warning.bg     = '#ab8268'
c.colors.messages.warning.border = '#ab8268'
c.colors.messages.warning.fg     = '#343235'

c.colors.prompts.bg          = '#e9e7e3'
c.colors.prompts.border      = '1px solid #d5d3cf'
c.colors.prompts.fg          = '#343235'
c.colors.prompts.selected.bg = '#bfafb6'

c.colors.statusbar.caret.fg             = '#D5AE91'
c.colors.statusbar.caret.bg             = '#dfd9d8'
c.colors.statusbar.caret.selection.fg   = '#e9e7e3'
c.colors.statusbar.caret.selection.bg   = '#ae8f80'
c.colors.statusbar.command.fg           = '#343235'
c.colors.statusbar.command.bg           = '#dfd9d8'
c.colors.statusbar.command.private.bg   = '#5c5a5d'
c.colors.statusbar.command.private.fg   = '#e9e7e3'
c.colors.statusbar.insert.fg            = '#9c7864'
c.colors.statusbar.insert.bg            = '#dfd9d8'
c.colors.statusbar.normal.fg            = '#343235'
c.colors.statusbar.normal.bg            = '#dfd9d8'
c.colors.statusbar.passthrough.bg       = '#bfafb6'
c.colors.statusbar.passthrough.fg       = '#343235'
c.colors.statusbar.private.bg           = '#a38a9b'
c.colors.statusbar.private.fg           = '#343235'
c.colors.statusbar.progress.bg          = '#343235'
c.colors.statusbar.url.error.fg         = '#8d5b4c'
c.colors.statusbar.url.fg               = '#484649'
c.colors.statusbar.url.hover.fg         = '#343235'
c.colors.statusbar.url.success.http.fg  = '#9c7864'
c.colors.statusbar.url.success.https.fg = '#9c7864'
c.colors.statusbar.url.warn.fg          = '#ab8268'

c.colors.tabs.bar.bg           = '#bfafb6'
c.colors.tabs.even.bg          = '#bfafb6'
c.colors.tabs.even.fg          = '#96778A'
c.colors.tabs.odd.bg           = '#cabdc2'
c.colors.tabs.odd.fg           = '#96778A'
c.colors.tabs.indicator.error  = '#8d5b4c'
c.colors.tabs.indicator.start  = '#9c7864'
c.colors.tabs.indicator.stop   = '#96778A'
c.colors.tabs.indicator.system = 'rgb'                      # rgb, hsv, hsl, none
c.colors.tabs.selected.even.bg = '#dfd9d8'
c.colors.tabs.selected.even.fg = '#343235'
c.colors.tabs.selected.odd.bg  = '#dfd9d8'
c.colors.tabs.selected.odd.fg  = '#343235'
c.colors.tabs.pinned.even.bg          = '#3c6f99'
c.colors.tabs.pinned.even.fg          = '#343235'
c.colors.tabs.pinned.odd.bg           = '#3c6f99'
c.colors.tabs.pinned.odd.fg           = '#343235'
c.colors.tabs.pinned.selected.even.bg = '#dfd9d8'
c.colors.tabs.pinned.selected.even.fg = '#65545f'
c.colors.tabs.pinned.selected.odd.bg  = '#dfd9d8'
c.colors.tabs.pinned.selected.odd.fg  = '#65545f'

c.colors.webpage.bg = '#dfd9d8'
