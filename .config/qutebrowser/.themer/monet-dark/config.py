...
c.hints.border = '1px solid #cfe0bb'

c.colors.completion.category.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #A3C99C, stop:1 #A3C99C)'
c.colors.completion.category.border.bottom      = '#A3C99C'
c.colors.completion.category.border.top         = '#A3C99C'
c.colors.completion.category.fg                 = '#fcfcfb'
c.colors.completion.even.bg                     = '#745b4e'
c.colors.completion.odd.bg                      = '#745b4e'
c.colors.completion.fg                          = ['#A3C99C', '#fcfcfb', '#9c8376']
c.colors.completion.item.selected.bg            = '#A3C99C'
c.colors.completion.item.selected.fg            = '#fcfcfb'
c.colors.completion.item.selected.border.bottom = '#CCDCB9'
c.colors.completion.item.selected.border.top    = '#CCDCB9'
c.colors.completion.match.fg                    = '#A3C99C'
c.colors.completion.item.selected.match.fg      = '#A3C99C'
c.colors.completion.scrollbar.bg                = '#745b4e'
c.colors.completion.scrollbar.fg                = '#fcfcfb'
...
c.colors.downloads.bar.bg    = '#745b4e'
c.colors.downloads.error.bg  = '#BEB7C6'
c.colors.downloads.error.fg  = '#fcfcfb'
c.colors.downloads.start.bg  = '#A3C99C'
c.colors.downloads.start.fg  = '#fcfcfb'
c.colors.downloads.stop.bg   = '#CCDCB9'
c.colors.downloads.stop.fg   = '#fcfcfb'
c.colors.downloads.system.bg = 'rgb' # rgb, hsv, hsl, none
c.colors.downloads.system.fg = 'rgb' # rgb, hsv, hsl, none

c.colors.hints.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 rgba(208, 223, 180, 0.8), stop:1 rgba(208, 223, 180, 0.8))'
c.colors.hints.fg          = '#fcfcfb'
c.colors.hints.match.fg    = '#CCDCB9'
c.colors.keyhint.bg        = 'rgba(208, 223, 180, 80%)'
c.colors.keyhint.fg        = '#fcfcfb'
c.colors.keyhint.suffix.fg = '#745b4e'

c.colors.messages.error.bg     = '#c3c5c7'
c.colors.messages.error.border = '#c3c5c7'
c.colors.messages.error.fg     = '#60473A'
c.colors.messages.info.bg     = '#745b4e'
c.colors.messages.info.border = '#745b4e'
c.colors.messages.info.fg     = '#fcfcfb'
c.colors.messages.warning.bg     = '#cfe0bb'
c.colors.messages.warning.border = '#cfe0bb'
c.colors.messages.warning.fg     = '#fcfcfb'

c.colors.prompts.bg          = '#60473A'
c.colors.prompts.border      = '1px solid #745b4e'
c.colors.prompts.fg          = '#fcfcfb'
c.colors.prompts.selected.bg = '#81886b'

c.colors.statusbar.caret.fg             = '#9FCCD3'
c.colors.statusbar.caret.bg             = '#685645'
c.colors.statusbar.caret.selection.fg   = '#60473A'
c.colors.statusbar.caret.selection.bg   = '#afd3d0'
c.colors.statusbar.command.fg           = '#fcfcfb'
c.colors.statusbar.command.bg           = '#685645'
c.colors.statusbar.command.private.bg   = '#d4d4d3'
c.colors.statusbar.command.private.fg   = '#60473A'
c.colors.statusbar.insert.fg            = '#cddebf'
c.colors.statusbar.insert.bg            = '#685645'
c.colors.statusbar.normal.fg            = '#fcfcfb'
c.colors.statusbar.normal.bg            = '#685645'
c.colors.statusbar.passthrough.bg       = '#81886b'
c.colors.statusbar.passthrough.fg       = '#fcfcfb'
c.colors.statusbar.private.bg           = '#d4decf'
c.colors.statusbar.private.fg           = '#fcfcfb'
c.colors.statusbar.progress.bg          = '#fcfcfb'
c.colors.statusbar.url.error.fg         = '#c3c5c7'
c.colors.statusbar.url.fg               = '#e8e8e7'
c.colors.statusbar.url.hover.fg         = '#fcfcfb'
c.colors.statusbar.url.success.http.fg  = '#cddebf'
c.colors.statusbar.url.success.https.fg = '#cddebf'
c.colors.statusbar.url.warn.fg          = '#cfe0bb'

c.colors.tabs.bar.bg           = '#81886b'
c.colors.tabs.even.bg          = '#81886b'
c.colors.tabs.even.fg          = '#A3C99C'
c.colors.tabs.odd.bg           = '#78775e'
c.colors.tabs.odd.fg           = '#A3C99C'
c.colors.tabs.indicator.error  = '#c3c5c7'
c.colors.tabs.indicator.start  = '#cddebf'
c.colors.tabs.indicator.stop   = '#A3C99C'
c.colors.tabs.indicator.system = 'rgb'                      # rgb, hsv, hsl, none
c.colors.tabs.selected.even.bg = '#685645'
c.colors.tabs.selected.even.fg = '#fcfcfb'
c.colors.tabs.selected.odd.bg  = '#685645'
c.colors.tabs.selected.odd.fg  = '#fcfcfb'
c.colors.tabs.pinned.even.bg          = '#60a0be'
c.colors.tabs.pinned.even.fg          = '#fcfcfb'
c.colors.tabs.pinned.odd.bg           = '#60a0be'
c.colors.tabs.pinned.odd.fg           = '#fcfcfb'
c.colors.tabs.pinned.selected.even.bg = '#685645'
c.colors.tabs.pinned.selected.even.fg = '#cfe2cb'
c.colors.tabs.pinned.selected.odd.bg  = '#685645'
c.colors.tabs.pinned.selected.odd.fg  = '#cfe2cb'

c.colors.webpage.bg = '#685645'
