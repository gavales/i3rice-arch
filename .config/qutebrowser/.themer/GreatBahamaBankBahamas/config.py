...
# ━  COLORS
# ━━ completion
c.colors.completion.category.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #259BE0, stop:1 #259BE0)'
c.colors.completion.category.border.bottom      = '#259BE0'
c.colors.completion.category.border.top         = '#259BE0'
c.colors.completion.category.fg                 = '#a4dfe5'
c.colors.completion.even.bg                     = '#90cbd1'
c.colors.completion.odd.bg                      = '#90cbd1'
c.colors.completion.fg                          = ['#259BE0', '#085175', '#68a3a9']
c.colors.completion.item.selected.bg            = '#259BE0'
c.colors.completion.item.selected.fg            = '#90cbd1'
c.colors.completion.item.selected.border.bottom = '#0690CF'
c.colors.completion.item.selected.border.top    = '#0690CF'
c.colors.completion.match.fg                    = '#259BE0'
c.colors.completion.scrollbar.bg                = '#90cbd1'
c.colors.completion.scrollbar.fg                = '#085175'

# ━━ downloads
c.colors.downloads.bar.bg    = '#90cbd1'
c.colors.downloads.error.bg  = '#08A2B5'
c.colors.downloads.error.fg  = '#085175'
c.colors.downloads.start.bg  = '#259BE0'
c.colors.downloads.start.fg  = '#085175'
c.colors.downloads.stop.bg   = '#0690CF'
c.colors.downloads.stop.fg   = '#085175'
c.colors.downloads.system.bg = 'rgb' # rgb, hsv, hsl, none
c.colors.downloads.system.fg = 'rgb' # rgb, hsv, hsl, none

# ━━ hints
c.colors.hints.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 rgba(7, 175, 204, 0.8), stop:1 rgba(7, 175, 204, 0.8))'
c.colors.hints.fg          = '#085175'
c.colors.hints.match.fg    = '#0690CF'
c.colors.keyhint.bg        = 'rgba(7, 175, 204, 80%)'
c.colors.keyhint.fg        = '#085175'
c.colors.keyhint.suffix.fg = '#90cbd1'

# ━━ errors
c.colors.messages.error.bg     = '#08A2B5'
c.colors.messages.error.border = '#08A2B5'
c.colors.messages.error.fg     = '#085175'

# ━━ info
c.colors.messages.info.bg     = '#085175'
c.colors.messages.info.border = '#085175'
c.colors.messages.info.fg     = '#90cbd1'

# ━━ warning
c.colors.messages.warning.bg     = '#07AFCC'
c.colors.messages.warning.border = '#07AFCC'
c.colors.messages.warning.fg     = '#90cbd1'

# ━━ prompts
c.colors.prompts.bg          = '#90cbd1'
c.colors.prompts.border      = '1px solid #90cbd1'
c.colors.prompts.fg          = '#085175'
c.colors.prompts.selected.bg = '#259BE0'

# ━━ statusbar
c.colors.statusbar.caret.fg             = '#64B1E7'
c.colors.statusbar.caret.bg             = '#90cbd1'
c.colors.statusbar.caret.selection.fg   = '#64B1E7'
c.colors.statusbar.caret.selection.bg   = '#90cbd1'
c.colors.statusbar.command.fg           = '#085175'
c.colors.statusbar.command.bg           = '#90cbd1'
c.colors.statusbar.command.private.bg   = '#68a3a9'
c.colors.statusbar.command.private.fg   = '#085175'
c.colors.statusbar.insert.fg            = '#0690CF'
c.colors.statusbar.insert.bg            = '#90cbd1'
c.colors.statusbar.normal.fg            = '#259BE0'
c.colors.statusbar.normal.bg            = '#90cbd1'
c.colors.statusbar.passthrough.bg       = '#90cbd1'
c.colors.statusbar.passthrough.fg       = '#085175'
c.colors.statusbar.private.bg           = '#68a3a9'
c.colors.statusbar.private.fg           = '#085175'
c.colors.statusbar.progress.bg          = '#085175'
c.colors.statusbar.url.error.fg         = '#08A2B5'
c.colors.statusbar.url.fg               = '#085175'
c.colors.statusbar.url.hover.fg         = '#259BE0'
c.colors.statusbar.url.success.http.fg  = '#085175'
c.colors.statusbar.url.success.https.fg = '#085175'
c.colors.statusbar.url.warn.fg          = '#07AFCC'

# ━━ tabs
c.colors.tabs.bar.bg           = '#90cbd1'
c.colors.tabs.even.bg          = '#90cbd1'
c.colors.tabs.even.fg          = '#085175'
c.colors.tabs.odd.bg           = '#90cbd1'
c.colors.tabs.odd.fg           = '#085175'
c.colors.tabs.indicator.error  = '#08A2B5'
c.colors.tabs.indicator.start  = '#259BE0'
c.colors.tabs.indicator.stop   = '#0690CF'
c.colors.tabs.indicator.system = 'rgb' # rgb, hsv, hsl, none
c.colors.tabs.selected.even.bg = '#259BE0'
c.colors.tabs.selected.even.fg = '#90cbd1'
c.colors.tabs.selected.odd.bg  = '#259BE0'
c.colors.tabs.selected.odd.fg  = '#90cbd1'
...
c.hints.border                     = '1px solid #07AFCC'
