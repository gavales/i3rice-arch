...
c.colors.completion.category.fg                 = '#3d3d3d'
c.colors.completion.even.bg                     = '#515151'
c.colors.completion.odd.bg                      = '#515151'
c.colors.completion.fg                          = ['#285577', '#CDCBCD', '#797979']
c.colors.completion.item.selected.bg            = '#285577'
c.colors.completion.item.selected.fg            = '#515151'
...
c.colors.completion.scrollbar.bg                = '#515151'
c.colors.completion.scrollbar.fg                = '#CDCBCD'

# //// downloads
c.colors.downloads.bar.bg    = '#515151'
...
c.colors.keyhint.suffix.fg = '#515151'
...
c.colors.messages.info.fg     = '#515151'

# //// warning
c.colors.messages.warning.bg     = '#904800'
c.colors.messages.warning.border = '#904800'
c.colors.messages.warning.fg     = '#515151'

# //// prompts
c.colors.prompts.bg          = '#515151'
c.colors.prompts.border      = '1px solid #515151'
c.colors.prompts.fg          = '#CDCBCD'
c.colors.prompts.selected.bg = '#285577'

# //// statusbar
c.colors.statusbar.caret.fg             = '#900048'
c.colors.statusbar.caret.bg             = '#515151'
c.colors.statusbar.caret.selection.fg   = '#900048'
c.colors.statusbar.caret.selection.bg   = '#515151'
c.colors.statusbar.command.fg           = '#CDCBCD'
c.colors.statusbar.command.bg           = '#515151'
c.colors.statusbar.command.private.bg   = '#797979'
c.colors.statusbar.command.private.fg   = '#CDCBCD'
c.colors.statusbar.insert.fg            = '#009048'
c.colors.statusbar.insert.bg            = '#515151'
c.colors.statusbar.normal.fg            = '#285577'
c.colors.statusbar.normal.bg            = '#515151'
c.colors.statusbar.passthrough.bg       = '#515151'
c.colors.statusbar.passthrough.fg       = '#CDCBCD'
c.colors.statusbar.private.bg           = '#797979'
...
# //// tabs
c.colors.tabs.bar.bg           = '#515151'
c.colors.tabs.even.bg          = '#515151'
c.colors.tabs.even.fg          = '#CDCBCD'
c.colors.tabs.odd.bg           = '#515151'
...
c.colors.tabs.selected.even.fg = '#515151'
c.colors.tabs.selected.odd.bg  = '#285577'
c.colors.tabs.selected.odd.fg  = '#515151'
