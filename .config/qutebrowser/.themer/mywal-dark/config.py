...
c.colors.completion.category.fg                 = '#050406'
c.colors.completion.even.bg                     = '#19181a'
c.colors.completion.odd.bg                      = '#19181a'
c.colors.completion.fg                          = ['#A697AB', '#fdf9f7', '#414042']
c.colors.completion.item.selected.bg            = '#A697AB'
c.colors.completion.item.selected.fg            = '#19181a'
...
c.colors.completion.scrollbar.bg                = '#19181a'
c.colors.completion.scrollbar.fg                = '#fdf9f7'

# ━━ downloads
c.colors.downloads.bar.bg    = '#19181a'
...
c.colors.keyhint.suffix.fg = '#19181a'
...
c.colors.messages.info.fg     = '#19181a'

# ━━ warning
c.colors.messages.warning.bg     = '#638CB1'
c.colors.messages.warning.border = '#638CB1'
c.colors.messages.warning.fg     = '#19181a'

# ━━ prompts
c.colors.prompts.bg          = '#19181a'
c.colors.prompts.border      = '1px solid #19181a'
c.colors.prompts.fg          = '#fdf9f7'
c.colors.prompts.selected.bg = '#A697AB'

# ━━ statusbar
c.colors.statusbar.caret.fg             = '#E4A6A3'
c.colors.statusbar.caret.bg             = '#19181a'
c.colors.statusbar.caret.selection.fg   = '#E4A6A3'
c.colors.statusbar.caret.selection.bg   = '#19181a'
c.colors.statusbar.command.fg           = '#fdf9f7'
c.colors.statusbar.command.bg           = '#19181a'
c.colors.statusbar.command.private.bg   = '#414042'
c.colors.statusbar.command.private.fg   = '#fdf9f7'
c.colors.statusbar.insert.fg            = '#318CBD'
c.colors.statusbar.insert.bg            = '#19181a'
c.colors.statusbar.normal.fg            = '#A697AB'
c.colors.statusbar.normal.bg            = '#19181a'
c.colors.statusbar.passthrough.bg       = '#19181a'
c.colors.statusbar.passthrough.fg       = '#fdf9f7'
c.colors.statusbar.private.bg           = '#414042'
...
# ━━ tabs
c.colors.tabs.bar.bg           = '#19181a'
c.colors.tabs.even.bg          = '#19181a'
c.colors.tabs.even.fg          = '#fdf9f7'
c.colors.tabs.odd.bg           = '#19181a'
...
c.colors.tabs.selected.even.fg = '#19181a'
c.colors.tabs.selected.odd.bg  = '#A697AB'
c.colors.tabs.selected.odd.fg  = '#19181a'
