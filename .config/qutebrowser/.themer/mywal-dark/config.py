...
c.hints.border = '1px solid #dbe6c5'

c.colors.completion.category.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #BEB7C6, stop:1 #BEB7C6)'
c.colors.completion.category.border.bottom      = '#BEB7C6'
c.colors.completion.category.border.top         = '#BEB7C6'
c.colors.completion.category.fg                 = '#fcfcfb'
c.colors.completion.even.bg                     = '#745b4e'
c.colors.completion.odd.bg                      = '#745b4e'
c.colors.completion.fg                          = ['#BEB7C6', '#fcfcfb', '#9c8376']
c.colors.completion.item.selected.bg            = '#BEB7C6'
...
c.colors.completion.match.fg                    = '#BEB7C6'
c.colors.completion.item.selected.match.fg      = '#BEB7C6'
...
c.colors.downloads.error.bg  = '#A3C99C'
c.colors.downloads.error.fg  = '#fcfcfb'
c.colors.downloads.start.bg  = '#BEB7C6'
...
c.colors.messages.error.bg     = '#b9d5b3'
c.colors.messages.error.border = '#b9d5b3'
...
c.colors.messages.warning.bg     = '#dbe6c5'
c.colors.messages.warning.border = '#dbe6c5'
...
c.colors.prompts.selected.bg = '#8f7f80'

c.colors.statusbar.caret.fg             = '#9FCCD3'
c.colors.statusbar.caret.bg             = '#6b544a'
c.colors.statusbar.caret.selection.fg   = '#60473A'
c.colors.statusbar.caret.selection.bg   = '#b6d8dd'
c.colors.statusbar.command.fg           = '#fcfcfb'
c.colors.statusbar.command.bg           = '#6b544a'
c.colors.statusbar.command.private.bg   = '#d4d4d3'
c.colors.statusbar.command.private.fg   = '#60473A'
c.colors.statusbar.insert.fg            = '#d8e4c9'
c.colors.statusbar.insert.bg            = '#6b544a'
c.colors.statusbar.normal.fg            = '#fcfcfb'
c.colors.statusbar.normal.bg            = '#6b544a'
c.colors.statusbar.passthrough.bg       = '#8f7f80'
c.colors.statusbar.passthrough.fg       = '#fcfcfb'
c.colors.statusbar.private.bg           = '#e1e4dc'
c.colors.statusbar.private.fg           = '#fcfcfb'
c.colors.statusbar.progress.bg          = '#fcfcfb'
c.colors.statusbar.url.error.fg         = '#b9d5b3'
c.colors.statusbar.url.fg               = '#e8e8e7'
c.colors.statusbar.url.hover.fg         = '#fcfcfb'
c.colors.statusbar.url.success.http.fg  = '#d8e4c9'
c.colors.statusbar.url.success.https.fg = '#d8e4c9'
c.colors.statusbar.url.warn.fg          = '#dbe6c5'

c.colors.tabs.bar.bg           = '#8f7f80'
c.colors.tabs.even.bg          = '#8f7f80'
c.colors.tabs.even.fg          = '#BEB7C6'
c.colors.tabs.odd.bg           = '#82706d'
c.colors.tabs.odd.fg           = '#BEB7C6'
c.colors.tabs.indicator.error  = '#b9d5b3'
c.colors.tabs.indicator.start  = '#d8e4c9'
c.colors.tabs.indicator.stop   = '#BEB7C6'
c.colors.tabs.indicator.system = 'rgb'                      # rgb, hsv, hsl, none
c.colors.tabs.selected.even.bg = '#6b544a'
c.colors.tabs.selected.even.fg = '#fcfcfb'
c.colors.tabs.selected.odd.bg  = '#6b544a'
c.colors.tabs.selected.odd.fg  = '#fcfcfb'
c.colors.tabs.pinned.even.bg          = '#5c9dc8'
c.colors.tabs.pinned.even.fg          = '#fcfcfb'
c.colors.tabs.pinned.odd.bg           = '#5c9dc8'
c.colors.tabs.pinned.odd.fg           = '#fcfcfb'
c.colors.tabs.pinned.selected.even.bg = '#6b544a'
c.colors.tabs.pinned.selected.even.fg = '#ddd9e0'
c.colors.tabs.pinned.selected.odd.bg  = '#6b544a'
c.colors.tabs.pinned.selected.odd.fg  = '#ddd9e0'

c.colors.webpage.bg = '#6b544a'
