...
c.colors.completion.category.fg                 = '#0F1610'
c.colors.completion.even.bg                     = '#232a24'
c.colors.completion.odd.bg                      = '#232a24'
c.colors.completion.fg                          = ['#667B86', '#f7f4f1', '#4b524c']
c.colors.completion.item.selected.bg            = '#667B86'
c.colors.completion.item.selected.fg            = '#232a24'
...
c.colors.completion.scrollbar.bg                = '#232a24'
c.colors.completion.scrollbar.fg                = '#f7f4f1'

# ━━ downloads
c.colors.downloads.bar.bg    = '#232a24'
...
c.colors.keyhint.suffix.fg = '#232a24'
...
c.colors.messages.info.fg     = '#232a24'

# ━━ warning
c.colors.messages.warning.bg     = '#517689'
c.colors.messages.warning.border = '#517689'
c.colors.messages.warning.fg     = '#232a24'

# ━━ prompts
c.colors.prompts.bg          = '#232a24'
c.colors.prompts.border      = '1px solid #232a24'
c.colors.prompts.fg          = '#f7f4f1'
c.colors.prompts.selected.bg = '#667B86'

# ━━ statusbar
c.colors.statusbar.caret.fg             = '#6F8B94'
c.colors.statusbar.caret.bg             = '#232a24'
c.colors.statusbar.caret.selection.fg   = '#6F8B94'
c.colors.statusbar.caret.selection.bg   = '#232a24'
c.colors.statusbar.command.fg           = '#f7f4f1'
c.colors.statusbar.command.bg           = '#232a24'
c.colors.statusbar.command.private.bg   = '#4b524c'
c.colors.statusbar.command.private.fg   = '#f7f4f1'
c.colors.statusbar.insert.fg            = '#3E6881'
c.colors.statusbar.insert.bg            = '#232a24'
c.colors.statusbar.normal.fg            = '#667B86'
c.colors.statusbar.normal.bg            = '#232a24'
c.colors.statusbar.passthrough.bg       = '#232a24'
c.colors.statusbar.passthrough.fg       = '#f7f4f1'
c.colors.statusbar.private.bg           = '#4b524c'
...
# ━━ tabs
c.colors.tabs.bar.bg           = '#232a24'
c.colors.tabs.even.bg          = '#232a24'
c.colors.tabs.even.fg          = '#f7f4f1'
c.colors.tabs.odd.bg           = '#232a24'
...
c.colors.tabs.selected.even.fg = '#232a24'
c.colors.tabs.selected.odd.bg  = '#667B86'
c.colors.tabs.selected.odd.fg  = '#232a24'
