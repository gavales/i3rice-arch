...
# ━  COLORS
# ━━ completion
c.colors.completion.category.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #e06a26, stop:1 #e06a26)'
c.colors.completion.category.border.bottom      = '#e06a26'
c.colors.completion.category.border.top         = '#e06a26'
c.colors.completion.category.fg                 = '#fffff0'
c.colors.completion.even.bg                     = '#ebebdc'
c.colors.completion.odd.bg                      = '#ebebdc'
c.colors.completion.fg                          = ['#e06a26', '#2b2b2b', '#c3c3b4']
c.colors.completion.item.selected.bg            = '#e06a26'
c.colors.completion.item.selected.fg            = '#ebebdc'
c.colors.completion.item.selected.border.bottom = '#219e21'
c.colors.completion.item.selected.border.top    = '#219e21'
c.colors.completion.match.fg                    = '#e06a26'
c.colors.completion.scrollbar.bg                = '#ebebdc'
c.colors.completion.scrollbar.fg                = '#2b2b2b'

# ━━ downloads
c.colors.downloads.bar.bg    = '#ebebdc'
c.colors.downloads.error.bg  = '#f55050'
c.colors.downloads.error.fg  = '#2b2b2b'
c.colors.downloads.start.bg  = '#e06a26'
c.colors.downloads.start.fg  = '#2b2b2b'
c.colors.downloads.stop.bg   = '#219e21'
c.colors.downloads.stop.fg   = '#2b2b2b'
c.colors.downloads.system.bg = 'rgb' # rgb, hsv, hsl, none
c.colors.downloads.system.fg = 'rgb' # rgb, hsv, hsl, none

# ━━ hints
c.colors.hints.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 rgba(212, 172, 53, 0.8), stop:1 rgba(212, 172, 53, 0.8))'
c.colors.hints.fg          = '#2b2b2b'
c.colors.hints.match.fg    = '#219e21'
c.colors.keyhint.bg        = 'rgba(212, 172, 53, 80%)'
c.colors.keyhint.fg        = '#2b2b2b'
c.colors.keyhint.suffix.fg = '#ebebdc'

# ━━ errors
c.colors.messages.error.bg     = '#f55050'
c.colors.messages.error.border = '#f55050'
c.colors.messages.error.fg     = '#2b2b2b'

# ━━ info
c.colors.messages.info.bg     = '#2b2b2b'
c.colors.messages.info.border = '#2b2b2b'
c.colors.messages.info.fg     = '#ebebdc'

# ━━ warning
c.colors.messages.warning.bg     = '#d4ac35'
c.colors.messages.warning.border = '#d4ac35'
c.colors.messages.warning.fg     = '#ebebdc'

# ━━ prompts
c.colors.prompts.bg          = '#ebebdc'
c.colors.prompts.border      = '1px solid #ebebdc'
c.colors.prompts.fg          = '#2b2b2b'
c.colors.prompts.selected.bg = '#e06a26'

# ━━ statusbar
c.colors.statusbar.caret.fg             = '#a26fbf'
c.colors.statusbar.caret.bg             = '#ebebdc'
c.colors.statusbar.caret.selection.fg   = '#a26fbf'
c.colors.statusbar.caret.selection.bg   = '#ebebdc'
c.colors.statusbar.command.fg           = '#2b2b2b'
c.colors.statusbar.command.bg           = '#ebebdc'
c.colors.statusbar.command.private.bg   = '#c3c3b4'
c.colors.statusbar.command.private.fg   = '#2b2b2b'
c.colors.statusbar.insert.fg            = '#219e21'
c.colors.statusbar.insert.bg            = '#ebebdc'
c.colors.statusbar.normal.fg            = '#e06a26'
c.colors.statusbar.normal.bg            = '#ebebdc'
c.colors.statusbar.passthrough.bg       = '#ebebdc'
c.colors.statusbar.passthrough.fg       = '#2b2b2b'
c.colors.statusbar.private.bg           = '#c3c3b4'
c.colors.statusbar.private.fg           = '#2b2b2b'
c.colors.statusbar.progress.bg          = '#2b2b2b'
c.colors.statusbar.url.error.fg         = '#f55050'
c.colors.statusbar.url.fg               = '#2b2b2b'
c.colors.statusbar.url.hover.fg         = '#e06a26'
c.colors.statusbar.url.success.http.fg  = '#2b2b2b'
c.colors.statusbar.url.success.https.fg = '#2b2b2b'
c.colors.statusbar.url.warn.fg          = '#d4ac35'

# ━━ tabs
c.colors.tabs.bar.bg           = '#ebebdc'
c.colors.tabs.even.bg          = '#ebebdc'
c.colors.tabs.even.fg          = '#2b2b2b'
c.colors.tabs.odd.bg           = '#ebebdc'
c.colors.tabs.odd.fg           = '#2b2b2b'
c.colors.tabs.indicator.error  = '#f55050'
c.colors.tabs.indicator.start  = '#e06a26'
c.colors.tabs.indicator.stop   = '#219e21'
c.colors.tabs.indicator.system = 'rgb' # rgb, hsv, hsl, none
c.colors.tabs.selected.even.bg = '#e06a26'
c.colors.tabs.selected.even.fg = '#ebebdc'
c.colors.tabs.selected.odd.bg  = '#e06a26'
c.colors.tabs.selected.odd.fg  = '#ebebdc'
...
c.hints.border                     = '1px solid #d4ac35'
