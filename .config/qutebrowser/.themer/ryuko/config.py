...
c.hints.border = '1px solid #203584'

c.colors.completion.category.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #666C99, stop:1 #666C99)'
c.colors.completion.category.border.bottom      = '#666C99'
c.colors.completion.category.border.top         = '#666C99'
c.colors.completion.category.fg                 = '#040817'
c.colors.completion.even.bg                     = '#e9e8e7'
c.colors.completion.odd.bg                      = '#e9e8e7'
c.colors.completion.fg                          = ['#666C99', '#040817', '#c1c0bf']
c.colors.completion.item.selected.bg            = '#666C99'
c.colors.completion.item.selected.fg            = '#040817'
c.colors.completion.item.selected.border.bottom = '#C02E17'
c.colors.completion.item.selected.border.top    = '#C02E17'
c.colors.completion.match.fg                    = '#666C99'
c.colors.completion.item.selected.match.fg      = '#666C99'
c.colors.completion.scrollbar.bg                = '#e9e8e7'
c.colors.completion.scrollbar.fg                = '#040817'
...
c.colors.downloads.bar.bg    = '#e9e8e7'
c.colors.downloads.error.bg  = '#5A4E59'
c.colors.downloads.error.fg  = '#040817'
c.colors.downloads.start.bg  = '#666C99'
c.colors.downloads.start.fg  = '#040817'
c.colors.downloads.stop.bg   = '#C02E17'
c.colors.downloads.stop.fg   = '#040817'
c.colors.downloads.system.bg = 'rgb' # rgb, hsv, hsl, none
c.colors.downloads.system.fg = 'rgb' # rgb, hsv, hsl, none

c.colors.hints.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 rgba(42, 68, 169, 0.8), stop:1 rgba(42, 68, 169, 0.8))'
c.colors.hints.fg          = '#040817'
c.colors.hints.match.fg    = '#C02E17'
c.colors.keyhint.bg        = 'rgba(42, 68, 169, 80%)'
c.colors.keyhint.fg        = '#040817'
c.colors.keyhint.suffix.fg = '#e9e8e7'

c.colors.messages.error.bg     = '#443c48'
c.colors.messages.error.border = '#443c48'
c.colors.messages.error.fg     = '#fdfcfb'
c.colors.messages.info.bg     = '#e9e8e7'
c.colors.messages.info.border = '#e9e8e7'
c.colors.messages.info.fg     = '#040817'
c.colors.messages.warning.bg     = '#203584'
c.colors.messages.warning.border = '#203584'
c.colors.messages.warning.fg     = '#040817'

c.colors.prompts.bg          = '#fdfcfb'
c.colors.prompts.border      = '1px solid #e9e8e7'
c.colors.prompts.fg          = '#040817'
c.colors.prompts.selected.bg = '#b1b4ca'

c.colors.statusbar.caret.fg             = '#7B87A5'
c.colors.statusbar.caret.bg             = '#eaeaef'
c.colors.statusbar.caret.selection.fg   = '#fdfcfb'
c.colors.statusbar.caret.selection.bg   = '#5d6781'
c.colors.statusbar.command.fg           = '#040817'
c.colors.statusbar.command.bg           = '#eaeaef'
c.colors.statusbar.command.private.bg   = '#2c303f'
c.colors.statusbar.command.private.fg   = '#fdfcfb'
c.colors.statusbar.insert.fg            = '#912417'
c.colors.statusbar.insert.bg            = '#eaeaef'
c.colors.statusbar.normal.fg            = '#040817'
c.colors.statusbar.normal.bg            = '#eaeaef'
c.colors.statusbar.passthrough.bg       = '#b1b4ca'
c.colors.statusbar.passthrough.fg       = '#040817'
c.colors.statusbar.private.bg           = '#887d84'
c.colors.statusbar.private.fg           = '#040817'
c.colors.statusbar.progress.bg          = '#040817'
c.colors.statusbar.url.error.fg         = '#443c48'
c.colors.statusbar.url.fg               = '#181c2b'
c.colors.statusbar.url.hover.fg         = '#040817'
c.colors.statusbar.url.success.http.fg  = '#912417'
c.colors.statusbar.url.success.https.fg = '#912417'
c.colors.statusbar.url.warn.fg          = '#203584'

c.colors.tabs.bar.bg           = '#b1b4ca'
c.colors.tabs.even.bg          = '#b1b4ca'
c.colors.tabs.even.fg          = '#666C99'
c.colors.tabs.odd.bg           = '#c5c6d6'
c.colors.tabs.odd.fg           = '#666C99'
c.colors.tabs.indicator.error  = '#443c48'
c.colors.tabs.indicator.start  = '#912417'
c.colors.tabs.indicator.stop   = '#666C99'
c.colors.tabs.indicator.system = 'rgb'                      # rgb, hsv, hsl, none
c.colors.tabs.selected.even.bg = '#eaeaef'
c.colors.tabs.selected.even.fg = '#040817'
c.colors.tabs.selected.odd.bg  = '#eaeaef'
c.colors.tabs.selected.odd.fg  = '#040817'
c.colors.tabs.pinned.even.bg          = '#1e608f'
c.colors.tabs.pinned.even.fg          = '#040817'
c.colors.tabs.pinned.odd.bg           = '#1e608f'
c.colors.tabs.pinned.odd.fg           = '#040817'
c.colors.tabs.pinned.selected.even.bg = '#eaeaef'
c.colors.tabs.pinned.selected.even.fg = '#353a58'
c.colors.tabs.pinned.selected.odd.bg  = '#eaeaef'
c.colors.tabs.pinned.selected.odd.fg  = '#353a58'

c.colors.webpage.bg = '#eaeaef'
