...
c.hints.border = '1px solid #a38c1d'
...
c.colors.messages.error.bg     = '#8b4937'
c.colors.messages.error.border = '#8b4937'
...
c.colors.messages.warning.bg     = '#a38c1d'
c.colors.messages.warning.border = '#a38c1d'
...
c.colors.statusbar.caret.selection.bg   = '#863fa7'
...
c.colors.statusbar.insert.fg            = '#21a9a1'
...
c.colors.statusbar.private.bg           = '#3ba4bb'
c.colors.statusbar.private.fg           = '#040817'
c.colors.statusbar.progress.bg          = '#040817'
c.colors.statusbar.url.error.fg         = '#8b4937'
c.colors.statusbar.url.fg               = '#181c2b'
c.colors.statusbar.url.hover.fg         = '#040817'
c.colors.statusbar.url.success.http.fg  = '#21a9a1'
c.colors.statusbar.url.success.https.fg = '#21a9a1'
c.colors.statusbar.url.warn.fg          = '#a38c1d'
...
c.colors.tabs.indicator.error  = '#8b4937'
c.colors.tabs.indicator.start  = '#21a9a1'
...
c.colors.tabs.pinned.even.bg          = '#2b6697'
c.colors.tabs.pinned.even.fg          = '#040817'
c.colors.tabs.pinned.odd.bg           = '#2b6697'
