...
c.hints.border = '1px solid #c7a438'
...
c.colors.completion.even.bg                     = '#143f4a'
c.colors.completion.odd.bg                      = '#143f4a'
c.colors.completion.fg                          = ['#2aa198', '#fdf6e3', '#3c6772']
...
c.colors.completion.scrollbar.bg                = '#143f4a'
c.colors.completion.scrollbar.fg                = '#fdf6e3'
...
c.colors.downloads.bar.bg    = '#143f4a'
...
c.colors.downloads.stop.fg   = '#fdf6e3'
...
c.colors.keyhint.suffix.fg = '#143f4a'

c.colors.messages.error.bg     = '#e4635c'
c.colors.messages.error.border = '#e4635c'
c.colors.messages.error.fg     = '#002b36'
c.colors.messages.info.bg     = '#143f4a'
c.colors.messages.info.border = '#143f4a'
c.colors.messages.info.fg     = '#fdf6e3'
c.colors.messages.warning.bg     = '#c7a438'
c.colors.messages.warning.border = '#c7a438'
c.colors.messages.warning.fg     = '#fdf6e3'

c.colors.prompts.bg          = '#002b36'
c.colors.prompts.border      = '1px solid #143f4a'
c.colors.prompts.fg          = '#fdf6e3'
c.colors.prompts.selected.bg = '#156667'

c.colors.statusbar.caret.fg             = '#d33682'
c.colors.statusbar.caret.bg             = '#053941'
c.colors.statusbar.caret.selection.fg   = '#002b36'
c.colors.statusbar.caret.selection.bg   = '#dd669a'
c.colors.statusbar.command.fg           = '#fdf6e3'
c.colors.statusbar.command.bg           = '#053941'
c.colors.statusbar.command.private.bg   = '#d5cebb'
c.colors.statusbar.command.private.fg   = '#002b36'
c.colors.statusbar.insert.fg            = '#a3b038'
c.colors.statusbar.insert.bg            = '#053941'
c.colors.statusbar.normal.fg            = '#fdf6e3'
c.colors.statusbar.normal.bg            = '#053941'
c.colors.statusbar.passthrough.bg       = '#156667'
c.colors.statusbar.passthrough.fg       = '#fdf6e3'
c.colors.statusbar.private.bg           = '#5ba5d6'
c.colors.statusbar.private.fg           = '#fdf6e3'
c.colors.statusbar.progress.bg          = '#fdf6e3'
c.colors.statusbar.url.error.fg         = '#e4635c'
c.colors.statusbar.url.fg               = '#e9e2cf'
c.colors.statusbar.url.hover.fg         = '#fdf6e3'
c.colors.statusbar.url.success.http.fg  = '#a3b038'
c.colors.statusbar.url.success.https.fg = '#a3b038'
c.colors.statusbar.url.warn.fg          = '#c7a438'

c.colors.tabs.bar.bg           = '#156667'
c.colors.tabs.even.bg          = '#156667'
c.colors.tabs.even.fg          = '#2aa198'
c.colors.tabs.odd.bg           = '#0f565a'
c.colors.tabs.odd.fg           = '#2aa198'
c.colors.tabs.indicator.error  = '#e4635c'
c.colors.tabs.indicator.start  = '#a3b038'
c.colors.tabs.indicator.stop   = '#2aa198'
c.colors.tabs.indicator.system = 'rgb'                      # rgb, hsv, hsl, none
c.colors.tabs.selected.even.bg = '#053941'
c.colors.tabs.selected.even.fg = '#fdf6e3'
c.colors.tabs.selected.odd.bg  = '#053941'
c.colors.tabs.selected.odd.fg  = '#fdf6e3'
c.colors.tabs.pinned.even.bg          = '#5eb6aa'
c.colors.tabs.pinned.even.fg          = '#fdf6e3'
c.colors.tabs.pinned.odd.bg           = '#5eb6aa'
c.colors.tabs.pinned.odd.fg           = '#fdf6e3'
c.colors.tabs.pinned.selected.even.bg = '#053941'
c.colors.tabs.pinned.selected.even.fg = '#93cbbd'
c.colors.tabs.pinned.selected.odd.bg  = '#053941'
c.colors.tabs.pinned.selected.odd.fg  = '#93cbbd'

c.colors.webpage.bg = '#053941'
