...
c.hints.border = '1px solid #a99f40'
...
c.colors.messages.error.bg     = '#c3665f'
c.colors.messages.error.border = '#c3665f'
...
c.colors.messages.warning.bg     = '#a99f40'
c.colors.messages.warning.border = '#a99f40'
...
c.colors.statusbar.caret.selection.bg   = '#bd6896'
...
c.colors.statusbar.insert.fg            = '#89aa40'
...
c.colors.statusbar.private.bg           = '#4ba0ca'
c.colors.statusbar.private.fg           = '#fdf6e3'
c.colors.statusbar.progress.bg          = '#fdf6e3'
c.colors.statusbar.url.error.fg         = '#c3665f'
c.colors.statusbar.url.fg               = '#e9e2cf'
c.colors.statusbar.url.hover.fg         = '#fdf6e3'
c.colors.statusbar.url.success.http.fg  = '#89aa40'
c.colors.statusbar.url.success.https.fg = '#89aa40'
c.colors.statusbar.url.warn.fg          = '#a99f40'
...
c.colors.tabs.indicator.error  = '#c3665f'
c.colors.tabs.indicator.start  = '#89aa40'
...
c.colors.tabs.pinned.even.bg          = '#4dafa4'
c.colors.tabs.pinned.even.fg          = '#fdf6e3'
c.colors.tabs.pinned.odd.bg           = '#4dafa4'
