...
c.hints.border = '1px solid #caa849'
...
c.colors.completion.even.bg                     = '#3c3c3c'
c.colors.completion.odd.bg                      = '#3c3c3c'
c.colors.completion.fg                          = ['#689d6a', '#fbf1c7', '#646464']
...
c.colors.downloads.bar.bg    = '#3c3c3c'
...
c.colors.keyhint.suffix.fg = '#3c3c3c'

c.colors.messages.error.bg     = '#c25b46'
c.colors.messages.error.border = '#c25b46'
c.colors.messages.error.fg     = '#282828'
c.colors.messages.info.bg     = '#3c3c3c'
c.colors.messages.info.border = '#3c3c3c'
c.colors.messages.info.fg     = '#fbf1c7'
c.colors.messages.warning.bg     = '#caa849'
c.colors.messages.warning.border = '#caa849'
c.colors.messages.warning.fg     = '#fbf1c7'

c.colors.prompts.bg          = '#282828'
c.colors.prompts.border      = '1px solid #3c3c3c'
c.colors.prompts.fg          = '#fbf1c7'
c.colors.prompts.selected.bg = '#486249'

c.colors.statusbar.caret.fg             = '#b16286'
c.colors.statusbar.caret.bg             = '#2f362f'
c.colors.statusbar.caret.selection.fg   = '#282828'
c.colors.statusbar.caret.selection.bg   = '#b1848c'
c.colors.statusbar.command.fg           = '#fbf1c7'
c.colors.statusbar.command.bg           = '#2f362f'
c.colors.statusbar.command.private.bg   = '#d3c99f'
c.colors.statusbar.command.private.fg   = '#282828'
c.colors.statusbar.insert.fg            = '#a0a744'
c.colors.statusbar.insert.bg            = '#2f362f'
c.colors.statusbar.normal.fg            = '#fbf1c7'
c.colors.statusbar.normal.bg            = '#2f362f'
c.colors.statusbar.passthrough.bg       = '#486249'
c.colors.statusbar.passthrough.fg       = '#fbf1c7'
c.colors.statusbar.private.bg           = '#699b8d'
c.colors.statusbar.private.fg           = '#fbf1c7'
c.colors.statusbar.progress.bg          = '#fbf1c7'
c.colors.statusbar.url.error.fg         = '#c25b46'
c.colors.statusbar.url.fg               = '#e7ddb3'
c.colors.statusbar.url.hover.fg         = '#fbf1c7'
c.colors.statusbar.url.success.http.fg  = '#a0a744'
c.colors.statusbar.url.success.https.fg = '#a0a744'
c.colors.statusbar.url.warn.fg          = '#caa849'

c.colors.tabs.bar.bg           = '#486249'
c.colors.tabs.even.bg          = '#486249'
c.colors.tabs.even.fg          = '#689d6a'
c.colors.tabs.odd.bg           = '#3f5340'
c.colors.tabs.odd.fg           = '#689d6a'
c.colors.tabs.indicator.error  = '#c25b46'
c.colors.tabs.indicator.start  = '#a0a744'
c.colors.tabs.indicator.stop   = '#689d6a'
c.colors.tabs.indicator.system = 'rgb'                      # rgb, hsv, hsl, none
c.colors.tabs.selected.even.bg = '#2f362f'
c.colors.tabs.selected.even.fg = '#fbf1c7'
c.colors.tabs.selected.odd.bg  = '#2f362f'
c.colors.tabs.selected.odd.fg  = '#fbf1c7'
c.colors.tabs.pinned.even.bg          = '#80ab79'
c.colors.tabs.pinned.even.fg          = '#fbf1c7'
c.colors.tabs.pinned.odd.bg           = '#80ab79'
c.colors.tabs.pinned.odd.fg           = '#fbf1c7'
c.colors.tabs.pinned.selected.even.bg = '#2f362f'
c.colors.tabs.pinned.selected.even.fg = '#b1c798'
c.colors.tabs.pinned.selected.odd.bg  = '#2f362f'
c.colors.tabs.pinned.selected.odd.fg  = '#b1c798'

c.colors.webpage.bg = '#2f362f'
