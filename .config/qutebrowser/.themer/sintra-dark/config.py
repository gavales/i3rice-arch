...
c.colors.completion.fg                          = ['#667B86', '#c2c6c4', '#4b524c']
...
c.colors.completion.scrollbar.fg                = '#c2c6c4'

# ━━ downloads
c.colors.downloads.bar.bg    = '#232a24'
c.colors.downloads.error.bg  = '#8A806F'
c.colors.downloads.error.fg  = '#c2c6c4'
c.colors.downloads.start.bg  = '#667B86'
c.colors.downloads.start.fg  = '#c2c6c4'
c.colors.downloads.stop.bg   = '#3E6881'
c.colors.downloads.stop.fg   = '#c2c6c4'
...
c.colors.statusbar.command.fg           = '#c2c6c4'
c.colors.statusbar.command.bg           = '#232a24'
c.colors.statusbar.command.private.bg   = '#4b524c'
c.colors.statusbar.command.private.fg   = '#c2c6c4'
...
c.colors.statusbar.passthrough.fg       = '#c2c6c4'
c.colors.statusbar.private.bg           = '#4b524c'
c.colors.statusbar.private.fg           = '#c2c6c4'
c.colors.statusbar.progress.bg          = '#c2c6c4'
c.colors.statusbar.url.error.fg         = '#8A806F'
c.colors.statusbar.url.fg               = '#c2c6c4'
c.colors.statusbar.url.hover.fg         = '#667B86'
c.colors.statusbar.url.success.http.fg  = '#c2c6c4'
c.colors.statusbar.url.success.https.fg = '#c2c6c4'
c.colors.statusbar.url.warn.fg          = '#517689'

# ━━ tabs
c.colors.tabs.bar.bg           = '#232a24'
c.colors.tabs.even.bg          = '#232a24'
c.colors.tabs.even.fg          = '#c2c6c4'
c.colors.tabs.odd.bg           = '#232a24'
c.colors.tabs.odd.fg           = '#c2c6c4'
