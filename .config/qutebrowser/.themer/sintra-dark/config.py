...
c.colors.completion.category.fg                 = '#232a24'
c.colors.completion.even.bg                     = '#373e38'
c.colors.completion.odd.bg                      = '#373e38'
c.colors.completion.fg                          = ['#667B86', '#f7f4f1', '#5f6660']
c.colors.completion.item.selected.bg            = '#667B86'
c.colors.completion.item.selected.fg            = '#373e38'
...
c.colors.completion.scrollbar.bg                = '#373e38'
c.colors.completion.scrollbar.fg                = '#f7f4f1'

# ━━ downloads
c.colors.downloads.bar.bg    = '#373e38'
c.colors.downloads.error.bg  = '#b85227'
c.colors.downloads.error.fg  = '#f7f4f1'
c.colors.downloads.start.bg  = '#667B86'
c.colors.downloads.start.fg  = '#f7f4f1'
c.colors.downloads.stop.bg   = '#18E3C8'
c.colors.downloads.stop.fg   = '#f7f4f1'
...
c.colors.hints.fg          = '#f7f4f1'
c.colors.hints.match.fg    = '#18E3C8'
c.colors.keyhint.bg        = 'rgba(221, 183, 0, 80%)'
c.colors.keyhint.fg        = '#f7f4f1'
c.colors.keyhint.suffix.fg = '#373e38'

# ━━ errors
c.colors.messages.error.bg     = '#b85227'
c.colors.messages.error.border = '#b85227'
c.colors.messages.error.fg     = '#f7f4f1'

# ━━ info
c.colors.messages.info.bg     = '#f7f4f1'
c.colors.messages.info.border = '#f7f4f1'
c.colors.messages.info.fg     = '#373e38'

# ━━ warning
c.colors.messages.warning.bg     = '#DDB700'
c.colors.messages.warning.border = '#DDB700'
c.colors.messages.warning.fg     = '#373e38'

# ━━ prompts
c.colors.prompts.bg          = '#373e38'
c.colors.prompts.border      = '1px solid #373e38'
c.colors.prompts.fg          = '#f7f4f1'
c.colors.prompts.selected.bg = '#667B86'

# ━━ statusbar
c.colors.statusbar.caret.fg             = '#B043D1'
c.colors.statusbar.caret.bg             = '#373e38'
c.colors.statusbar.caret.selection.fg   = '#B043D1'
c.colors.statusbar.caret.selection.bg   = '#373e38'
c.colors.statusbar.command.fg           = '#f7f4f1'
c.colors.statusbar.command.bg           = '#373e38'
c.colors.statusbar.command.private.bg   = '#5f6660'
c.colors.statusbar.command.private.fg   = '#f7f4f1'
c.colors.statusbar.insert.fg            = '#18E3C8'
c.colors.statusbar.insert.bg            = '#373e38'
c.colors.statusbar.normal.fg            = '#667B86'
c.colors.statusbar.normal.bg            = '#373e38'
c.colors.statusbar.passthrough.bg       = '#373e38'
c.colors.statusbar.passthrough.fg       = '#f7f4f1'
c.colors.statusbar.private.bg           = '#5f6660'
c.colors.statusbar.private.fg           = '#f7f4f1'
c.colors.statusbar.progress.bg          = '#f7f4f1'
c.colors.statusbar.url.error.fg         = '#b85227'
c.colors.statusbar.url.fg               = '#f7f4f1'
c.colors.statusbar.url.hover.fg         = '#667B86'
c.colors.statusbar.url.success.http.fg  = '#f7f4f1'
c.colors.statusbar.url.success.https.fg = '#f7f4f1'
c.colors.statusbar.url.warn.fg          = '#DDB700'

# ━━ tabs
c.colors.tabs.bar.bg           = '#373e38'
c.colors.tabs.even.bg          = '#373e38'
c.colors.tabs.even.fg          = '#f7f4f1'
c.colors.tabs.odd.bg           = '#373e38'
c.colors.tabs.odd.fg           = '#f7f4f1'
...
c.colors.tabs.selected.even.fg = '#373e38'
c.colors.tabs.selected.odd.bg  = '#667B86'
c.colors.tabs.selected.odd.fg  = '#373e38'
