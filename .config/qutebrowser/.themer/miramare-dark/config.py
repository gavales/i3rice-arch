...
c.hints.border = '1px solid #dcc18b'

c.colors.completion.category.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #87c095, stop:1 #87c095)'
c.colors.completion.category.border.bottom      = '#87c095'
c.colors.completion.category.border.top         = '#87c095'
c.colors.completion.category.fg                 = '#e6d6ac'
c.colors.completion.even.bg                     = '#3e383a'
c.colors.completion.odd.bg                      = '#3e383a'
c.colors.completion.fg                          = ['#87c095', '#e6d6ac', '#666062']
c.colors.completion.item.selected.bg            = '#87c095'
c.colors.completion.item.selected.fg            = '#e6d6ac'
c.colors.completion.item.selected.border.bottom = '#87af87'
c.colors.completion.item.selected.border.top    = '#87af87'
c.colors.completion.match.fg                    = '#87c095'
c.colors.completion.item.selected.match.fg      = '#87c095'
c.colors.completion.scrollbar.bg                = '#3e383a'
c.colors.completion.scrollbar.fg                = '#e6d6ac'
...
c.colors.downloads.bar.bg    = '#3e383a'
c.colors.downloads.error.bg  = '#e68183'
c.colors.downloads.error.fg  = '#e6d6ac'
c.colors.downloads.start.bg  = '#87c095'
c.colors.downloads.start.fg  = '#e6d6ac'
c.colors.downloads.stop.bg   = '#87af87'
c.colors.downloads.stop.fg   = '#e6d6ac'
c.colors.downloads.system.bg = 'rgb' # rgb, hsv, hsl, none
c.colors.downloads.system.fg = 'rgb' # rgb, hsv, hsl, none

c.colors.hints.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 rgba(217, 187, 128, 0.8), stop:1 rgba(217, 187, 128, 0.8))'
c.colors.hints.fg          = '#e6d6ac'
c.colors.hints.match.fg    = '#87af87'
c.colors.keyhint.bg        = 'rgba(217, 187, 128, 80%)'
c.colors.keyhint.fg        = '#e6d6ac'
c.colors.keyhint.suffix.fg = '#3e383a'

c.colors.messages.error.bg     = '#e6968d'
c.colors.messages.error.border = '#e6968d'
c.colors.messages.error.fg     = '#2A2426'
c.colors.messages.info.bg     = '#3e383a'
c.colors.messages.info.border = '#3e383a'
c.colors.messages.info.fg     = '#e6d6ac'
c.colors.messages.warning.bg     = '#dcc18b'
c.colors.messages.warning.border = '#dcc18b'
c.colors.messages.warning.fg     = '#e6d6ac'

c.colors.prompts.bg          = '#2A2426'
c.colors.prompts.border      = '1px solid #3e383a'
c.colors.prompts.fg          = '#e6d6ac'
c.colors.prompts.selected.bg = '#58725d'

c.colors.statusbar.caret.fg             = '#d3a0bc'
c.colors.statusbar.caret.bg             = '#353633'
c.colors.statusbar.caret.selection.fg   = '#2A2426'
c.colors.statusbar.caret.selection.bg   = '#d7adb8'
c.colors.statusbar.command.fg           = '#e6d6ac'
c.colors.statusbar.command.bg           = '#353633'
c.colors.statusbar.command.private.bg   = '#beae84'
c.colors.statusbar.command.private.fg   = '#2A2426'
c.colors.statusbar.insert.fg            = '#9eb890'
c.colors.statusbar.insert.bg            = '#353633'
c.colors.statusbar.normal.fg            = '#e6d6ac'
c.colors.statusbar.normal.bg            = '#353633'
c.colors.statusbar.passthrough.bg       = '#58725d'
c.colors.statusbar.passthrough.fg       = '#e6d6ac'
c.colors.statusbar.private.bg           = '#9ec59a'
c.colors.statusbar.private.fg           = '#e6d6ac'
c.colors.statusbar.progress.bg          = '#e6d6ac'
c.colors.statusbar.url.error.fg         = '#e6968d'
c.colors.statusbar.url.fg               = '#d2c298'
c.colors.statusbar.url.hover.fg         = '#e6d6ac'
c.colors.statusbar.url.success.http.fg  = '#9eb890'
c.colors.statusbar.url.success.https.fg = '#9eb890'
c.colors.statusbar.url.warn.fg          = '#dcc18b'

c.colors.tabs.bar.bg           = '#58725d'
c.colors.tabs.even.bg          = '#58725d'
c.colors.tabs.even.fg          = '#87c095'
c.colors.tabs.odd.bg           = '#4c5d4f'
c.colors.tabs.odd.fg           = '#87c095'
c.colors.tabs.indicator.error  = '#e6968d'
c.colors.tabs.indicator.start  = '#9eb890'
c.colors.tabs.indicator.stop   = '#87c095'
c.colors.tabs.indicator.system = 'rgb' # rgb, hsv, hsl, none
c.colors.tabs.selected.even.bg = '#353633'
c.colors.tabs.selected.even.fg = '#e6d6ac'
c.colors.tabs.selected.odd.bg  = '#353633'
c.colors.tabs.selected.odd.fg  = '#e6d6ac'
c.colors.tabs.pinned.even.bg          = '#a0c4b6'
c.colors.tabs.pinned.even.fg          = '#e6d6ac'
c.colors.tabs.pinned.odd.bg           = '#a0c4b6'
c.colors.tabs.pinned.odd.fg           = '#e6d6ac'
c.colors.tabs.pinned.selected.even.bg = '#353633'
c.colors.tabs.pinned.selected.even.fg = '#b6cba0'
c.colors.tabs.pinned.selected.odd.bg  = '#353633'
c.colors.tabs.pinned.selected.odd.fg  = '#b6cba0'

c.colors.webpage.bg = '#353633'
...
c.fonts.default_family = ['Luxi Mono']
...
c.tabs.title.format = '{audio}{private}{scroll_pos} {current_title}'
