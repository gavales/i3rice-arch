...
c.colors.completion.item.selected.fg            = '#3e383a'
...
# ━━ info
c.colors.messages.info.bg     = '#e6d6ac'
c.colors.messages.info.border = '#e6d6ac'
c.colors.messages.info.fg     = '#3e383a'

# ━━ warning
c.colors.messages.warning.bg     = '#d9bb80'
c.colors.messages.warning.border = '#d9bb80'
c.colors.messages.warning.fg     = '#3e383a'

# ━━ prompts
c.colors.prompts.bg          = '#3e383a'
...
c.colors.statusbar.caret.bg             = '#3e383a'
c.colors.statusbar.caret.selection.fg   = '#d3a0bc'
c.colors.statusbar.caret.selection.bg   = '#3e383a'
c.colors.statusbar.command.fg           = '#e6d6ac'
c.colors.statusbar.command.bg           = '#3e383a'
c.colors.statusbar.command.private.bg   = '#666062'
c.colors.statusbar.command.private.fg   = '#e6d6ac'
c.colors.statusbar.insert.fg            = '#87af87'
c.colors.statusbar.insert.bg            = '#3e383a'
c.colors.statusbar.normal.fg            = '#87c095'
c.colors.statusbar.normal.bg            = '#3e383a'
c.colors.statusbar.passthrough.bg       = '#3e383a'
c.colors.statusbar.passthrough.fg       = '#e6d6ac'
c.colors.statusbar.private.bg           = '#666062'
c.colors.statusbar.private.fg           = '#e6d6ac'
c.colors.statusbar.progress.bg          = '#e6d6ac'
c.colors.statusbar.url.error.fg         = '#e68183'
c.colors.statusbar.url.fg               = '#e6d6ac'
c.colors.statusbar.url.hover.fg         = '#87c095'
c.colors.statusbar.url.success.http.fg  = '#e6d6ac'
c.colors.statusbar.url.success.https.fg = '#e6d6ac'
c.colors.statusbar.url.warn.fg          = '#d9bb80'

# ━━ tabs
c.colors.tabs.bar.bg           = '#3e383a'
c.colors.tabs.even.bg          = '#3e383a'
c.colors.tabs.even.fg          = '#e6d6ac'
c.colors.tabs.odd.bg           = '#3e383a'
c.colors.tabs.odd.fg           = '#e6d6ac'
...
c.colors.tabs.selected.even.fg = '#3e383a'
c.colors.tabs.selected.odd.bg  = '#87c095'
c.colors.tabs.selected.odd.fg  = '#3e383a'
