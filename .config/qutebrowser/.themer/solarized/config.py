...
c.hints.border = '1px solid #87710d'

c.colors.completion.category.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #2aa198, stop:1 #2aa198)'
c.colors.completion.category.border.bottom      = '#2aa198'
c.colors.completion.category.border.top         = '#2aa198'
c.colors.completion.category.fg                 = '#002b36'
c.colors.completion.even.bg                     = '#e9e2cf'
c.colors.completion.odd.bg                      = '#e9e2cf'
c.colors.completion.fg                          = ['#2aa198', '#002b36', '#c1baa7']
c.colors.completion.item.selected.bg            = '#2aa198'
c.colors.completion.item.selected.fg            = '#002b36'
c.colors.completion.item.selected.border.bottom = '#859900'
c.colors.completion.item.selected.border.top    = '#859900'
c.colors.completion.match.fg                    = '#2aa198'
c.colors.completion.item.selected.match.fg      = '#2aa198'
c.colors.completion.scrollbar.bg                = '#e9e2cf'
c.colors.completion.scrollbar.fg                = '#002b36'
...
c.colors.downloads.error.fg  = '#002b36'
c.colors.downloads.start.bg  = '#2aa198'
...
c.colors.hints.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 rgba(181, 137, 0, 0.8), stop:1 rgba(181, 137, 0, 0.8))'
c.colors.hints.fg          = '#002b36'
c.colors.hints.match.fg    = '#859900'
c.colors.keyhint.bg        = 'rgba(181, 137, 0, 80%)'
c.colors.keyhint.fg        = '#002b36'
c.colors.keyhint.suffix.fg = '#e9e2cf'

c.colors.messages.error.bg     = '#a53030'
c.colors.messages.error.border = '#a53030'
c.colors.messages.error.fg     = '#fdf6e3'
c.colors.messages.info.bg     = '#e9e2cf'
c.colors.messages.info.border = '#e9e2cf'
c.colors.messages.info.fg     = '#002b36'
c.colors.messages.warning.bg     = '#87710d'
c.colors.messages.warning.border = '#87710d'
c.colors.messages.warning.fg     = '#002b36'

c.colors.prompts.bg          = '#fdf6e3'
c.colors.prompts.border      = '1px solid #e9e2cf'
c.colors.prompts.fg          = '#002b36'
c.colors.prompts.selected.bg = '#93cbbd'

c.colors.statusbar.caret.fg             = '#d33682'
c.colors.statusbar.caret.bg             = '#e3ebda'
c.colors.statusbar.caret.selection.fg   = '#fdf6e3'
c.colors.statusbar.caret.selection.bg   = '#9e336f'
c.colors.statusbar.command.fg           = '#002b36'
c.colors.statusbar.command.bg           = '#e3ebda'
c.colors.statusbar.command.private.bg   = '#28535e'
c.colors.statusbar.command.private.fg   = '#fdf6e3'
c.colors.statusbar.insert.fg            = '#637d0d'
c.colors.statusbar.insert.bg            = '#e3ebda'
c.colors.statusbar.normal.fg            = '#002b36'
c.colors.statusbar.normal.bg            = '#e3ebda'
c.colors.statusbar.passthrough.bg       = '#93cbbd'
c.colors.statusbar.passthrough.fg       = '#002b36'
c.colors.statusbar.private.bg           = '#1c73ab'
c.colors.statusbar.private.fg           = '#002b36'
c.colors.statusbar.progress.bg          = '#002b36'
c.colors.statusbar.url.error.fg         = '#a53030'
c.colors.statusbar.url.fg               = '#143f4a'
c.colors.statusbar.url.hover.fg         = '#002b36'
c.colors.statusbar.url.success.http.fg  = '#637d0d'
c.colors.statusbar.url.success.https.fg = '#637d0d'
c.colors.statusbar.url.warn.fg          = '#87710d'

c.colors.tabs.bar.bg           = '#93cbbd'
c.colors.tabs.even.bg          = '#93cbbd'
c.colors.tabs.even.fg          = '#2aa198'
c.colors.tabs.odd.bg           = '#aed6c7'
c.colors.tabs.odd.fg           = '#2aa198'
c.colors.tabs.indicator.error  = '#a53030'
c.colors.tabs.indicator.start  = '#637d0d'
c.colors.tabs.indicator.stop   = '#2aa198'
c.colors.tabs.indicator.system = 'rgb' # rgb, hsv, hsl, none
c.colors.tabs.selected.even.bg = '#e3ebda'
c.colors.tabs.selected.even.fg = '#002b36'
c.colors.tabs.selected.odd.bg  = '#e3ebda'
c.colors.tabs.selected.odd.fg  = '#002b36'
c.colors.tabs.pinned.even.bg          = '#1f837f'
c.colors.tabs.pinned.even.fg          = '#002b36'
c.colors.tabs.pinned.odd.bg           = '#1f837f'
c.colors.tabs.pinned.odd.fg           = '#002b36'
c.colors.tabs.pinned.selected.even.bg = '#e3ebda'
c.colors.tabs.pinned.selected.even.fg = '#156667'
c.colors.tabs.pinned.selected.odd.bg  = '#e3ebda'
c.colors.tabs.pinned.selected.odd.fg  = '#156667'

c.colors.webpage.bg = '#e3ebda'
