...
c.hints.border = '1px solid #8d8019'
...
c.colors.messages.error.bg     = '#aa3f3d'
c.colors.messages.error.border = '#aa3f3d'
...
c.colors.messages.warning.bg     = '#8d8019'
c.colors.messages.warning.border = '#8d8019'
...
c.colors.statusbar.caret.selection.bg   = '#a3427b'
...
c.colors.statusbar.insert.fg            = '#698c19'
...
c.colors.statusbar.private.bg           = '#2181b7'
c.colors.statusbar.private.fg           = '#002b36'
c.colors.statusbar.progress.bg          = '#002b36'
c.colors.statusbar.url.error.fg         = '#aa3f3d'
c.colors.statusbar.url.fg               = '#143f4a'
c.colors.statusbar.url.hover.fg         = '#002b36'
c.colors.statusbar.url.success.http.fg  = '#698c19'
c.colors.statusbar.url.success.https.fg = '#698c19'
c.colors.statusbar.url.warn.fg          = '#8d8019'
...
c.colors.tabs.indicator.error  = '#aa3f3d'
c.colors.tabs.indicator.start  = '#698c19'
...
c.colors.tabs.pinned.even.bg          = '#24928b'
c.colors.tabs.pinned.even.fg          = '#002b36'
c.colors.tabs.pinned.odd.bg           = '#24928b'
