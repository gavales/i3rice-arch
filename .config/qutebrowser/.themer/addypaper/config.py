...
# ━  COLORS
# ━━ completion
c.colors.completion.category.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #e46c6d, stop:1 #e46c6d)'
c.colors.completion.category.border.bottom      = '#e46c6d'
c.colors.completion.category.border.top         = '#e46c6d'
c.colors.completion.category.fg                 = '#fdf6e3'
c.colors.completion.even.bg                     = '#e9e2cf'
c.colors.completion.odd.bg                      = '#e9e2cf'
c.colors.completion.fg                          = ['#e46c6d', '#3b4d4f', '#c1baa7']
c.colors.completion.item.selected.bg            = '#e46c6d'
c.colors.completion.item.selected.fg            = '#e9e2cf'
c.colors.completion.item.selected.border.bottom = '#8cb88b'
c.colors.completion.item.selected.border.top    = '#8cb88b'
c.colors.completion.match.fg                    = '#e46c6d'
c.colors.completion.scrollbar.bg                = '#e9e2cf'
c.colors.completion.scrollbar.fg                = '#3b4d4f'

# ━━ downloads
c.colors.downloads.bar.bg    = '#e9e2cf'
c.colors.downloads.error.bg  = '#d65455'
c.colors.downloads.error.fg  = '#3b4d4f'
c.colors.downloads.start.bg  = '#e46c6d'
c.colors.downloads.start.fg  = '#3b4d4f'
c.colors.downloads.stop.bg   = '#8cb88b'
c.colors.downloads.stop.fg   = '#3b4d4f'
c.colors.downloads.system.bg = 'rgb' # rgb, hsv, hsl, none
c.colors.downloads.system.fg = 'rgb' # rgb, hsv, hsl, none

# ━━ hints
c.colors.hints.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 rgba(196, 155, 74, 0.8), stop:1 rgba(196, 155, 74, 0.8))'
c.colors.hints.fg          = '#3b4d4f'
c.colors.hints.match.fg    = '#8cb88b'
c.colors.keyhint.bg        = 'rgba(196, 155, 74, 80%)'
c.colors.keyhint.fg        = '#3b4d4f'
c.colors.keyhint.suffix.fg = '#e9e2cf'

# ━━ errors
c.colors.messages.error.bg     = '#d65455'
c.colors.messages.error.border = '#d65455'
c.colors.messages.error.fg     = '#3b4d4f'

# ━━ info
c.colors.messages.info.bg     = '#3b4d4f'
c.colors.messages.info.border = '#3b4d4f'
c.colors.messages.info.fg     = '#e9e2cf'

# ━━ warning
c.colors.messages.warning.bg     = '#c49b4a'
c.colors.messages.warning.border = '#c49b4a'
c.colors.messages.warning.fg     = '#e9e2cf'

# ━━ prompts
c.colors.prompts.bg          = '#e9e2cf'
c.colors.prompts.border      = '1px solid #e9e2cf'
c.colors.prompts.fg          = '#3b4d4f'
c.colors.prompts.selected.bg = '#e46c6d'

# ━━ statusbar
c.colors.statusbar.caret.fg             = '#a38895'
c.colors.statusbar.caret.bg             = '#e9e2cf'
c.colors.statusbar.caret.selection.fg   = '#a38895'
c.colors.statusbar.caret.selection.bg   = '#e9e2cf'
c.colors.statusbar.command.fg           = '#3b4d4f'
c.colors.statusbar.command.bg           = '#e9e2cf'
c.colors.statusbar.command.private.bg   = '#c1baa7'
c.colors.statusbar.command.private.fg   = '#3b4d4f'
c.colors.statusbar.insert.fg            = '#8cb88b'
c.colors.statusbar.insert.bg            = '#e9e2cf'
c.colors.statusbar.normal.fg            = '#e46c6d'
c.colors.statusbar.normal.bg            = '#e9e2cf'
c.colors.statusbar.passthrough.bg       = '#e9e2cf'
c.colors.statusbar.passthrough.fg       = '#3b4d4f'
c.colors.statusbar.private.bg           = '#c1baa7'
c.colors.statusbar.private.fg           = '#3b4d4f'
c.colors.statusbar.progress.bg          = '#3b4d4f'
c.colors.statusbar.url.error.fg         = '#d65455'
c.colors.statusbar.url.fg               = '#3b4d4f'
c.colors.statusbar.url.hover.fg         = '#e46c6d'
c.colors.statusbar.url.success.http.fg  = '#3b4d4f'
c.colors.statusbar.url.success.https.fg = '#3b4d4f'
c.colors.statusbar.url.warn.fg          = '#c49b4a'

# ━━ tabs
c.colors.tabs.bar.bg           = '#e9e2cf'
c.colors.tabs.even.bg          = '#e9e2cf'
c.colors.tabs.even.fg          = '#3b4d4f'
c.colors.tabs.odd.bg           = '#e9e2cf'
c.colors.tabs.odd.fg           = '#3b4d4f'
c.colors.tabs.indicator.error  = '#d65455'
c.colors.tabs.indicator.start  = '#e46c6d'
c.colors.tabs.indicator.stop   = '#8cb88b'
c.colors.tabs.indicator.system = 'rgb' # rgb, hsv, hsl, none
c.colors.tabs.selected.even.bg = '#e46c6d'
c.colors.tabs.selected.even.fg = '#e9e2cf'
c.colors.tabs.selected.odd.bg  = '#e46c6d'
c.colors.tabs.selected.odd.fg  = '#e9e2cf'
...
c.hints.border                     = '1px solid #c49b4a'
