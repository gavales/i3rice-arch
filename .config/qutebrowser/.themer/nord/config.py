...
# ━  COLORS
# ━━ completion
c.colors.completion.category.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #8FBCBB, stop:1 #8FBCBB)'
c.colors.completion.category.border.bottom      = '#8FBCBB'
c.colors.completion.category.border.top         = '#8FBCBB'
c.colors.completion.category.fg                 = '#D8DEE9'
c.colors.completion.even.bg                     = '#c4cad5'
c.colors.completion.odd.bg                      = '#c4cad5'
c.colors.completion.fg                          = ['#8FBCBB', '#3B4252', '#9ca2ad']
c.colors.completion.item.selected.bg            = '#8FBCBB'
c.colors.completion.item.selected.fg            = '#c4cad5'
c.colors.completion.item.selected.border.bottom = '#a3be8c'
c.colors.completion.item.selected.border.top    = '#a3be8c'
c.colors.completion.match.fg                    = '#8FBCBB'
c.colors.completion.scrollbar.bg                = '#c4cad5'
c.colors.completion.scrollbar.fg                = '#3B4252'

# ━━ downloads
c.colors.downloads.bar.bg    = '#c4cad5'
c.colors.downloads.error.bg  = '#bf616a'
c.colors.downloads.error.fg  = '#3B4252'
c.colors.downloads.start.bg  = '#8FBCBB'
c.colors.downloads.start.fg  = '#3B4252'
c.colors.downloads.stop.bg   = '#a3be8c'
c.colors.downloads.stop.fg   = '#3B4252'
c.colors.downloads.system.bg = 'rgb' # rgb, hsv, hsl, none
c.colors.downloads.system.fg = 'rgb' # rgb, hsv, hsl, none

# ━━ hints
c.colors.hints.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 rgba(235, 203, 139, 0.8), stop:1 rgba(235, 203, 139, 0.8))'
c.colors.hints.fg          = '#3B4252'
c.colors.hints.match.fg    = '#a3be8c'
c.colors.keyhint.bg        = 'rgba(235, 203, 139, 80%)'
c.colors.keyhint.fg        = '#3B4252'
c.colors.keyhint.suffix.fg = '#c4cad5'

# ━━ errors
c.colors.messages.error.bg     = '#bf616a'
c.colors.messages.error.border = '#bf616a'
c.colors.messages.error.fg     = '#3B4252'

# ━━ info
c.colors.messages.info.bg     = '#3B4252'
c.colors.messages.info.border = '#3B4252'
c.colors.messages.info.fg     = '#c4cad5'

# ━━ warning
c.colors.messages.warning.bg     = '#ebcb8b'
c.colors.messages.warning.border = '#ebcb8b'
c.colors.messages.warning.fg     = '#c4cad5'

# ━━ prompts
c.colors.prompts.bg          = '#c4cad5'
c.colors.prompts.border      = '1px solid #c4cad5'
c.colors.prompts.fg          = '#3B4252'
c.colors.prompts.selected.bg = '#8FBCBB'

# ━━ statusbar
c.colors.statusbar.caret.fg             = '#b48ead'
c.colors.statusbar.caret.bg             = '#c4cad5'
c.colors.statusbar.caret.selection.fg   = '#b48ead'
c.colors.statusbar.caret.selection.bg   = '#c4cad5'
c.colors.statusbar.command.fg           = '#3B4252'
c.colors.statusbar.command.bg           = '#c4cad5'
c.colors.statusbar.command.private.bg   = '#9ca2ad'
c.colors.statusbar.command.private.fg   = '#3B4252'
c.colors.statusbar.insert.fg            = '#a3be8c'
c.colors.statusbar.insert.bg            = '#c4cad5'
c.colors.statusbar.normal.fg            = '#8FBCBB'
c.colors.statusbar.normal.bg            = '#c4cad5'
c.colors.statusbar.passthrough.bg       = '#c4cad5'
c.colors.statusbar.passthrough.fg       = '#3B4252'
c.colors.statusbar.private.bg           = '#9ca2ad'
c.colors.statusbar.private.fg           = '#3B4252'
c.colors.statusbar.progress.bg          = '#3B4252'
c.colors.statusbar.url.error.fg         = '#bf616a'
c.colors.statusbar.url.fg               = '#3B4252'
c.colors.statusbar.url.hover.fg         = '#8FBCBB'
c.colors.statusbar.url.success.http.fg  = '#3B4252'
c.colors.statusbar.url.success.https.fg = '#3B4252'
c.colors.statusbar.url.warn.fg          = '#ebcb8b'

# ━━ tabs
c.colors.tabs.bar.bg           = '#c4cad5'
c.colors.tabs.even.bg          = '#c4cad5'
c.colors.tabs.even.fg          = '#3B4252'
c.colors.tabs.odd.bg           = '#c4cad5'
c.colors.tabs.odd.fg           = '#3B4252'
...
c.colors.tabs.selected.even.bg = '#8FBCBB'
c.colors.tabs.selected.even.fg = '#c4cad5'
c.colors.tabs.selected.odd.bg  = '#8FBCBB'
c.colors.tabs.selected.odd.fg  = '#c4cad5'
