...
# ━  COLORS
# ━━ completion
c.colors.completion.category.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #d5715e, stop:1 #d5715e)'
c.colors.completion.category.border.bottom      = '#d5715e'
c.colors.completion.category.border.top         = '#d5715e'
c.colors.completion.category.fg                 = '#1F1F1F'
c.colors.completion.even.bg                     = '#333333'
c.colors.completion.odd.bg                      = '#333333'
c.colors.completion.fg                          = ['#d5715e', '#DFBF9F', '#5b5b5b']
...
c.colors.completion.scrollbar.fg                = '#DFBF9F'

# ━━ downloads
c.colors.downloads.bar.bg    = '#333333'
c.colors.downloads.error.bg  = '#FF4971'
c.colors.downloads.error.fg  = '#DFBF9F'
c.colors.downloads.start.bg  = '#d5715e'
c.colors.downloads.start.fg  = '#DFBF9F'
c.colors.downloads.stop.bg   = '#18E3C8'
c.colors.downloads.stop.fg   = '#DFBF9F'
...
c.colors.prompts.fg          = '#DFBF9F'
c.colors.prompts.selected.bg = '#d5715e'

# ━━ statusbar
c.colors.statusbar.caret.fg             = '#B043D1'
c.colors.statusbar.caret.bg             = '#333333'
c.colors.statusbar.caret.selection.fg   = '#B043D1'
c.colors.statusbar.caret.selection.bg   = '#333333'
c.colors.statusbar.command.fg           = '#DFBF9F'
c.colors.statusbar.command.bg           = '#333333'
c.colors.statusbar.command.private.bg   = '#5b5b5b'
c.colors.statusbar.command.private.fg   = '#DFBF9F'
...
c.colors.statusbar.passthrough.fg       = '#DFBF9F'
c.colors.statusbar.private.bg           = '#5b5b5b'
c.colors.statusbar.private.fg           = '#DFBF9F'
c.colors.statusbar.progress.bg          = '#DFBF9F'
c.colors.statusbar.url.error.fg         = '#FF4971'
c.colors.statusbar.url.fg               = '#DFBF9F'
c.colors.statusbar.url.hover.fg         = '#d5715e'
c.colors.statusbar.url.success.http.fg  = '#DFBF9F'
c.colors.statusbar.url.success.https.fg = '#DFBF9F'
c.colors.statusbar.url.warn.fg          = '#FF8037'

# ━━ tabs
c.colors.tabs.bar.bg           = '#333333'
c.colors.tabs.even.bg          = '#333333'
c.colors.tabs.even.fg          = '#DFBF9F'
c.colors.tabs.odd.bg           = '#333333'
c.colors.tabs.odd.fg           = '#DFBF9F'
...
c.colors.tabs.selected.odd.bg  = '#d5715e'
