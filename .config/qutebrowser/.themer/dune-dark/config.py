...
c.hints.border = '1px solid #e5bf2f'

c.colors.completion.category.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #EFA92E, stop:1 #EFA92E)'
c.colors.completion.category.border.bottom      = '#EFA92E'
c.colors.completion.category.border.top         = '#EFA92E'
c.colors.completion.category.fg                 = '#fef7ec'
c.colors.completion.even.bg                     = '#5a2b2b'
c.colors.completion.odd.bg                      = '#5a2b2b'
c.colors.completion.fg                          = ['#EFA92E', '#fef7ec', '#825353']
c.colors.completion.item.selected.bg            = '#EFA92E'
c.colors.completion.item.selected.fg            = '#fef7ec'
c.colors.completion.item.selected.border.bottom = '#18E3C8'
c.colors.completion.item.selected.border.top    = '#18E3C8'
c.colors.completion.match.fg                    = '#EFA92E'
c.colors.completion.item.selected.match.fg      = '#EFA92E'
c.colors.completion.scrollbar.bg                = '#5a2b2b'
c.colors.completion.scrollbar.fg                = '#fef7ec'
...
c.colors.downloads.bar.bg    = '#5a2b2b'
c.colors.downloads.error.bg  = '#b85227'
c.colors.downloads.error.fg  = '#fef7ec'
c.colors.downloads.start.bg  = '#EFA92E'
c.colors.downloads.start.fg  = '#fef7ec'
c.colors.downloads.stop.bg   = '#18E3C8'
c.colors.downloads.stop.fg   = '#fef7ec'
c.colors.downloads.system.bg = 'rgb' # rgb, hsv, hsl, none
c.colors.downloads.system.fg = 'rgb' # rgb, hsv, hsl, none

c.colors.hints.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 rgba(221, 183, 0, 0.8), stop:1 rgba(221, 183, 0, 0.8))'
c.colors.hints.fg          = '#fef7ec'
c.colors.hints.match.fg    = '#18E3C8'
c.colors.keyhint.bg        = 'rgba(221, 183, 0, 80%)'
c.colors.keyhint.fg        = '#fef7ec'
c.colors.keyhint.suffix.fg = '#5a2b2b'

c.colors.messages.error.bg     = '#cd7c49'
c.colors.messages.error.border = '#cd7c49'
c.colors.messages.error.fg     = '#461717'
c.colors.messages.info.bg     = '#5a2b2b'
c.colors.messages.info.border = '#5a2b2b'
c.colors.messages.info.fg     = '#fef7ec'
c.colors.messages.warning.bg     = '#e5bf2f'
c.colors.messages.warning.border = '#e5bf2f'
c.colors.messages.warning.fg     = '#fef7ec'

c.colors.prompts.bg          = '#461717'
c.colors.prompts.border      = '1px solid #5a2b2b'
c.colors.prompts.fg          = '#fef7ec'
c.colors.prompts.selected.bg = '#9a6022'

c.colors.statusbar.caret.fg             = '#B043D1'
c.colors.statusbar.caret.bg             = '#5a2819'
c.colors.statusbar.caret.selection.fg   = '#461717'
c.colors.statusbar.caret.selection.bg   = '#c772b9'
c.colors.statusbar.command.fg           = '#fef7ec'
c.colors.statusbar.command.bg           = '#5a2819'
c.colors.statusbar.command.private.bg   = '#d6cfc4'
c.colors.statusbar.command.private.fg   = '#461717'
c.colors.statusbar.insert.fg            = '#63dcb3'
c.colors.statusbar.insert.bg            = '#5a2819'
c.colors.statusbar.normal.fg            = '#fef7ec'
c.colors.statusbar.normal.bg            = '#5a2819'
c.colors.statusbar.passthrough.bg       = '#9a6022'
c.colors.statusbar.passthrough.fg       = '#fef7ec'
c.colors.statusbar.private.bg           = '#7dd7cd'
c.colors.statusbar.private.fg           = '#fef7ec'
c.colors.statusbar.progress.bg          = '#fef7ec'
c.colors.statusbar.url.error.fg         = '#cd7c49'
c.colors.statusbar.url.fg               = '#eae3d8'
c.colors.statusbar.url.hover.fg         = '#fef7ec'
c.colors.statusbar.url.success.http.fg  = '#63dcb3'
c.colors.statusbar.url.success.https.fg = '#63dcb3'
c.colors.statusbar.url.warn.fg          = '#e5bf2f'

c.colors.tabs.bar.bg           = '#9a6022'
c.colors.tabs.even.bg          = '#9a6022'
c.colors.tabs.even.fg          = '#EFA92E'
c.colors.tabs.odd.bg           = '#844d1f'
c.colors.tabs.odd.fg           = '#EFA92E'
c.colors.tabs.indicator.error  = '#cd7c49'
c.colors.tabs.indicator.start  = '#63dcb3'
c.colors.tabs.indicator.stop   = '#EFA92E'
c.colors.tabs.indicator.system = 'rgb'                      # rgb, hsv, hsl, none
c.colors.tabs.selected.even.bg = '#5a2819'
c.colors.tabs.selected.even.fg = '#fef7ec'
c.colors.tabs.selected.odd.bg  = '#5a2819'
c.colors.tabs.selected.odd.fg  = '#fef7ec'
c.colors.tabs.pinned.even.bg          = '#6d99a9'
c.colors.tabs.pinned.even.fg          = '#fef7ec'
c.colors.tabs.pinned.odd.bg           = '#6d99a9'
c.colors.tabs.pinned.odd.fg           = '#fef7ec'
c.colors.tabs.pinned.selected.even.bg = '#5a2819'
c.colors.tabs.pinned.selected.even.fg = '#f6d08d'
c.colors.tabs.pinned.selected.odd.bg  = '#5a2819'
c.colors.tabs.pinned.selected.odd.fg  = '#f6d08d'

c.colors.webpage.bg = '#5a2819'
