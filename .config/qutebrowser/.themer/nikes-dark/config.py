...
c.hints.border = '1px solid #f09645'
...
c.colors.completion.category.fg                 = '#f6f6f4'
c.colors.completion.even.bg                     = '#444444'
c.colors.completion.odd.bg                      = '#444444'
c.colors.completion.fg                          = ['#b46b7d', '#f6f6f4', '#6c6c6c']
c.colors.completion.item.selected.bg            = '#b46b7d'
c.colors.completion.item.selected.fg            = '#f6f6f4'
...
c.colors.completion.scrollbar.fg                = '#f6f6f4'
...
c.colors.downloads.bar.bg    = '#444444'
c.colors.downloads.error.bg  = '#ff4845'
c.colors.downloads.error.fg  = '#f6f6f4'
c.colors.downloads.start.bg  = '#b46b7d'
c.colors.downloads.start.fg  = '#f6f6f4'
c.colors.downloads.stop.bg   = '#47aa12'
c.colors.downloads.stop.fg   = '#f6f6f4'
...
c.colors.hints.fg          = '#f6f6f4'
c.colors.hints.match.fg    = '#47aa12'
c.colors.keyhint.bg        = 'rgba(255, 137, 10, 80%)'
c.colors.keyhint.fg        = '#f6f6f4'
c.colors.keyhint.suffix.fg = '#444444'

c.colors.messages.error.bg     = '#f06b6c'
c.colors.messages.error.border = '#f06b6c'
c.colors.messages.error.fg     = '#303030'
c.colors.messages.info.bg     = '#444444'
c.colors.messages.info.border = '#444444'
c.colors.messages.info.fg     = '#f6f6f4'
c.colors.messages.warning.bg     = '#f09645'
c.colors.messages.warning.border = '#f09645'
c.colors.messages.warning.fg     = '#f6f6f4'

c.colors.prompts.bg          = '#303030'
c.colors.prompts.border      = '1px solid #444444'
c.colors.prompts.fg          = '#f6f6f4'
c.colors.prompts.selected.bg = '#724d56'

c.colors.statusbar.caret.fg             = '#288ad6'
c.colors.statusbar.caret.bg             = '#3f3739'
c.colors.statusbar.caret.selection.fg   = '#303030'
c.colors.statusbar.caret.selection.bg   = '#6296cb'
c.colors.statusbar.command.fg           = '#f6f6f4'
c.colors.statusbar.command.bg           = '#3f3739'
c.colors.statusbar.command.private.bg   = '#cececc'
c.colors.statusbar.command.private.fg   = '#303030'
c.colors.statusbar.insert.fg            = '#77ac4a'
c.colors.statusbar.insert.bg            = '#3f3739'
c.colors.statusbar.normal.fg            = '#f6f6f4'
c.colors.statusbar.normal.bg            = '#3f3739'
c.colors.statusbar.passthrough.bg       = '#724d56'
c.colors.statusbar.passthrough.fg       = '#f6f6f4'
c.colors.statusbar.private.bg           = '#8fb2a9'
c.colors.statusbar.private.fg           = '#f6f6f4'
c.colors.statusbar.progress.bg          = '#f6f6f4'
c.colors.statusbar.url.error.fg         = '#f06b6c'
c.colors.statusbar.url.fg               = '#e2e2e0'
c.colors.statusbar.url.hover.fg         = '#f6f6f4'
c.colors.statusbar.url.success.http.fg  = '#77ac4a'
c.colors.statusbar.url.success.https.fg = '#77ac4a'
c.colors.statusbar.url.warn.fg          = '#f09645'

c.colors.tabs.bar.bg           = '#724d56'
c.colors.tabs.even.bg          = '#724d56'
c.colors.tabs.even.fg          = '#b46b7d'
c.colors.tabs.odd.bg           = '#60454c'
c.colors.tabs.odd.fg           = '#b46b7d'
c.colors.tabs.indicator.error  = '#f06b6c'
c.colors.tabs.indicator.start  = '#77ac4a'
c.colors.tabs.indicator.stop   = '#b46b7d'
c.colors.tabs.indicator.system = 'rgb'                      # rgb, hsv, hsl, none
c.colors.tabs.selected.even.bg = '#3f3739'
c.colors.tabs.selected.even.fg = '#f6f6f4'
c.colors.tabs.selected.odd.bg  = '#3f3739'
c.colors.tabs.selected.odd.fg  = '#f6f6f4'
c.colors.tabs.pinned.even.bg          = '#bf8291'
c.colors.tabs.pinned.even.fg          = '#f6f6f4'
c.colors.tabs.pinned.odd.bg           = '#bf8291'
c.colors.tabs.pinned.odd.fg           = '#f6f6f4'
c.colors.tabs.pinned.selected.even.bg = '#3f3739'
c.colors.tabs.pinned.selected.even.fg = '#d5b0b8'
c.colors.tabs.pinned.selected.odd.bg  = '#3f3739'
c.colors.tabs.pinned.selected.odd.fg  = '#d5b0b8'

c.colors.webpage.bg = '#3f3739'
