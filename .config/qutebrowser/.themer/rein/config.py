...
c.colors.completion.category.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #66ac68, stop:1 #66ac68)'
c.colors.completion.category.border.bottom      = '#66ac68'
c.colors.completion.category.border.top         = '#66ac68'
c.colors.completion.category.fg                 = '#505050'
c.colors.completion.even.bg                     = '#e6e6e6'
c.colors.completion.odd.bg                      = '#e6e6e6'
c.colors.completion.fg                          = ['#66ac68', '#505050', '#bebebe']
c.colors.completion.item.selected.bg            = '#66ac68'
c.colors.completion.item.selected.fg            = '#505050'
c.colors.completion.item.selected.border.bottom = '#66ac68'
c.colors.completion.item.selected.border.top    = '#66ac68'
c.colors.completion.match.fg                    = '#66ac68'
c.colors.completion.item.selected.match.fg      = '#66ac68'
c.colors.completion.scrollbar.bg                = '#e6e6e6'
...
c.colors.downloads.bar.bg    = '#e6e6e6'
c.colors.downloads.error.bg  = '#c7728f'
c.colors.downloads.error.fg  = '#505050'
c.colors.downloads.start.bg  = '#66ac68'
c.colors.downloads.start.fg  = '#505050'
c.colors.downloads.stop.bg   = '#66ac68'
c.colors.downloads.stop.fg   = '#505050'
c.colors.downloads.system.bg = 'rgb' # rgb, hsv, hsl, none
c.colors.downloads.system.fg = 'rgb' # rgb, hsv, hsl, none

c.colors.hints.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 rgba(206, 192, 159, 0.8), stop:1 rgba(206, 192, 159, 0.8))'
c.colors.hints.fg          = '#505050'
c.colors.hints.match.fg    = '#66ac68'
c.colors.keyhint.bg        = 'rgba(206, 192, 159, 80%)'
c.colors.keyhint.fg        = '#505050'
c.colors.keyhint.suffix.fg = '#e6e6e6'

c.colors.messages.error.bg     = '#a2767d'
c.colors.messages.error.border = '#a2767d'
c.colors.messages.error.fg     = '#fafafa'
c.colors.messages.info.bg     = '#e6e6e6'
c.colors.messages.info.border = '#e6e6e6'
c.colors.messages.info.fg     = '#505050'
c.colors.messages.warning.bg     = '#a6a988'
c.colors.messages.warning.border = '#a6a988'
c.colors.messages.warning.fg     = '#505050'

c.colors.prompts.bg          = '#fafafa'
c.colors.prompts.border      = '1px solid #e6e6e6'
c.colors.prompts.fg          = '#505050'
c.colors.prompts.selected.bg = '#b0d3b1'

c.colors.statusbar.caret.fg             = '#b66dac'
c.colors.statusbar.caret.bg             = '#e8f0e8'
c.colors.statusbar.caret.selection.fg   = '#fafafa'
c.colors.statusbar.caret.selection.bg   = '#977290'
c.colors.statusbar.command.fg           = '#505050'
c.colors.statusbar.command.bg           = '#e8f0e8'
c.colors.statusbar.command.private.bg   = '#787878'
c.colors.statusbar.command.private.fg   = '#fafafa'
c.colors.statusbar.insert.fg            = '#629c63'
c.colors.statusbar.insert.bg            = '#e8f0e8'
c.colors.statusbar.normal.fg            = '#505050'
c.colors.statusbar.normal.bg            = '#e8f0e8'
c.colors.statusbar.passthrough.bg       = '#b0d3b1'
c.colors.statusbar.passthrough.fg       = '#505050'
c.colors.statusbar.private.bg           = '#31a494'
c.colors.statusbar.private.fg           = '#505050'
c.colors.statusbar.progress.bg          = '#505050'
c.colors.statusbar.url.error.fg         = '#a2767d'
c.colors.statusbar.url.fg               = '#646464'
c.colors.statusbar.url.hover.fg         = '#505050'
c.colors.statusbar.url.success.http.fg  = '#629c63'
c.colors.statusbar.url.success.https.fg = '#629c63'
c.colors.statusbar.url.warn.fg          = '#a6a988'

c.colors.tabs.bar.bg           = '#b0d3b1'
c.colors.tabs.even.bg          = '#b0d3b1'
c.colors.tabs.even.fg          = '#66ac68'
c.colors.tabs.odd.bg           = '#c3ddc3'
c.colors.tabs.odd.fg           = '#66ac68'
c.colors.tabs.indicator.error  = '#a2767d'
c.colors.tabs.indicator.start  = '#629c63'
c.colors.tabs.indicator.stop   = '#66ac68'
c.colors.tabs.indicator.system = 'rgb'                      # rgb, hsv, hsl, none
c.colors.tabs.selected.even.bg = '#e8f0e8'
c.colors.tabs.selected.even.fg = '#505050'
c.colors.tabs.selected.odd.bg  = '#e8f0e8'
c.colors.tabs.selected.odd.fg  = '#505050'
c.colors.tabs.pinned.even.bg          = '#6e959f'
c.colors.tabs.pinned.even.fg          = '#505050'
c.colors.tabs.pinned.odd.bg           = '#6e959f'
c.colors.tabs.pinned.odd.fg           = '#505050'
c.colors.tabs.pinned.selected.even.bg = '#e8f0e8'
c.colors.tabs.pinned.selected.even.fg = '#5b7e5c'
c.colors.tabs.pinned.selected.odd.bg  = '#e8f0e8'
c.colors.tabs.pinned.selected.odd.fg  = '#5b7e5c'

c.colors.webpage.bg = '#e8f0e8'
