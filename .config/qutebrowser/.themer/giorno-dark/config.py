...
# ━  COLORS
# ━━ completion
c.colors.completion.category.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #D7AB39, stop:1 #D7AB39)'
c.colors.completion.category.border.bottom      = '#D7AB39'
c.colors.completion.category.border.top         = '#D7AB39'
c.colors.completion.category.fg                 = '#360A09'
c.colors.completion.even.bg                     = '#4a1e1d'
c.colors.completion.odd.bg                      = '#4a1e1d'
c.colors.completion.fg                          = ['#D7AB39', '#c3bba6', '#724645']
c.colors.completion.item.selected.bg            = '#D7AB39'
c.colors.completion.item.selected.fg            = '#4a1e1d'
c.colors.completion.item.selected.border.bottom = '#A15B15'
c.colors.completion.item.selected.border.top    = '#A15B15'
c.colors.completion.match.fg                    = '#D7AB39'
c.colors.completion.scrollbar.bg                = '#4a1e1d'
c.colors.completion.scrollbar.fg                = '#c3bba6'

# ━━ downloads
c.colors.downloads.bar.bg    = '#4a1e1d'
c.colors.downloads.error.bg  = '#CC3B2F'
c.colors.downloads.error.fg  = '#c3bba6'
c.colors.downloads.start.bg  = '#D7AB39'
c.colors.downloads.start.fg  = '#c3bba6'
c.colors.downloads.stop.bg   = '#A15B15'
c.colors.downloads.stop.fg   = '#c3bba6'
c.colors.downloads.system.bg = 'rgb' # rgb, hsv, hsl, none
c.colors.downloads.system.fg = 'rgb' # rgb, hsv, hsl, none

# ━━ hints
c.colors.hints.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 rgba(206, 112, 18, 0.8), stop:1 rgba(206, 112, 18, 0.8))'
c.colors.hints.fg          = '#c3bba6'
c.colors.hints.match.fg    = '#A15B15'
c.colors.keyhint.bg        = 'rgba(206, 112, 18, 80%)'
c.colors.keyhint.fg        = '#c3bba6'
c.colors.keyhint.suffix.fg = '#4a1e1d'

# ━━ errors
c.colors.messages.error.bg     = '#CC3B2F'
c.colors.messages.error.border = '#CC3B2F'
c.colors.messages.error.fg     = '#c3bba6'

# ━━ info
c.colors.messages.info.bg     = '#c3bba6'
c.colors.messages.info.border = '#c3bba6'
c.colors.messages.info.fg     = '#4a1e1d'

# ━━ warning
c.colors.messages.warning.bg     = '#CE7012'
c.colors.messages.warning.border = '#CE7012'
c.colors.messages.warning.fg     = '#4a1e1d'

# ━━ prompts
c.colors.prompts.bg          = '#4a1e1d'
c.colors.prompts.border      = '1px solid #4a1e1d'
c.colors.prompts.fg          = '#c3bba6'
c.colors.prompts.selected.bg = '#D7AB39'

# ━━ statusbar
c.colors.statusbar.caret.fg             = '#ECA421'
c.colors.statusbar.caret.bg             = '#4a1e1d'
c.colors.statusbar.caret.selection.fg   = '#ECA421'
c.colors.statusbar.caret.selection.bg   = '#4a1e1d'
c.colors.statusbar.command.fg           = '#c3bba6'
c.colors.statusbar.command.bg           = '#4a1e1d'
c.colors.statusbar.command.private.bg   = '#724645'
c.colors.statusbar.command.private.fg   = '#c3bba6'
c.colors.statusbar.insert.fg            = '#A15B15'
c.colors.statusbar.insert.bg            = '#4a1e1d'
c.colors.statusbar.normal.fg            = '#D7AB39'
c.colors.statusbar.normal.bg            = '#4a1e1d'
c.colors.statusbar.passthrough.bg       = '#4a1e1d'
c.colors.statusbar.passthrough.fg       = '#c3bba6'
c.colors.statusbar.private.bg           = '#724645'
c.colors.statusbar.private.fg           = '#c3bba6'
c.colors.statusbar.progress.bg          = '#c3bba6'
c.colors.statusbar.url.error.fg         = '#CC3B2F'
c.colors.statusbar.url.fg               = '#c3bba6'
c.colors.statusbar.url.hover.fg         = '#D7AB39'
c.colors.statusbar.url.success.http.fg  = '#c3bba6'
c.colors.statusbar.url.success.https.fg = '#c3bba6'
c.colors.statusbar.url.warn.fg          = '#CE7012'

# ━━ tabs
c.colors.tabs.bar.bg           = '#4a1e1d'
c.colors.tabs.even.bg          = '#4a1e1d'
c.colors.tabs.even.fg          = '#c3bba6'
c.colors.tabs.odd.bg           = '#4a1e1d'
c.colors.tabs.odd.fg           = '#c3bba6'
c.colors.tabs.indicator.error  = '#CC3B2F'
c.colors.tabs.indicator.start  = '#D7AB39'
c.colors.tabs.indicator.stop   = '#A15B15'
c.colors.tabs.indicator.system = 'rgb' # rgb, hsv, hsl, none
c.colors.tabs.selected.even.bg = '#D7AB39'
c.colors.tabs.selected.even.fg = '#4a1e1d'
c.colors.tabs.selected.odd.bg  = '#D7AB39'
c.colors.tabs.selected.odd.fg  = '#4a1e1d'
...
c.hints.border                     = '1px solid #CE7012'
