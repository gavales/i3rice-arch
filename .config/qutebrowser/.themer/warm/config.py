...
# >>>> COLORS
# //// completion
c.colors.completion.category.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #68A8AD, stop:1 #68A8AD)'
c.colors.completion.category.border.bottom      = '#68A8AD'
c.colors.completion.category.border.top         = '#68A8AD'
c.colors.completion.category.fg                 = '#C4D4AF'
c.colors.completion.even.bg                     = '#b0c09b'
c.colors.completion.odd.bg                      = '#b0c09b'
c.colors.completion.fg                          = ['#68A8AD', '#6C8672', '#889873']
c.colors.completion.item.selected.bg            = '#68A8AD'
c.colors.completion.item.selected.fg            = '#b0c09b'
c.colors.completion.item.selected.border.bottom = '#009048'
c.colors.completion.item.selected.border.top    = '#009048'
c.colors.completion.match.fg                    = '#68A8AD'
c.colors.completion.scrollbar.bg                = '#b0c09b'
c.colors.completion.scrollbar.fg                = '#6C8672'

# //// downloads
c.colors.downloads.bar.bg    = '#b0c09b'
c.colors.downloads.error.bg  = '#F17D80'
c.colors.downloads.error.fg  = '#6C8672'
c.colors.downloads.start.bg  = '#68A8AD'
c.colors.downloads.start.fg  = '#6C8672'
c.colors.downloads.stop.bg   = '#009048'
c.colors.downloads.stop.fg   = '#6C8672'
...
c.colors.hints.fg          = '#6C8672'
c.colors.hints.match.fg    = '#009048'
c.colors.keyhint.bg        = 'rgba(144, 72, 0, 80%)'
c.colors.keyhint.fg        = '#6C8672'
c.colors.keyhint.suffix.fg = '#b0c09b'

# //// errors
c.colors.messages.error.bg     = '#F17D80'
c.colors.messages.error.border = '#F17D80'
c.colors.messages.error.fg     = '#6C8672'

# //// info
c.colors.messages.info.bg     = '#6C8672'
c.colors.messages.info.border = '#6C8672'
c.colors.messages.info.fg     = '#b0c09b'

# //// warning
c.colors.messages.warning.bg     = '#904800'
c.colors.messages.warning.border = '#904800'
c.colors.messages.warning.fg     = '#b0c09b'

# //// prompts
c.colors.prompts.bg          = '#b0c09b'
c.colors.prompts.border      = '1px solid #b0c09b'
c.colors.prompts.fg          = '#6C8672'
c.colors.prompts.selected.bg = '#68A8AD'

# //// statusbar
c.colors.statusbar.caret.fg             = '#737495'
c.colors.statusbar.caret.bg             = '#b0c09b'
c.colors.statusbar.caret.selection.fg   = '#737495'
c.colors.statusbar.caret.selection.bg   = '#b0c09b'
c.colors.statusbar.command.fg           = '#6C8672'
c.colors.statusbar.command.bg           = '#b0c09b'
c.colors.statusbar.command.private.bg   = '#889873'
c.colors.statusbar.command.private.fg   = '#6C8672'
c.colors.statusbar.insert.fg            = '#009048'
c.colors.statusbar.insert.bg            = '#b0c09b'
c.colors.statusbar.normal.fg            = '#68A8AD'
c.colors.statusbar.normal.bg            = '#b0c09b'
c.colors.statusbar.passthrough.bg       = '#b0c09b'
c.colors.statusbar.passthrough.fg       = '#6C8672'
c.colors.statusbar.private.bg           = '#889873'
c.colors.statusbar.private.fg           = '#6C8672'
c.colors.statusbar.progress.bg          = '#6C8672'
c.colors.statusbar.url.error.fg         = '#F17D80'
c.colors.statusbar.url.fg               = '#6C8672'
c.colors.statusbar.url.hover.fg         = '#68A8AD'
c.colors.statusbar.url.success.http.fg  = '#6C8672'
c.colors.statusbar.url.success.https.fg = '#6C8672'
c.colors.statusbar.url.warn.fg          = '#904800'

# //// tabs
c.colors.tabs.bar.bg           = '#b0c09b'
c.colors.tabs.even.bg          = '#b0c09b'
c.colors.tabs.even.fg          = '#6C8672'
c.colors.tabs.odd.bg           = '#b0c09b'
c.colors.tabs.odd.fg           = '#6C8672'
c.colors.tabs.indicator.error  = '#F17D80'
c.colors.tabs.indicator.start  = '#68A8AD'
c.colors.tabs.indicator.stop   = '#009048'
c.colors.tabs.indicator.system = 'rgb' # rgb, hsv, hsl, none
c.colors.tabs.selected.even.bg = '#68A8AD'
c.colors.tabs.selected.even.fg = '#b0c09b'
c.colors.tabs.selected.odd.bg  = '#68A8AD'
c.colors.tabs.selected.odd.fg  = '#b0c09b'
