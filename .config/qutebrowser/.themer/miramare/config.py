...
c.hints.border = '1px solid #ad9569'
...
c.colors.completion.category.fg                 = '#2A2426'
c.colors.completion.even.bg                     = '#d2c298'
c.colors.completion.odd.bg                      = '#d2c298'
c.colors.completion.fg                          = ['#87c095', '#2A2426', '#aa9a70']
c.colors.completion.item.selected.bg            = '#87c095'
c.colors.completion.item.selected.fg            = '#2A2426'
...
c.colors.completion.scrollbar.bg                = '#d2c298'
c.colors.completion.scrollbar.fg                = '#2A2426'
...
c.colors.downloads.bar.bg    = '#d2c298'
c.colors.downloads.error.bg  = '#e68183'
c.colors.downloads.error.fg  = '#2A2426'
c.colors.downloads.start.bg  = '#87c095'
c.colors.downloads.start.fg  = '#2A2426'
c.colors.downloads.stop.bg   = '#87af87'
c.colors.downloads.stop.fg   = '#2A2426'
...
c.colors.hints.fg          = '#2A2426'
c.colors.hints.match.fg    = '#87af87'
c.colors.keyhint.bg        = 'rgba(217, 187, 128, 80%)'
c.colors.keyhint.fg        = '#2A2426'
c.colors.keyhint.suffix.fg = '#d2c298'

c.colors.messages.error.bg     = '#b7696b'
c.colors.messages.error.border = '#b7696b'
c.colors.messages.error.fg     = '#e6d6ac'
c.colors.messages.info.bg     = '#d2c298'
c.colors.messages.info.border = '#d2c298'
c.colors.messages.info.fg     = '#2A2426'
c.colors.messages.warning.bg     = '#ad9569'
c.colors.messages.warning.border = '#ad9569'
c.colors.messages.warning.fg     = '#2A2426'

c.colors.prompts.bg          = '#e6d6ac'
c.colors.prompts.border      = '1px solid #d2c298'
c.colors.prompts.fg          = '#2A2426'
c.colors.prompts.selected.bg = '#b6cba0'

c.colors.statusbar.caret.fg             = '#d3a0bc'
c.colors.statusbar.caret.bg             = '#e6d6ac'
c.colors.statusbar.caret.selection.fg   = '#e6d6ac'
c.colors.statusbar.caret.selection.bg   = '#d3a0bc'
c.colors.statusbar.command.fg           = '#2A2426'
c.colors.statusbar.command.bg           = '#e6d6ac'
c.colors.statusbar.command.private.bg   = '#524c4e'
c.colors.statusbar.command.private.fg   = '#e6d6ac'
c.colors.statusbar.insert.fg            = '#6f8c6e'
c.colors.statusbar.insert.bg            = '#e6d6ac'
c.colors.statusbar.normal.fg            = '#58725d'
c.colors.statusbar.normal.bg            = '#e6d6ac'
c.colors.statusbar.passthrough.bg       = '#b6cba0'
c.colors.statusbar.passthrough.fg       = '#2A2426'
c.colors.statusbar.private.bg           = '#aa9a70'
c.colors.statusbar.private.fg           = '#2A2426'
c.colors.statusbar.progress.bg          = '#2A2426'
c.colors.statusbar.url.error.fg         = '#b7696b'
c.colors.statusbar.url.fg               = '#3e383a'
c.colors.statusbar.url.hover.fg         = '#2A2426'
c.colors.statusbar.url.success.http.fg  = '#6f8c6e'
c.colors.statusbar.url.success.https.fg = '#6f8c6e'
c.colors.statusbar.url.warn.fg          = '#ad9569'

c.colors.tabs.bar.bg           = '#b6cba0'
c.colors.tabs.even.bg          = '#b6cba0'
c.colors.tabs.even.fg          = '#87c095'
c.colors.tabs.odd.bg           = '#c2cda3'
c.colors.tabs.odd.fg           = '#87c095'
c.colors.tabs.indicator.error  = '#b7696b'
c.colors.tabs.indicator.start  = '#6f8c6e'
c.colors.tabs.indicator.stop   = '#87c095'
c.colors.tabs.indicator.system = 'rgb' # rgb, hsv, hsl, none
c.colors.tabs.selected.even.bg = '#b6cba0'
c.colors.tabs.selected.even.fg = '#2A2426'
c.colors.tabs.selected.odd.bg  = '#b6cba0'
c.colors.tabs.selected.odd.fg  = '#2A2426'
c.colors.tabs.pinned.even.bg          = '#c2cda3'
c.colors.tabs.pinned.even.fg          = '#2A2426'
c.colors.tabs.pinned.odd.bg           = '#c2cda3'
c.colors.tabs.pinned.odd.fg           = '#2A2426'
c.colors.tabs.pinned.selected.even.bg = '#ced0a6'
c.colors.tabs.pinned.selected.even.fg = '#58725d'
c.colors.tabs.pinned.selected.odd.bg  = '#ced0a6'
c.colors.tabs.pinned.selected.odd.fg  = '#58725d'

c.colors.webpage.bg = '#dad3a9'
