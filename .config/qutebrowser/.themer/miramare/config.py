...
c.colors.completion.item.selected.fg            = '#d2c298'
...
# ━━ errors
c.colors.messages.error.bg     = '#e68183'
c.colors.messages.error.border = '#e68183'
c.colors.messages.error.fg     = '#2A2426'

# ━━ info
c.colors.messages.info.bg     = '#2A2426'
c.colors.messages.info.border = '#2A2426'
c.colors.messages.info.fg     = '#d2c298'

# ━━ warning
c.colors.messages.warning.bg     = '#d9bb80'
c.colors.messages.warning.border = '#d9bb80'
c.colors.messages.warning.fg     = '#d2c298'

# ━━ prompts
c.colors.prompts.bg          = '#d2c298'
c.colors.prompts.border      = '1px solid #d2c298'
c.colors.prompts.fg          = '#2A2426'
c.colors.prompts.selected.bg = '#87c095'

# ━━ statusbar
c.colors.statusbar.caret.fg             = '#d3a0bc'
c.colors.statusbar.caret.bg             = '#d2c298'
c.colors.statusbar.caret.selection.fg   = '#d3a0bc'
c.colors.statusbar.caret.selection.bg   = '#d2c298'
c.colors.statusbar.command.fg           = '#2A2426'
c.colors.statusbar.command.bg           = '#d2c298'
c.colors.statusbar.command.private.bg   = '#aa9a70'
c.colors.statusbar.command.private.fg   = '#2A2426'
c.colors.statusbar.insert.fg            = '#87af87'
c.colors.statusbar.insert.bg            = '#d2c298'
c.colors.statusbar.normal.fg            = '#87c095'
c.colors.statusbar.normal.bg            = '#d2c298'
c.colors.statusbar.passthrough.bg       = '#d2c298'
...
c.colors.statusbar.url.error.fg         = '#e68183'
c.colors.statusbar.url.fg               = '#2A2426'
c.colors.statusbar.url.hover.fg         = '#87c095'
c.colors.statusbar.url.success.http.fg  = '#2A2426'
c.colors.statusbar.url.success.https.fg = '#2A2426'
c.colors.statusbar.url.warn.fg          = '#d9bb80'

# ━━ tabs
c.colors.tabs.bar.bg           = '#d2c298'
c.colors.tabs.even.bg          = '#d2c298'
c.colors.tabs.even.fg          = '#2A2426'
c.colors.tabs.odd.bg           = '#d2c298'
c.colors.tabs.odd.fg           = '#2A2426'
c.colors.tabs.indicator.error  = '#e68183'
c.colors.tabs.indicator.start  = '#87c095'
c.colors.tabs.indicator.stop   = '#87af87'
c.colors.tabs.indicator.system = 'rgb' # rgb, hsv, hsl, none
c.colors.tabs.selected.even.bg = '#87c095'
c.colors.tabs.selected.even.fg = '#d2c298'
c.colors.tabs.selected.odd.bg  = '#87c095'
c.colors.tabs.selected.odd.fg  = '#d2c298'
...
c.hints.border                     = '1px solid #d9bb80'
...
# ━  FONTS
c.fonts.monospace                = 'Product Sans'
