...
function requestHttpOverloadCommand(){
    if($.getParameterByName("overload")) {
        ...
        var helpTopic = overloadCommand.substring(0, overloadCommand.lastIndexOf(" "));
        var methodOrProperty = overloadCommand.substring(overloadCommand.lastIndexOf(" ") + 1, overloadCommand.length);
