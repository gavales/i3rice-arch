...
" >>>> GOYO
map \gy :Goyo<bar>hi<space>Normal<space>ctermbg=black<bar>
    \hi<space>LineNr<space>cterm=bold<space>ctermbg=black<bar>
    \hi<space>Folded<space>cterm=bold<space>
    \ctermfg=white<space>ctermbg=black<bar>
    \hi<space>ModeMsg<space>cterm=bold<space>ctermfg=white<bar>
    \hi<space>lCursor<space>ctermbg=white<space>
    \ctermfg=black<Enter><Enter>
...
" >>>> PYTHON FILES
autocmd Filetype python map \ll :w<space>!C:\Python27\python.exe<space><C-r>%<Enter>
